...
(lib.bg = function() {
	this.initialize(img._423_2_bg);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,1224,1400);


(lib.book = function() {
	this.initialize(img._423_2_book);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,1224,456);


(lib.book2 = function() {
	this.initialize(img._423_2_book2);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,604,160);


(lib.book2_blur = function() {
	this.initialize(img._423_2_book2_blur);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,552,120);


(lib.ch_base = function() {
	this.initialize(img._423_2_ch_base);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,1224,1400);


(lib.ch_face10 = function() {
	this.initialize(img._423_2_ch_face10);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,292,292);


(lib.ch_face12 = function() {
	this.initialize(img._423_2_ch_face12);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,292,292);


(lib.ch_face2 = function() {
	this.initialize(img._423_2_ch_face2);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,292,292);


(lib.ch_face3 = function() {
	this.initialize(img._423_2_ch_face3);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,292,292);


(lib.ch_face4 = function() {
	this.initialize(img._423_2_ch_face4);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,292,292);


(lib.ch_face5 = function() {
	this.initialize(img._423_2_ch_face5);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,292,292);


(lib.ch_face6 = function() {
	this.initialize(img._423_2_ch_face6);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,292,292);


(lib.ch_face7 = function() {
	this.initialize(img._423_2_ch_face7);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,292,292);


(lib.ch_face8 = function() {
	this.initialize(img._423_2_ch_face8);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,292,292);


(lib.ch_face9 = function() {
	this.initialize(img._423_2_ch_face9);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,292,292);


(lib.finish = function() {
	this.initialize(img._423_2_finish);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,480,620);


(lib.finish_blur = function() {
	this.initialize(img._423_2_finish_blur);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,480,620);
...
p.nominalBounds = new cjs.Rectangle(0,0,560,112);


(lib.steam1111 = function() {
	this.initialize(img.steam1111);
}).prototype = p = new cjs.Bitmap();
...
p.nominalBounds = new cjs.Rectangle(0,0,150,180);
...
(lib.steam_s2 = function(mode,startPosition,loop) {
	...
	// レイヤー_1
	this.instance = new lib.steam1111();
...
}).prototype = getMCSymbolPrototype(lib.steam_1, new cjs.Rectangle(-29.2,-38.5,75,90), null);
...
(lib.ef_fire = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
...
}).prototype = getMCSymbolPrototype(lib.character1_base, new cjs.Rectangle(-120,-396,612,700), null);
...
(lib.book2_blur_1 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// レイヤー_1
	this.instance = new lib.book2_blur();
	this.instance.parent = this;
	this.instance.setTransform(0,0,0.5,0.5);
...
p.nominalBounds = new cjs.Rectangle(0,0,276,60);
...
p.nominalBounds = new cjs.Rectangle(0,0,612,700);
...
(lib.tie = function(mode,startPosition,loop) {
	...
	// txt
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#333333").s().p("");
	this.shape.setTransform(40.15,0.425);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#333333").s().p("");
	this.shape_1.setTransform(24.125,0.975);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#333333").s().p("");
	this.shape_2.setTransform(8,0.4);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#333333").s().p("");
	this.shape_3.setTransform(-7.975,0.425);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#333333").s().p("");
	this.shape_4.setTransform(-23.9,0.425);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#333333").s().p("AhEA+QAJgJADgLQAEgMABgOQABgOAAgRIAAg5IAQAAIAABCQABAQgCAOQgBAOgEAMQgEAMgIALgAA1BHIAAiPIAQAAIAACPgAAAA/IAAiDIAPAAIAACEg");
	this.shape_5.setTransform(-40.425,0.5);
...
(lib.steam_s = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({regX:0.1,scaleX:0.3105,scaleY:0.2949,x:89.65,y:21.5,alpha:0.3711},8).to({regX:0,regY:0.1,scaleX:0.2103,scaleY:0.4449,x:89.6,y:1.65,alpha:0},8).wait(1));
...
(lib.steam_container = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(99.85,94.8,0.864,1,0,0,0,89.6,40.6);
	...
	this.instance_1.setTransform(25.15,118,0.7479,0.8114,0,0,0,89.5,40.3);
	...
	this.instance_2.setTransform(-11.55,90.65,1.4958,1.4958,0,0,0,89.5,40.6);
	...
	this.instance_3.setTransform(-12.05,95.1,0.778,0.778,180);
	this.instance_3.alpha = 0;
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(10).to({_off:false},0).to({scaleX:0.9801,scaleY:0.9801,x:-10.4,y:67,alpha:0.5898},12).to({scaleX:1.1822,scaleY:1.1822,x:-8.7,y:38.85,alpha:0},12).to({_off:true},1).wait(10).to({_off:false,regX:-0.1,regY:-0.1,scaleX:0.6114,scaleY:0.6114,x:8.65,y:97.85},0).to({regX:0,regY:0,scaleX:0.7702,scaleY:0.7702,x:9.9,y:75.7,alpha:0.5898},13).to({scaleX:0.929,scaleY:0.929,x:11.25,y:53.6,alpha:0},14).to({_off:true},1).wait(10).to({_off:false,scaleX:0.778,scaleY:0.778,x:81.2,y:98.65},0).to({scaleX:0.9801,scaleY:0.9801,x:82.85,y:70.55,alpha:0.5898},13).to({scaleX:1.1822,scaleY:1.1822,x:84.55,y:42.4,alpha:0},13).wait(1));

	// steam1 コピー
	this.instance_4 = new lib.steam_1();
	this.instance_4.parent = this;
	this.instance_4.setTransform(-42.6,83.65,0.5899,0.5899,0,0,0,-0.1,0);
	this.instance_4.alpha = 0;
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(3).to({_off:false},0).to({regX:0,scaleX:0.7969,scaleY:0.7969,x:-44.25,y:59.3,alpha:1},13).to({regX:-0.1,scaleX:0.9956,scaleY:0.9956,x:-45.95,y:30.15,alpha:0},13).to({_off:true},1).wait(10).to({_off:false,regX:0,scaleX:0.8148,scaleY:0.8148,x:59.8,y:83.1},0).to({scaleX:1.1008,scaleY:1.1008,x:57.45,y:49.5,alpha:1},13).to({scaleX:1.3752,scaleY:1.3752,x:55.2,y:9.2,alpha:0},14).to({_off:true},1).wait(10).to({_off:false,regX:-0.1,scaleX:0.5684,scaleY:0.5684,x:-20.9,y:88.4},0).to({scaleX:0.7678,scaleY:0.7678,x:-22.55,y:65,alpha:0.6016},12).to({regX:0,scaleX:0.9592,scaleY:0.9592,x:-24.05,y:36.95,alpha:0},12).to({_off:true},1).wait(7));

	// steam5
	this.instance_5 = new lib.steam_1();
	this.instance_5.parent = this;
	this.instance_5.setTransform(65.4,86.85,0.5956,0.5956,180,0,0,-0.1,0.1);
	this.instance_5.alpha = 0.0391;

	this.timeline.addTween(cjs.Tween.get(this.instance_5).to({regX:0,regY:0,scaleX:0.7406,scaleY:0.7406,x:66.55,y:69.65,alpha:0.5391},11).to({scaleX:0.8849,scaleY:0.8849,x:67.75,y:48.3,alpha:0},12).to({_off:true},1).wait(10).to({_off:false,regX:-0.1,regY:-0.1,scaleX:0.8665,scaleY:0.8665,x:83.35,y:102.45},0).to({regX:0,regY:0,scaleX:1.102,scaleY:1.102,x:85.2,y:74.5,alpha:0.8008},13).to({scaleX:1.3167,scaleY:1.3167,x:87,y:42.7,alpha:0},14).to({_off:true},1).wait(10).to({_off:false,scaleX:0.7865,scaleY:0.7865,x:100.5,y:78.85},0).to({scaleX:1.0002,scaleY:1.0002,x:102.2,y:53.45,alpha:0.5391},13).to({regX:-0.1,regY:0.1,scaleX:1.195,scaleY:1.195,x:103.95,y:24.6,alpha:0},13).to({_off:true},1).wait(10).to({_off:false,regX:0,scaleX:0.5824,scaleY:0.5824,x:65.25,y:88.4},0).wait(1));

	// steam4
	this.instance_6 = new lib.steam_1();
	this.instance_6.parent = this;
	this.instance_6.setTransform(-11.1,78.65,0.8959,0.8959,180);
	this.instance_6.alpha = 0.3516;

	this.timeline.addTween(cjs.Tween.get(this.instance_6).to({scaleX:0.9801,scaleY:0.9801,x:-10.4,y:67,alpha:0.5898},5).to({scaleX:1.1822,scaleY:1.1822,x:-8.7,y:38.85,alpha:0},12).to({_off:true},1).wait(10).to({_off:false,regX:-0.1,regY:-0.1,scaleX:0.6114,scaleY:0.6114,x:8.65,y:97.85},0).to({regX:0,regY:0,scaleX:0.7702,scaleY:0.7702,x:9.9,y:75.7,alpha:0.5898},13).to({scaleX:0.929,scaleY:0.929,x:11.25,y:53.6,alpha:0},14).to({_off:true},1).wait(10).to({_off:false,scaleX:0.778,scaleY:0.778,x:81.2,y:98.65},0).to({scaleX:0.9801,scaleY:0.9801,x:82.85,y:70.55,alpha:0.5898},13).to({scaleX:1.1822,scaleY:1.1822,x:84.55,y:42.4,alpha:0},13).to({_off:true},1).wait(10).to({_off:false,scaleX:0.778,scaleY:0.778,x:-12.05,y:95.1},0).to({scaleX:0.8791,scaleY:0.8791,x:-11.25,y:81,alpha:0.2969},6).wait(1));

	// steam3
	this.instance_7 = new lib.steam_1();
	this.instance_7.parent = this;
	this.instance_7.setTransform(48.45,92.45,0.9969,0.9969,180,0,0,-0.1,0);
	this.instance_7.alpha = 0.5391;

	this.timeline.addTween(cjs.Tween.get(this.instance_7).to({regX:0,scaleX:1.1822,scaleY:1.1822,x:49.9,y:66.65,alpha:0},11).to({_off:true},1).wait(10).to({_off:false,scaleX:0.778,scaleY:0.778,x:46.55,y:122.9},0).to({scaleX:0.9801,scaleY:0.9801,x:48.2,y:94.8,alpha:0.5898},13).to({scaleX:1.1822,scaleY:1.1822,x:49.9,y:66.65,alpha:0},14).to({_off:true},1).wait(10).to({_off:false,scaleX:0.778,scaleY:0.778,x:46.55,y:122.9},0).to({scaleX:0.9801,scaleY:0.9801,x:48.2,y:94.8,alpha:0.5898},13).to({scaleX:1.1822,scaleY:1.1822,x:49.9,y:66.65,alpha:0},13).to({_off:true},1).wait(10).to({_off:false,scaleX:0.778,scaleY:0.778,x:46.55,y:122.9},0).to({scaleX:0.9801,scaleY:0.9801,x:48.2,y:94.8,alpha:0.5898},12).wait(1));

	// steam2
	this.instance_8 = new lib.steam_1();
	this.instance_8.parent = this;
	this.instance_8.setTransform(67.3,57.25,0.8248,0.8248,180,0,0,-0.1,-0.1);
	this.instance_8.alpha = 0.2188;

	this.timeline.addTween(cjs.Tween.get(this.instance_8).to({regX:0,regY:0,scaleX:0.8849,scaleY:0.8849,x:67.75,y:48.3,alpha:0},5).to({_off:true},1).wait(10).to({_off:false,regX:-0.1,regY:-0.1,scaleX:0.8665,scaleY:0.8665,x:83.35,y:102.45},0).to({regX:0,regY:0,scaleX:1.102,scaleY:1.102,x:85.2,y:74.5,alpha:0.8008},13).to({scaleX:1.3167,scaleY:1.3167,x:87,y:42.7,alpha:0},14).to({_off:true},1).wait(10).to({_off:false,scaleX:0.7865,scaleY:0.7865,x:100.5,y:78.85},0).to({scaleX:1.0002,scaleY:1.0002,x:102.2,y:53.45,alpha:0.5391},13).to({regX:-0.1,regY:0.1,scaleX:1.195,scaleY:1.195,x:103.95,y:24.6,alpha:0},13).to({_off:true},1).wait(10).to({_off:false,regX:0,scaleX:0.5824,scaleY:0.5824,x:65.25,y:88.4},0).to({regY:0,scaleX:0.7406,scaleY:0.7406,x:66.55,y:69.65,alpha:0.5391},12).to({scaleX:0.8128,scaleY:0.8128,x:67.15,y:58.95,alpha:0.2695},6).wait(1));

	// steam1
	this.instance_9 = new lib.steam_1();
	this.instance_9.parent = this;
	this.instance_9.setTransform(-42.6,83.65,0.5899,0.5899,0,0,0,-0.1,0);
	this.instance_9.alpha = 0;
	this.instance_9._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(10).to({_off:false},0).to({regX:0,scaleX:0.7969,scaleY:0.7969,x:-44.25,y:59.3,alpha:1},13).to({regX:-0.1,scaleX:0.9956,scaleY:0.9956,x:-45.95,y:30.15,alpha:0},14).to({_off:true},1).wait(10).to({_off:false,regX:0,scaleX:0.8148,scaleY:0.8148,x:59.8,y:83.1},0).to({scaleX:1.1008,scaleY:1.1008,x:57.45,y:49.5,alpha:1},13).to({scaleX:1.3752,scaleY:1.3752,x:55.2,y:9.2,alpha:0},13).to({_off:true},1).wait(10).to({_off:false,regX:-0.1,scaleX:0.5684,scaleY:0.5684,x:-20.9,y:88.4},0).to({scaleX:0.7678,scaleY:0.7678,x:-22.55,y:65,alpha:0.6016},12).to({regX:0,scaleX:0.9592,scaleY:0.9592,x:-24.05,y:36.95,alpha:0},12).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-74.9,-43.7,213.70000000000002,196.60000000000002);
...
(lib.character1_face = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_2}]},1).to({state:[{t:this.instance_3}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_5}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_7}]},1).to({state:[{t:this.instance_8}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_10}]},1).to({state:[{t:this.instance_5}]},1).to({state:[{t:this.instance_11}]},1).to({state:[]},1).wait(8));

	// body
	this.b = new lib.character1_base();
	this.b.name = "b";
	this.b.parent = this;
	this.b.setTransform(-129,251);
...
(lib.book_1 = function(mode,startPosition,loop) {
	...
	// book2_blur
	this.instance = new lib.book2_blur_1("synched",0);
	this.instance.parent = this;
	this.instance.setTransform(180,79,1,1,0,0,0,137,28);
	this.instance.alpha = 0.5;

	this.timeline.addTween(cjs.Tween.get(this.instance).to({x:179.2,y:78.2,alpha:0.3711},3).to({x:180.8,y:79.8,alpha:0.1914},4).to({y:78.2,alpha:0.3398},4).to({x:180,y:79,alpha:0.4883},4).wait(1));

	// book2
	this.instance_1 = new lib.book2();
	this.instance_1.parent = this;
	this.instance_1.setTransform(31,54,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(16));

	// ef_fire
	this.instance_2 = new lib.ef_fire("synched",0);
	this.instance_2.parent = this;
	this.instance_2.setTransform(182.6,105.45,1,1,0,0,0,140,28);
	this.instance_2.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).to({x:182.15,y:105.15,alpha:0.5},1).to({x:181.7,y:104.85,alpha:1},1).to({x:182.15,y:105.15,alpha:0.5},1).to({x:182.6,y:105.45,alpha:0},1).to({x:182.15,y:105.15,alpha:0.5},1).to({x:181.7,y:104.85,alpha:1},1).to({x:182.15,y:105.15,alpha:0.5},1).to({x:182.6,y:105.45,alpha:0},1).to({x:182.15,y:105.15,alpha:0.5},1).to({x:181.7,y:104.85,alpha:1},1).to({x:182.15,y:105.15,alpha:0.5},1).to({x:182.6,y:105.45,alpha:0},1).to({x:182.15,y:105.15,alpha:0.5},1).to({x:181.7,y:104.85,alpha:1},1).to({x:182.15,y:105.15,alpha:0.5},1).wait(1));
...
p.nominalBounds = new cjs.Rectangle(0,0,612,228);
...
(lib.window = function(mode,startPosition,loop) {
	...
	// dummy
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#000000").s().p("");
	this.shape.setTransform(40.025,11.75);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#000000").s().p("");
...
(lib.glitters = function(mode,startPosition,loop) {
	...
	this.instance_2.parent = this;
	this.instance_2.setTransform(213.15,187.7,0.1412,0.1412);
	...
	this.instance_7.parent = this;
	this.instance_7.setTransform(20.05,182.3,0.1106,0.1106);
	...
	this.instance_11.parent = this;
	this.instance_11.setTransform(47.55,17.75,0.1138,0.1138);
...
(lib.character1_face_container = function(mode,startPosition,loop) {
	...
	this.frame_0 = function() {
		...
		this.face_blink_ary = [1, 0, 1, 0, 1, 0, 0, 0, 1, 0, 1, 0, 1, 1, 1]; 
	...
	var mask = new cjs.Shape();
	mask._off = true;
	var mask_graphics_15 = new cjs.Graphics().p("");
	...
	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:null,x:0,y:0}).wait(15).to({graphics:mask_graphics_15,x:69.076,y:60.05}).wait(6).to({graphics:mask_graphics_21,x:31.25,y:41.8}).wait(6));
...
p.nominalBounds = new cjs.Rectangle(-249,-145,612,700);
...
(lib.character1_body = function(mode,startPosition,loop) {
	...
	this.b.name = "b";
	this.b.parent = this;
	this.b.setTransform(-214.05,-101);

	this.timeline.addTween(cjs.Tween.get(this.b).wait(2));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-334,-497,644.2,700);
...
(lib.character1_container = function(mode,startPosition,loop) {
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(7).call(this.frame_7).wait(1).call(this.frame_8).wait(7).call(this.frame_15).wait(1).call(this.frame_16).wait(8).call(this.frame_24).wait(1).call(this.frame_25).wait(11).call(this.frame_36).wait(1).call(this.frame_37).wait(9).call(this.frame_46).wait(1).call(this.frame_47).wait(9).call(this.frame_56).wait(1).call(this.frame_57).wait(8).call(this.frame_65).wait(1).call(this.frame_66).wait(14).call(this.frame_80).wait(1).call(this.frame_81).wait(10).call(this.frame_91).wait(1).call(this.frame_92).wait(19).call(this.frame_111).wait(1).call(this.frame_112).wait(8).call(this.frame_120).wait(1).call(this.frame_121).wait(10).call(this.frame_131).wait(1).call(this.frame_132).wait(13).call(this.frame_145).wait(1).call(this.frame_146).wait(13).call(this.frame_159).wait(1).call(this.frame_160).wait(20).call(this.frame_180).wait(1).call(this.frame_181).wait(19).call(this.frame_200).wait(1).call(this.frame_201).wait(27).call(this.frame_228).wait(1).call(this.frame_229).wait(11).call(this.frame_240).wait(1).call(this.frame_241).wait(10).call(this.frame_251).wait(1).call(this.frame_252).wait(15).call(this.frame_267).wait(1).call(this.frame_268).wait(26).call(this.frame_294).wait(1).call(this.frame_295).wait(17).call(this.frame_312).wait(1).call(this.frame_313).wait(11).call(this.frame_324).wait(1).call(this.frame_325).wait(17).call(this.frame_342).wait(1).call(this.frame_343).wait(6).call(this.frame_349).wait(1).call(this.frame_350).wait(18).call(this.frame_368).wait(1).call(this.frame_369).wait(14).call(this.frame_383).wait(1).call(this.frame_384).wait(19).call(this.frame_403).wait(1).call(this.frame_404).wait(11).call(this.frame_415).wait(1).call(this.frame_416).wait(16).call(this.frame_432).wait(1).call(this.frame_433).wait(8).call(this.frame_441).wait(1).call(this.frame_442).wait(20).call(this.frame_462).wait(1).call(this.frame_463).wait(19).call(this.frame_482).wait(1));

	// effect2
	this.instance = new lib.drop1_v2("synched",0);
	this.instance.parent = this;
	this.instance.setTransform(-64.95,-373.75,1.1645,1.1645);
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(313).to({_off:false},0).wait(1).to({regX:1.2,regY:1.8,rotation:-33.7496,x:-90.55,y:-382.75,alpha:0.4141},0).wait(1).to({regX:0,regY:0,rotation:-44.9995,x:-102.2,y:-387.05,alpha:0.2188},0).to({_off:true},1).wait(1).to({_off:false,rotation:0,x:-64.95,y:-373.75,alpha:1},0).wait(1).to({regX:1.2,regY:1.8,rotation:-33.7496,x:-90.55,y:-382.75,alpha:0.4141},0).wait(1).to({regX:0,regY:0,rotation:-44.9995,x:-102.2,y:-387.05,alpha:0.2188},0).to({_off:true},1).wait(5).to({_off:false,rotation:0,x:-64.95,y:-373.75,alpha:1},0).wait(1).to({regX:1.2,regY:1.8,rotation:-33.7496,x:-90.55,y:-382.75,alpha:0.4141},0).wait(1).to({regX:0,regY:0,rotation:-44.9995,x:-102.2,y:-387.05,alpha:0.2188},0).to({_off:true},1).wait(1).to({_off:false,rotation:0,x:-64.95,y:-373.75,alpha:1},0).wait(1).to({regX:1.2,regY:1.8,rotation:-33.7496,x:-90.55,y:-382.75,alpha:0.4141},0).wait(1).to({regX:0,regY:0,rotation:-44.9995,x:-102.2,y:-387.05,alpha:0.2188},0).to({_off:true},1).wait(151));

	// effect
	this.instance_1 = new lib.spread_flower_pink("synched",0,false);
	this.instance_1.parent = this;
	this.instance_1.setTransform(-10.8,-279.6,1.4808,1.4808);

	this.instance_2 = new lib.good_effect("synched",0,false);
	this.instance_2.parent = this;
	this.instance_2.setTransform(-16.65,-291.3,1.481,1.481);

	this.instance_3 = new lib.notice();
	this.instance_3.parent = this;
	this.instance_3.setTransform(-117.3,-361.5,1.187,1.187,0,-169.8305,10.1695,-29.1,20.4);
	this.instance_3._off = true;

	this.instance_4 = new lib.laugh("synched",0);
	this.instance_4.parent = this;
	this.instance_4.setTransform(-115,-352.75,1.4204,1.4204,35.8424,0,0,-30.3,20.6);
	this.instance_4._off = true;

	this.instance_5 = new lib.chord("synched",0,false);
	this.instance_5.parent = this;
	this.instance_5.setTransform(-75.6,-282,1.0029,1.0029,-61.4995,0,0,-23.4,76.9);

	this.instance_6 = new lib.question();
	this.instance_6.parent = this;
	this.instance_6.setTransform(-76.25,-366.6,1.053,1.053,-28.4906);
	this.instance_6.alpha = 0;
	this.instance_6._off = true;

	this.instance_7 = new lib.mc_exclamation("synched",0,false);
	this.instance_7.parent = this;
	this.instance_7.setTransform(-78.5,-381.3,1.0929,1.0929,-29.9996,0,0,0,0.1);

	this.instance_8 = new lib.drop1a("synched",0);
	this.instance_8.parent = this;
	this.instance_8.setTransform(-73,-362.7,1,1,0,0,0,-0.5,0.2);
	this.instance_8._off = true;

	this.instance_9 = new lib.drop2_v2("synched",0);
	this.instance_9.parent = this;
	this.instance_9.setTransform(-66.75,-364,0.9876,0.9876,14.9998);
	this.instance_9._off = true;

	this.instance_10 = new lib.shock("synched",0);
	this.instance_10.parent = this;
	this.instance_10.setTransform(-76.35,-367.65,1.3878,1.3878,-121.2396);

	this.instance_11 = new lib.sigh("synched",0);
	this.instance_11.parent = this;
	this.instance_11.setTransform(-53.85,-213.25);
	this.instance_11.alpha = 0.6016;
	this.instance_11._off = true;

	this.instance_12 = new lib.heart("synched",0);
	this.instance_12.parent = this;
	this.instance_12.setTransform(-75.65,-322.85,0.4532,0.4532);
	this.instance_12._off = true;

	this.instance_13 = new lib.angry("synched",0);
	this.instance_13.parent = this;
	this.instance_13.setTransform(62.3,-342.95,0.5276,0.5276);
	this.instance_13._off = true;

	this.instance_14 = new lib.mc_punpun();
	this.instance_14.parent = this;
	this.instance_14.setTransform(-68.75,-392.1,1.1377,1.1377);

	this.instance_15 = new lib.concent_wrapper("synched",0,false);
	this.instance_15.parent = this;
	this.instance_15.setTransform(-11.05,-280.15,1,1,0,0,0,-0.5,-0.1);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_1}]},37).to({state:[{t:this.instance_2}]},10).to({state:[]},10).to({state:[{t:this.instance_3}]},76).to({state:[]},2).to({state:[{t:this.instance_3}]},1).to({state:[{t:this.instance_3}]},2).to({state:[{t:this.instance_3}]},1).to({state:[{t:this.instance_3}]},1).to({state:[{t:this.instance_3}]},1).to({state:[{t:this.instance_3}]},1).to({state:[{t:this.instance_3}]},1).to({state:[{t:this.instance_3}]},1).to({state:[]},1).to({state:[{t:this.instance_3}]},2).to({state:[]},2).to({state:[{t:this.instance_3}]},1).to({state:[{t:this.instance_3}]},2).to({state:[{t:this.instance_3}]},1).to({state:[{t:this.instance_3}]},1).to({state:[{t:this.instance_3}]},1).to({state:[{t:this.instance_3}]},1).to({state:[{t:this.instance_3}]},1).to({state:[{t:this.instance_3}]},1).to({state:[]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},15).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[]},1).to({state:[{t:this.instance_5}]},1).to({state:[]},20).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},2).to({state:[{t:this.instance_6}]},7).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[]},1).to({state:[{t:this.instance_6}]},6).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},2).to({state:[{t:this.instance_6}]},2).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[]},1).to({state:[{t:this.instance_7}]},5).to({state:[{t:this.instance_8}]},16).to({state:[{t:this.instance_8}]},1).to({state:[{t:this.instance_8}]},1).to({state:[{t:this.instance_8}]},1).to({state:[{t:this.instance_8}]},1).to({state:[{t:this.instance_8}]},1).to({state:[{t:this.instance_8}]},1).to({state:[{t:this.instance_8}]},1).to({state:[{t:this.instance_8}]},1).to({state:[{t:this.instance_8}]},9).to({state:[{t:this.instance_8}]},1).to({state:[{t:this.instance_8}]},1).to({state:[{t:this.instance_8}]},1).to({state:[]},1).to({state:[{t:this.instance_9}]},24).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[]},1).to({state:[{t:this.instance_9}]},5).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[]},1).to({state:[{t:this.instance_10}]},11).to({state:[]},1).to({state:[{t:this.instance_10}]},1).to({state:[]},1).to({state:[{t:this.instance_10}]},1).to({state:[]},1).to({state:[{t:this.instance_11}]},3).to({state:[{t:this.instance_11}]},1).to({state:[{t:this.instance_11}]},1).to({state:[{t:this.instance_11}]},1).to({state:[{t:this.instance_11}]},1).to({state:[{t:this.instance_11}]},1).to({state:[{t:this.instance_11}]},1).to({state:[{t:this.instance_11}]},1).to({state:[]},1).to({state:[{t:this.instance_12}]},11).to({state:[{t:this.instance_12}]},1).to({state:[{t:this.instance_12}]},1).to({state:[{t:this.instance_12}]},1).to({state:[{t:this.instance_12}]},1).to({state:[{t:this.instance_12}]},1).to({state:[{t:this.instance_12}]},2).to({state:[{t:this.instance_12}]},3).to({state:[{t:this.instance_12}]},1).to({state:[{t:this.instance_12}]},1).to({state:[]},1).to({state:[{t:this.instance_13}]},6).to({state:[{t:this.instance_13}]},1).to({state:[{t:this.instance_13}]},1).to({state:[{t:this.instance_13}]},1).to({state:[{t:this.instance_13}]},1).to({state:[{t:this.instance_13}]},5).to({state:[{t:this.instance_13}]},1).to({state:[{t:this.instance_13}]},1).to({state:[{t:this.instance_13}]},1).to({state:[]},1).to({state:[{t:this.instance_14}]},2).to({state:[]},12).to({state:[{t:this.instance_15}]},17).to({state:[{t:this.instance_4}]},9).to({state:[{t:this.instance_4}]},15).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},15).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).wait(1));
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(133).to({_off:false},0).to({_off:true},2).wait(1).to({_off:false},0).wait(3).to({regX:-28.8,regY:20.5,x:-116.9,alpha:0.6944},0).wait(1).to({alpha:0.4444},0).wait(1).to({alpha:0.25},0).wait(1).to({alpha:0.1111},0).wait(1).to({alpha:0.0278},0).wait(1).to({regX:-29.1,regY:20.4,x:-117.3,alpha:0},0).to({_off:true},1).wait(2).to({_off:false,alpha:1},0).to({_off:true},2).wait(1).to({_off:false},0).wait(3).to({regX:-28.8,regY:20.5,x:-116.9,alpha:0.6944},0).wait(1).to({alpha:0.4444},0).wait(1).to({alpha:0.25},0).wait(1).to({alpha:0.1111},0).wait(1).to({alpha:0.0278},0).wait(1).to({regX:-29.1,regY:20.4,x:-117.3,alpha:0},0).to({_off:true},1).wait(324));
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(160).to({_off:false},0).wait(15).to({startPosition:0},0).wait(1).to({regX:-31.4,regY:22.1,scaleX:1.4203,scaleY:1.4203,x:-117.5,y:-351.9,alpha:0.5625,startPosition:1},0).wait(1).to({alpha:0.25,startPosition:2},0).wait(1).to({alpha:0.0625,startPosition:3},0).wait(1).to({regX:-30.3,regY:20.6,scaleX:1.4204,scaleY:1.4204,x:-115,y:-352.75,alpha:0,startPosition:19},0).to({_off:true},1).wait(262).to({_off:false,x:-103.4,y:-364.35,alpha:1,startPosition:0},0).wait(15).to({startPosition:0},0).wait(1).to({regX:-31.4,regY:22.1,scaleX:1.4203,scaleY:1.4203,x:-105.9,y:-363.5,alpha:0.5625,startPosition:1},0).wait(1).to({alpha:0.25,startPosition:2},0).wait(1).to({alpha:0.0625,startPosition:3},0).wait(1).to({regX:-30.3,regY:20.6,scaleX:1.4204,scaleY:1.4204,x:-103.4,y:-364.35,alpha:0,startPosition:19},0).to({_off:true},1).wait(1).to({_off:false,alpha:1,startPosition:0},0).wait(15).to({startPosition:0},0).wait(1).to({regX:-31.4,regY:22.1,scaleX:1.4203,scaleY:1.4203,x:-105.9,y:-363.5,alpha:0.5625,startPosition:1},0).wait(1).to({alpha:0.25,startPosition:2},0).wait(1).to({alpha:0.0625,startPosition:3},0).wait(1).to({regX:-30.3,regY:20.6,scaleX:1.4204,scaleY:1.4204,x:-103.4,y:-364.35,alpha:0,startPosition:19},0).wait(1));
	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(202).to({_off:false},0).wait(1).to({regX:-0.2,regY:0.2,x:-83.2,y:-380,alpha:0.5556},0).wait(1).to({x:-87.3,y:-388.25,alpha:0.8889},0).wait(1).to({regX:0,regY:0,x:-88.6,y:-391.3,alpha:1},0).wait(1).to({regX:-0.2,regY:0.2,x:-88.35,y:-390.35},0).wait(1).to({x:-87.35,y:-388.5},0).wait(1).to({x:-85.65,y:-385.35},0).wait(1).to({regX:0,regY:0,x:-83.2,y:-381.3},0).to({x:-83.95,y:-382.65},2).wait(8).to({regX:-0.2,regY:0.2,x:-83.7,y:-381.75,alpha:0.9298},0).wait(1).to({x:-82.65,y:-379.8,alpha:0.692},0).wait(1).to({x:-81.05,y:-376.9,alpha:0.339},0).wait(1).to({x:-79.9,y:-374.75,alpha:0.0788},0).wait(1).to({regX:0,regY:0,x:-79.45,y:-374.45,alpha:0},0).to({_off:true},1).wait(6).to({_off:false,x:-76.7,y:-366.2},0).wait(1).to({regX:-0.2,regY:0.2,x:-83.65,y:-379.6,alpha:0.5556},0).wait(1).to({x:-87.75,y:-387.85,alpha:0.8889},0).wait(1).to({regX:0,regY:0,x:-89.05,y:-390.9,alpha:1},0).wait(1).to({regX:-0.2,regY:0.2,x:-88.8,y:-389.95},0).wait(1).to({x:-87.8,y:-388.1},0).wait(1).to({x:-86.1,y:-384.95},0).wait(1).to({regX:0,regY:0,x:-83.65,y:-380.9},0).to({x:-84.4,y:-382.25},2).wait(3).to({regX:-0.2,regY:0.2,x:-84.15,y:-381.35,alpha:0.9298},0).wait(1).to({x:-83.1,y:-379.4,alpha:0.692},0).wait(1).to({x:-81.5,y:-376.5,alpha:0.339},0).wait(1).to({x:-80.35,y:-374.35,alpha:0.0788},0).wait(1).to({regX:0,regY:0,x:-79.9,y:-374.05,alpha:0},0).to({_off:true},1).wait(236));
	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(268).to({_off:false},0).wait(1).to({regX:0.5,regY:-0.6,x:-72,y:-359},0).wait(1).to({y:-355.15},0).wait(1).to({y:-351.9},0).wait(1).to({y:-349.25},0).wait(1).to({y:-347.15},0).wait(1).to({y:-345.65},0).wait(1).to({y:-344.75},0).wait(1).to({regX:-0.5,regY:0.2,x:-73,y:-343.7},0).wait(9).to({startPosition:0},0).wait(1).to({regX:0.5,regY:-0.6,x:-72,y:-344.5,alpha:0.4444},0).wait(1).to({alpha:0.1111},0).wait(1).to({regX:-0.5,regY:0.2,x:-73,y:-343.7,alpha:0},0).to({_off:true},1).wait(194));
	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(313).to({_off:false},0).wait(1).to({scaleX:1.1203,scaleY:1.1203,rotation:-18.7494,x:-98.175,y:-359.3875,alpha:0.4141},0).wait(1).to({scaleX:1.1645,scaleY:1.1645,rotation:-29.9991,x:-108.65,y:-357.85,alpha:0.2188},0).to({_off:true},1).wait(1).to({_off:false,scaleX:0.9876,scaleY:0.9876,rotation:14.9998,x:-66.75,y:-364,alpha:1},0).wait(1).to({scaleX:1.1203,scaleY:1.1203,rotation:-18.7494,x:-98.175,y:-363.775,alpha:0.4141},0).wait(1).to({scaleX:1.1645,scaleY:1.1645,rotation:-29.9991,x:-108.65,y:-363.7,alpha:0.2188},0).to({_off:true},1).wait(5).to({_off:false,scaleX:0.9876,scaleY:0.9876,rotation:14.9998,x:-66.75,y:-364,alpha:1},0).wait(1).to({scaleX:1.1203,scaleY:1.1203,rotation:-18.7494,x:-98.175,y:-359.3875,alpha:0.4141},0).wait(1).to({scaleX:1.1645,scaleY:1.1645,rotation:-29.9991,x:-108.65,y:-357.85,alpha:0.2188},0).to({_off:true},1).wait(1).to({_off:false,scaleX:0.9876,scaleY:0.9876,rotation:14.9998,x:-66.75,y:-364,alpha:1},0).wait(1).to({scaleX:1.1203,scaleY:1.1203,rotation:-18.7494,x:-98.175,y:-363.775,alpha:0.4141},0).wait(1).to({scaleX:1.1645,scaleY:1.1645,rotation:-29.9991,x:-108.65,y:-363.7,alpha:0.2188},0).to({_off:true},1).wait(151));
	this.timeline.addTween(cjs.Tween.get(this.instance_11).wait(351).to({_off:false},0).wait(1).to({x:-54.85,y:-212.25,alpha:1},0).wait(1).to({regX:0.9,x:-54.95,y:-211.3,alpha:0.8965},0).wait(1).to({x:-56.3,y:-210.1,alpha:0.7636},0).wait(1).to({x:-57.9,y:-208.65,alpha:0.6048},0).wait(1).to({x:-59.7,y:-207.05,alpha:0.4229},0).wait(1).to({x:-61.7,y:-205.2,alpha:0.2205},0).wait(1).to({regX:0,x:-64.85,y:-203.25,alpha:0},0).to({_off:true},1).wait(124));
	this.timeline.addTween(cjs.Tween.get(this.instance_12).wait(370).to({_off:false},0).wait(1).to({regX:2.3,regY:1,scaleX:0.8633,scaleY:0.8633,x:-77.4,y:-337},0).wait(1).to({regX:0,regY:0,scaleX:1,scaleY:1,x:-80.65,y:-342.85},0).wait(1).to({regX:2.3,regY:1,scaleX:0.9896,scaleY:0.9896,x:-78.1,y:-340.7},0).wait(1).to({scaleX:0.9586,scaleY:0.9586,x:-77.55,y:-337.45},0).wait(1).to({regX:0,regY:0,scaleX:0.9068,scaleY:0.9068,x:-78.65,y:-332.85},0).to({scaleX:1,scaleY:1,x:-79.65,y:-336.85},2).wait(3).to({scaleX:1.1165,scaleY:1.1165},0).wait(1).to({regX:2.3,regY:1,scaleX:0.8111,scaleY:0.8111,x:-77.05,y:-335.85,alpha:0.3262},0).wait(1).to({regX:0,regY:0,scaleX:0.7092,scaleY:0.7092,x:-78.65,y:-336.6,alpha:0.1016},0).to({_off:true},1).wait(100));
	...
	this.timeline.addTween(cjs.Tween.get(this.c).wait(9).to({regX:-28.1,regY:-147,x:-28.1,y:-155.4},0).wait(1).to({regX:0,regY:0,x:0,y:-10},0).wait(1).to({regX:-28.1,regY:-147,x:-28.1,y:-156.2},0).wait(1).to({y:-153.45},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({y:1},0).wait(1).to({y:0},0).wait(1).to({y:2},0).wait(1).to({regX:-28.1,regY:-147,x:-28.1,y:-152.5},0).wait(1).to({regX:0,regY:0,x:0,y:-8},0).wait(1).to({regX:-28.1,regY:-147,x:-28.1,y:-152.75},0).wait(1).to({y:-145.8},0).wait(1).to({regX:0,regY:0,x:0,y:4},0).wait(1).to({regX:-28.1,regY:-147,x:-28.1,y:-143.75},0).wait(1).to({y:-146.15},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({y:2},0).wait(1).to({y:-7},0).wait(1).to({regX:-28.1,regY:-147,x:-28.1,y:-151.95},0).wait(1).to({y:-146.05},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({y:-7},0).wait(1).to({regX:-28.1,regY:-147,x:-28.1,y:-151.95},0).wait(1).to({y:-146.05},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({regX:-28.1,regY:-147,x:-28.1,y:-146.1},0).wait(1).to({y:-146.75},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({y:6},0).wait(1).to({regX:-28.1,regY:-147,x:-28.1,y:-156},0).wait(1).to({regX:0,regY:0,x:0,y:-14},0).wait(1).to({regX:-28.1,regY:-147,x:-28.1,y:-159.95},0).wait(1).to({y:-156.35},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({regX:-28.1,regY:-147,x:-28.1,y:-145},0).wait(1).to({regX:0,regY:0,x:0,y:-1},0).wait(1).to({regX:-28.1,regY:-147,x:-28.1,y:-147.25},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({y:6},0).wait(1).to({regX:-28.1,regY:-147,x:-28.1,y:-156},0).wait(1).to({regX:0,regY:0,x:0,y:-14},0).wait(1).to({regX:-28.1,regY:-147,x:-28.1,y:-159.95},0).wait(1).to({y:-156.35},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({regX:-28.1,regY:-147,x:-28.1,y:-145},0).wait(1).to({regX:0,regY:0,x:0,y:-1},0).wait(1).to({regX:-28.1,regY:-147,x:-28.1,y:-147.25},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(2).to({regX:-28.1,regY:-147,x:-28.1,y:-146.4},0).wait(1).to({y:-144},0).wait(1).to({y:-141.65},0).wait(1).to({regX:0,regY:0,x:0,y:6},0).wait(1).to({regX:-28.1,regY:-147,x:-28.1,y:-141.65},0).wait(1).to({y:-144},0).wait(1).to({y:-146.4},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(2).to({regX:-28.1,regY:-147,x:-28.1,y:-146.85},0).wait(1).to({y:-146.3},0).wait(1).to({y:-145.2},0).wait(1).to({y:-143.85},0).wait(1).to({y:-142.75},0).wait(1).to({y:-142.2},0).wait(1).to({regX:0,regY:0,x:0,y:5},0).wait(1).to({regX:-28.1,regY:-147,x:-28.1,y:-142.2},0).wait(1).to({y:-142.75},0).wait(1).to({y:-143.85},0).wait(1).to({y:-145.2},0).wait(1).to({y:-146.3},0).wait(1).to({y:-146.85},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({y:6},2).wait(1).to({regX:-28.1,regY:-147,x:-28.1,y:-142.25},0).wait(1).to({y:-145.8},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).to({y:6},2).wait(1).to({regX:-28.1,regY:-147,x:-28.1,y:-144.8},0).wait(1).to({y:-146.65},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(2).to({regX:-28.1,regY:-147,rotation:-0.0253,x:-28.15,y:-146.95},0).wait(1).to({rotation:-0.1129,x:-28.45,y:-146.6},0).wait(1).to({rotation:-0.2845,x:-29,y:-145.95},0).wait(1).to({rotation:-0.5565,x:-29.9,y:-145},0).wait(1).to({scaleX:0.9999,scaleY:0.9999,rotation:-0.898,x:-31,y:-143.65},0).wait(1).to({rotation:-1.2075,x:-32,y:-142.5},0).wait(1).to({rotation:-1.4141,x:-32.7,y:-141.7},0).wait(1).to({rotation:-1.5201,x:-33,y:-141.3},0).wait(1).to({regX:0,regY:0,rotation:-1.5505,x:-1.05,y:5},0).wait(1).to({regX:-28.1,regY:-147,rotation:-1.5305,x:-33.05,y:-141.3},0).wait(1).to({rotation:-1.4624,x:-32.8,y:-141.55},0).wait(1).to({rotation:-1.3309,x:-32.35,y:-142.05},0).wait(1).to({rotation:-1.121,x:-31.75,y:-142.85},0).wait(1).to({rotation:-0.8372,x:-30.8,y:-143.9},0).wait(1).to({scaleX:1,scaleY:1,rotation:-0.534,x:-29.8,y:-145.1},0).wait(1).to({rotation:-0.2881,x:-29,y:-146},0).wait(1).to({rotation:-0.1291,x:-28.5,y:-146.65},0).wait(1).to({rotation:-0.0467,x:-28.2,y:-146.95},0).wait(1).to({regX:0,regY:0,rotation:-0.0227,x:0,y:0},0).wait(1).to({rotation:0},0).wait(1).to({regX:-28.1,regY:-147,rotation:-0.0253,x:-28.15,y:-146.95},0).wait(1).to({rotation:-0.1129,x:-28.45,y:-146.6},0).wait(1).to({rotation:-0.2845,x:-29,y:-145.95},0).wait(1).to({rotation:-0.5565,x:-29.9,y:-145},0).wait(1).to({scaleX:0.9999,scaleY:0.9999,rotation:-0.898,x:-31,y:-143.65},0).wait(1).to({rotation:-1.2075,x:-32,y:-142.5},0).wait(1).to({rotation:-1.4141,x:-32.7,y:-141.7},0).wait(1).to({rotation:-1.5201,x:-33,y:-141.3},0).wait(1).to({regX:0,regY:0,rotation:-1.5505,x:-1.05,y:5},0).wait(1).to({regX:-28.1,regY:-147,rotation:-1.5302,x:-33,y:-141.3},0).wait(1).to({rotation:-1.461,x:-32.8,y:-141.55},0).wait(1).to({rotation:-1.3276,x:-32.35,y:-142.05},0).wait(1).to({rotation:-1.1146,x:-31.7,y:-142.85},0).wait(1).to({rotation:-0.8266,x:-30.75,y:-143.9},0).wait(1).to({scaleX:1,scaleY:1,rotation:-0.5189,x:-29.8,y:-145.1},0).wait(1).to({rotation:-0.2693,x:-28.95,y:-146},0).wait(1).to({rotation:-0.1079,x:-28.45,y:-146.65},0).wait(1).to({rotation:-0.0243,x:-28.15,y:-146.95},0).wait(1).to({regX:0,regY:0,rotation:0,x:0,y:0},0).wait(16).to({regX:-28.1,regY:-147,x:-28.1,y:-152.55},0).wait(1).to({y:-154.45},0).wait(1).to({regX:0,regY:0,x:0,y:-8},0).wait(1).to({regX:-28.1,regY:-147,x:-28.1,y:-154.35},0).wait(1).to({y:-152.25},0).wait(1).to({regX:0,regY:0,x:0,y:2},0).wait(1).to({y:1},0).wait(1).to({y:0},0).wait(7).to({regX:-28.1,regY:-147,x:-28.1,y:-155.4},0).wait(1).to({regX:0,regY:0,x:0,y:-10},0).wait(1).to({regX:-28.1,regY:-147,x:-28.1,y:-156.2},0).wait(1).to({y:-153.45},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({y:1},0).wait(1).to({y:0},0).wait(15).to({regX:-28.1,regY:-147,rotation:-0.0253,x:-28.2,y:-146.9},0).wait(1).to({rotation:-0.1129,x:-28.65,y:-146.3},0).wait(1).to({rotation:-0.2845,x:-29.6,y:-145.2},0).wait(1).to({rotation:-0.5565,x:-31,y:-143.55},0).wait(1).to({scaleX:0.9999,scaleY:0.9999,rotation:-0.898,x:-32.75,y:-141.3},0).wait(1).to({rotation:-1.2075,x:-34.35,y:-139.35},0).wait(1).to({rotation:-1.4141,x:-35.45,y:-138.05},0).wait(1).to({rotation:-1.5201,x:-36,y:-137.4},0).wait(1).to({regX:0,regY:0,rotation:-1.5505,x:-4.1,y:9},0).wait(1).to({regX:-28.1,regY:-147,rotation:-1.5305,x:-36.05,y:-137.35},0).wait(1).to({rotation:-1.4624,x:-35.7,y:-137.8},0).wait(1).to({rotation:-1.3309,x:-35,y:-138.6},0).wait(1).to({rotation:-1.121,x:-33.9,y:-139.95},0).wait(1).to({rotation:-0.8372,x:-32.4,y:-141.8},0).wait(1).to({scaleX:1,scaleY:1,rotation:-0.534,x:-30.8,y:-143.75},0).wait(1).to({rotation:-0.2881,x:-29.55,y:-145.3},0).wait(1).to({rotation:-0.1291,x:-28.7,y:-146.35},0).wait(1).to({rotation:-0.0467,x:-28.25,y:-146.9},0).wait(1).to({regX:0,regY:0,rotation:-0.0227,x:0,y:0},0).wait(1).to({rotation:0},0).wait(1).to({regX:-28.1,regY:-147,rotation:-0.147,x:-28.35,y:-146.5},0).wait(1).to({rotation:-0.7239,x:-29.05,y:-144.35},0).wait(1).to({scaleX:0.9999,scaleY:0.9999,rotation:-1.3727,x:-29.85,y:-141.9},0).wait(1).to({regX:0,regY:0,rotation:-1.5505,x:2,y:5},0).wait(18).to({regX:-28.1,regY:-147,rotation:-1.4913,x:-30,y:-141.4},0).wait(1).to({rotation:-1.2701,x:-29.75,y:-142.3},0).wait(1).to({rotation:-0.8372,x:-29.2,y:-143.9},0).wait(1).to({scaleX:1,scaleY:1,rotation:-0.3606,x:-28.6,y:-145.7},0).wait(1).to({rotation:-0.094,x:-28.3,y:-146.75},0).wait(1).to({regX:0,regY:0,rotation:-0.0227,x:0,y:0},0).wait(1).to({rotation:0},0).wait(1).to({regX:-28.1,regY:-147,rotation:-0.0894,x:-28.25,y:-146.7},0).wait(1).to({rotation:-0.4358,x:-28.65,y:-145.4},0).wait(1).to({scaleX:0.9999,scaleY:0.9999,rotation:-1.0316,x:-29.45,y:-143.15},0).wait(1).to({rotation:-1.4426,x:-29.95,y:-141.6},0).wait(1).to({regX:0,regY:0,rotation:-1.5505,x:2,y:5},0).wait(8).to({regX:-28.1,regY:-147,rotation:-1.4913,x:-30,y:-141.4},0).wait(1).to({rotation:-1.2701,x:-29.75,y:-142.3},0).wait(1).to({rotation:-0.8372,x:-29.2,y:-143.9},0).wait(1).to({scaleX:1,scaleY:1,rotation:-0.3606,x:-28.6,y:-145.7},0).wait(1).to({rotation:-0.094,x:-28.3,y:-146.75},0).wait(1).to({regX:0,regY:0,rotation:-0.0227,x:0,y:0},0).wait(5).to({rotation:0},0).wait(1).to({regX:-28.1,regY:-147,x:-28.1,y:-155.4},0).wait(1).to({regX:0,regY:0,x:0,y:-10},0).wait(1).to({regX:-28.1,regY:-147,x:-28.1,y:-156.2},0).wait(1).to({y:-153.45},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({y:1},0).wait(1).to({y:0},0).wait(9).to({x:1,y:4},1,cjs.Ease.get(1)).wait(1).to({regX:-28.1,regY:-147,x:-30.85,y:-139.25},0).wait(1).to({regX:0,regY:0,x:-4,y:9},0).to({x:0,y:13},4).wait(11).to({regX:-28.1,regY:-147,x:-28.1,y:-134.75},0).wait(1).to({y:-137.7},0).wait(1).to({y:-142.65},0).wait(1).to({y:-146.1},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(5).to({y:-1},0).wait(1).to({regX:-28.1,regY:-147,x:-28.1,y:-146},0).wait(1).to({y:-140.05},0).wait(1).to({regX:0,regY:0,x:0,y:9},0).to({y:8},2).wait(1).to({y:9},0).wait(6).to({regX:-28.1,regY:-147,x:-28.1,y:-139.2},0).wait(1).to({y:-143.5},0).wait(1).to({y:-147.8},0).wait(1).to({regX:0,regY:0,x:0,y:-2},0).wait(1).to({regX:-28.1,regY:-147,x:-28.1,y:-147.5},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(2).to({regX:-28.1,regY:-147,x:-28.1,y:-153.7},0).wait(1).to({regX:0,regY:0,x:0,y:-8},0).wait(1).to({regX:-28.1,regY:-147,x:-28.1,y:-153.85},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({regX:-28.1,regY:-147,x:-28.1,y:-155.4},0).wait(1).to({regX:0,regY:0,x:0,y:-10},0).wait(1).to({regX:-28.1,regY:-147,x:-28.1,y:-156.2},0).wait(1).to({y:-153.45},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({y:1},0).wait(1).to({y:0},0).wait(1).to({x:1,y:4},1,cjs.Ease.get(1)).wait(1).to({regX:-28.1,regY:-147,x:-30.85,y:-139.25},0).wait(1).to({regX:0,regY:0,x:-4,y:9},0).to({x:0,y:13},4).wait(8).to({regX:-28.1,regY:-147,x:-28.1,y:-136.25},0).wait(1).to({y:-144},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({y:2},0).wait(1).to({regX:-28.1,regY:-147,x:-28.1,y:-148},0).wait(1).to({regX:0,regY:0,x:0,y:-2},0).wait(1).to({regX:-28.1,regY:-147,x:-28.1,y:-147.15},0).wait(1).to({regX:0,regY:0,x:0,y:2},0).wait(1).to({regX:-28.1,regY:-147,x:-28.1,y:-146.5},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(2).to({regX:-28.1,regY:-147,x:-28.1,y:-146.4},0).wait(1).to({y:-144},0).wait(1).to({y:-141.65},0).wait(1).to({regX:0,regY:0,x:0,y:6},0).wait(1).to({regX:-28.1,regY:-147,x:-28.1,y:-141.6},0).wait(1).to({y:-141.9},0).wait(1).to({regX:0,regY:0,x:0,y:5},0).wait(5).to({regX:-28.1,regY:-147,x:-28.1,y:-142.4},0).wait(1).to({y:-143.9},0).wait(1).to({y:-146.15},0).wait(1).to({y:-147.6},0).wait(1).to({regX:0,regY:0,x:0,y:-1},0).wait(1).to({regX:-28.1,regY:-147,x:-28.1,y:-147.25},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({y:5},0).wait(1).to({regX:-28.1,regY:-147,x:-28.1,y:-154.6},0).wait(1).to({regX:0,regY:0,x:0,y:-10},0).wait(1).to({regX:-28.1,regY:-147,x:-28.1,y:-156.2},0).wait(1).to({y:-153.45},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({y:1},0).wait(1).to({y:0},0).wait(9).to({regX:-28.1,regY:-147,x:-28.1,y:-154.5},0).wait(1).to({regX:0,regY:0,x:0,y:-10},0).wait(2).to({regX:-28.1,regY:-147,x:-28.1,y:-155},0).wait(1).to({y:-149},0).wait(1).to({regX:0,regY:0,x:0,y:8},0).to({y:5},2).wait(7).to({regX:-28.1,regY:-147,x:-28.1,y:-142.35},0).wait(1).to({y:-143.55},0).wait(1).to({y:-145.5},0).wait(1).to({y:-146.7},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({y:2},0).wait(1).to({y:-7},0).wait(1).to({regX:-28.1,regY:-147,x:-28.1,y:-151.95},0).wait(1).to({y:-146.05},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({y:-7},0).wait(1).to({regX:-28.1,regY:-147,x:-28.1,y:-151.95},0).wait(1).to({y:-146.05},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({regX:-28.1,regY:-147,x:-28.1,y:-146.1},0).wait(1).to({y:-146.75},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(2).to({regX:-28.1,regY:-147,x:-25.1,y:-143.6},0).wait(1).to({regX:0,regY:0,x:4,y:4.55},0).to({x:-2,y:8.8},2).wait(1).to({regX:-28.1,regY:-147,x:-28.95,y:-137.55},0).wait(1).to({x:-28.3,y:-137.15},0).wait(1).to({regX:0,regY:0,x:0,y:10},0).wait(5).to({regX:-28.1,regY:-147,x:-28.1,y:-137.7},0).wait(1).to({y:-140.15},0).wait(1).to({y:-143.85},0).wait(1).to({y:-146.35},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(32).to({regX:-28.1,regY:-147,rotation:-0.0253,x:-28.15,y:-146.95},0).wait(1).to({rotation:-0.1129,x:-28.45,y:-146.6},0).wait(1).to({rotation:-0.2845,x:-29,y:-145.95},0).wait(1).to({rotation:-0.5565,x:-29.9,y:-145},0).wait(1).to({scaleX:0.9999,scaleY:0.9999,rotation:-0.898,x:-31,y:-143.65},0).wait(1).to({rotation:-1.2075,x:-32,y:-142.5},0).wait(1).to({rotation:-1.4141,x:-32.7,y:-141.7},0).wait(1).to({rotation:-1.5201,x:-33,y:-141.3},0).wait(1).to({regX:0,regY:0,rotation:-1.5505,x:-1.05,y:5},0).wait(1).to({regX:-28.1,regY:-147,rotation:-1.5305,x:-33.05,y:-141.3},0).wait(1).to({rotation:-1.4624,x:-32.8,y:-141.55},0).wait(1).to({rotation:-1.3309,x:-32.35,y:-142.05},0).wait(1).to({rotation:-1.121,x:-31.75,y:-142.85},0).wait(1).to({rotation:-0.8372,x:-30.8,y:-143.9},0).wait(1).to({scaleX:1,scaleY:1,rotation:-0.534,x:-29.8,y:-145.1},0).wait(1).to({rotation:-0.2881,x:-29,y:-146},0).wait(1).to({rotation:-0.1291,x:-28.5,y:-146.65},0).wait(1).to({rotation:-0.0467,x:-28.2,y:-146.95},0).wait(1).to({regX:0,regY:0,rotation:-0.0227,x:0,y:0},0).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-416.9,-680.4,813.5,901.4);
...
// stage content:
(lib._423_2 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{end0:14,scene1:15,end1:169,scene2:170,end2:312,scene3:313,end3:438,scene4:439,end4:569,scene5:570,end5:734,scene6:735,end6:904,scene7:905,end7:1028});
	...
	this.frame_313 = function() {
		exportRoot._g.m1 = "ｱﾅｳﾝｻｰを目指してた頃､";
		exportRoot._g.m2 = "";
		exportRoot._g.m3 = "";
		exportRoot._g.m4 = "";
		exportRoot._u.setText();
	...
	this.frame_581 = function() {
		exportRoot._g.m1 = this.m.t[exportRoot._g.idx][1];
		exportRoot._g.m2 = "てやつよ♪";
		exportRoot._u.setText();
		exportRoot._u.setFace("ch2", 10);
		//this.ch2.gotoAndPlay("laugh3");
	}
	...
	this.frame_735 = function() {
		exportRoot._g.m1 = "めっちゃ好きやねん!";
		exportRoot._g.m2 = "";
		exportRoot._g.m3 = "";
		exportRoot._g.m4 = "";
		exportRoot._u.setText();
		exportRoot._u.setFace("ch2", 2);
		this.ch2.gotoAndPlay("happy");
	}
	...
	this.frame_784 = function() {
		exportRoot._g.m2 = "あ､あら､";
		exportRoot._u.setText();
		this.ch2.gotoAndPlay("shy_jump");
	}
	...
	this.frame_833 = function() {
		exportRoot._g.m3 = "でも､あなたが相手だと､";
		exportRoot._u.setText();
		this.ch2.gotoAndPlay("nod");
	}
	this.frame_851 = function() {
		exportRoot._g.m3 = this.m.t[exportRoot._g.idx][3];
		exportRoot._g.m4 = "ぴり照れるわ……";
		exportRoot._u.setText();
		exportRoot._u.setFace("ch2", 10);
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(14).call(this.frame_14).wait(1).call(this.frame_15).wait(19).call(this.frame_34).wait(17).call(this.frame_51).wait(17).call(this.frame_68).wait(23).call(this.frame_91).wait(13).call(this.frame_104).wait(9).call(this.frame_113).wait(28).call(this.frame_141).wait(14).call(this.frame_155).wait(14).call(this.frame_169).wait(1).call(this.frame_170).wait(10).call(this.frame_180).wait(30).call(this.frame_210).wait(20).call(this.frame_230).wait(26).call(this.frame_256).wait(28).call(this.frame_284).wait(13).call(this.frame_297).wait(15).call(this.frame_312).wait(1).call(this.frame_313).wait(27).call(this.frame_340).wait(15).call(this.frame_355).wait(30).call(this.frame_385).wait(19).call(this.frame_404).wait(15).call(this.frame_419).wait(19).call(this.frame_438).wait(1).call(this.frame_439).wait(21).call(this.frame_460).wait(28).call(this.frame_488).wait(23).call(this.frame_511).wait(27).call(this.frame_538).wait(10).call(this.frame_548).wait(21).call(this.frame_569).wait(1).call(this.frame_570).wait(11).call(this.frame_581).wait(20).call(this.frame_601).wait(25).call(this.frame_626).wait(18).call(this.frame_644).wait(24).call(this.frame_668).wait(24).call(this.frame_692).wait(17).call(this.frame_709).wait(25).call(this.frame_734).wait(1).call(this.frame_735).wait(24).call(this.frame_759).wait(18).call(this.frame_777).wait(7).call(this.frame_784).wait(13).call(this.frame_797).wait(29).call(this.frame_826).wait(7).call(this.frame_833).wait(18).call(this.frame_851).wait(38).call(this.frame_889).wait(15).call(this.frame_904).wait(1).call(this.frame_905).wait(8).call(this.frame_913).wait(6).call(this.frame_919).wait(15).call(this.frame_934).wait(7).call(this.frame_941).wait(18).call(this.frame_959).wait(14).call(this.frame_973).wait(31).call(this.frame_1004).wait(9).call(this.frame_1013).wait(15).call(this.frame_1028).wait(5));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1033));
	...
	this.timeline.addTween(cjs.Tween.get(this.sender).wait(1028).to({_off:false},0).wait(5));
	...
	this.timeline.addTween(cjs.Tween.get(this.loader).wait(1033));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(15).to({alpha:0.1992},3,cjs.Ease.get(1)).to({_off:true},1).wait(1014));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(12).to({_off:false},0).to({_off:true},3).wait(1018));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).to({_off:true},15).wait(1018));
	...
	this.timeline.addTween(cjs.Tween.get(this.window_1).wait(15).to({y:301.1},0).wait(1).to({regX:132.8,regY:98.8,x:134.8,y:398.6},0).wait(1).to({y:394.65},0).wait(1).to({y:388},0).wait(1).to({y:378.75},0).wait(1).to({y:367.25},0).wait(1).to({y:354.25},0).wait(1).to({y:340.85},0).wait(1).to({y:328.45},0).wait(1).to({y:318.45},0).wait(1).to({y:312},0).wait(1).to({regX:0,regY:0,x:2,y:211},0).wait(1).to({regX:132.8,regY:98.8,x:134.8,y:310.3},0).wait(1).to({y:311.9},0).wait(1).to({regX:0,regY:0,x:2,y:214},0).wait(964).to({regX:132.8,regY:98.8,x:134.8,y:313.9},0).wait(1).to({y:317.75},0).wait(1).to({y:325},0).wait(1).to({y:336.4},0).wait(1).to({y:351.7},0).wait(1).to({y:368.85},0).wait(1).to({y:384.15},0).wait(1).to({y:395.55},0).wait(1).to({y:402.8},0).wait(1).to({y:406.65},0).wait(1).to({regX:0,regY:0,x:2,y:309},0).to({_off:true},1).wait(29));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_8},{t:this.instance_7},{t:this.instance_6},{t:this.instance_5},{t:this.instance_4}]},998).wait(35));
	...
	this.timeline.addTween(cjs.Tween.get(this.glitters).wait(998).to({_off:false},0).wait(35));
	...
	this.timeline.addTween(cjs.Tween.get(this.fns).wait(998).to({_off:false},0).wait(35));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(986).to({_off:false},0).to({alpha:0.8984},11).to({_off:true},1).wait(35));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(15).to({_off:false},0).to({alpha:0},3).to({_off:true},1).wait(77).to({_off:false},0).to({alpha:1},8).to({alpha:0},6).to({_off:true},1).wait(794).to({_off:false,alpha:1},0).to({alpha:0},7).to({_off:true},1).wait(120));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_12},{t:this.instance_11}]}).to({state:[]},15).wait(1018));

	// overlay_top
	this.instance_13 = new lib.overlay_black();
	this.instance_13.parent = this;
	this.instance_13.setTransform(120,-123);
	this.instance_13._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_13).wait(104).to({_off:false},0).wait(67).to({regX:1,x:121,y:-123.3},0).wait(1).to({y:-124.15},0).wait(1).to({y:-125.6},0).wait(1).to({y:-127.6},0).wait(1).to({y:-130.1},0).wait(1).to({y:-133},0).wait(1).to({y:-136.35},0).wait(1).to({y:-140.05},0).wait(1).to({y:-144.1},0).wait(1).to({y:-148.4},0).wait(1).to({y:-152.9},0).wait(1).to({y:-157.5},0).wait(1).to({y:-162.2},0).wait(1).to({y:-166.9},0).wait(1).to({y:-171.55},0).wait(1).to({y:-176.1},0).wait(1).to({y:-180.4},0).wait(1).to({y:-184.45},0).wait(1).to({y:-188.15},0).wait(1).to({y:-191.4},0).wait(1).to({y:-194.25},0).wait(1).to({y:-196.5},0).wait(1).to({y:-198.2},0).wait(1).to({y:-199.25},0).wait(1).to({regX:0,x:120,y:-199.65},0).to({_off:true},1).wait(837));

	// overlay_bottom
	this.instance_14 = new lib.overlay_black();
	this.instance_14.parent = this;
	this.instance_14.setTransform(120,340);
	this.instance_14._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_14).wait(104).to({_off:false},0).wait(67).to({regX:1,x:121,y:340.65},0).wait(1).to({y:342.6},0).wait(1).to({y:345.75},0).wait(1).to({y:350.1},0).wait(1).to({y:355.55},0).wait(1).to({y:361.95},0).wait(1).to({y:369.3},0).wait(1).to({y:377.45},0).wait(1).to({y:386.3},0).wait(1).to({y:395.7},0).wait(1).to({y:405.55},0).wait(1).to({y:415.7},0).wait(1).to({y:426},0).wait(1).to({y:436.3},0).wait(1).to({y:446.5},0).wait(1).to({y:456.35},0).wait(1).to({y:465.8},0).wait(1).to({y:474.65},0).wait(1).to({y:482.75},0).wait(1).to({y:490},0).wait(1).to({y:496.15},0).wait(1).to({y:501.15},0).wait(1).to({y:504.9},0).wait(1).to({y:507.2},0).wait(1).to({regX:0,x:120,y:508},0).to({_off:true},1).wait(837));

	// steam
	this.instance_15 = new lib.steam_container();
	this.instance_15.parent = this;
	this.instance_15.setTransform(48.25,235.05,0.7916,0.7916,0,0,0,30.7,73.5);
	this.instance_15._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_15).wait(15).to({_off:false},0).wait(89).to({regY:73.7,scaleX:1.1916,scaleY:1.1916,x:18,y:297.85},0).wait(67).to({regX:31.9,regY:54.6,scaleX:1.191,scaleY:1.1912,x:19.5,y:274.95},0).wait(1).to({scaleX:1.1891,scaleY:1.1899,x:19.7,y:274.5},0).wait(1).to({scaleX:1.1858,scaleY:1.1877,x:20,y:273.75},0).wait(1).to({scaleX:1.1809,scaleY:1.1845,x:20.4,y:272.6},0).wait(1).to({scaleX:1.1745,scaleY:1.1802,x:21,y:271.1},0).wait(1).to({scaleX:1.1662,scaleY:1.1747,x:21.8,y:269.2},0).wait(1).to({scaleX:1.1561,scaleY:1.168,x:22.75,y:266.8},0).wait(1).to({scaleX:1.144,scaleY:1.16,x:23.9,y:264},0).wait(1).to({scaleX:1.1299,scaleY:1.1506,x:25.2,y:260.7},0).wait(1).to({scaleX:1.1138,scaleY:1.1399,x:26.7,y:256.95},0).wait(1).to({scaleX:1.0959,scaleY:1.1279,x:28.35,y:252.8},0).wait(1).to({scaleX:1.0763,scaleY:1.115,x:30.2,y:248.25},0).wait(1).to({scaleX:1.0556,scaleY:1.1012,x:32.1,y:243.35},0).wait(1).to({scaleX:1.0342,scaleY:1.0869,x:34.1,y:238.4},0).wait(1).to({scaleX:1.0127,scaleY:1.0726,x:36.05,y:233.35},0).wait(1).to({scaleX:0.9917,scaleY:1.0587,x:38.05,y:228.45},0).wait(1).to({scaleX:0.9718,scaleY:1.0455,x:39.9,y:223.85},0).wait(1).to({scaleX:0.9534,scaleY:1.0332,x:41.6,y:219.5},0).wait(1).to({scaleX:0.9366,scaleY:1.0221,x:43.2,y:215.65},0).wait(1).to({scaleX:0.9218,scaleY:1.0122,x:44.55,y:212.15},0).wait(1).to({scaleX:0.9089,scaleY:1.0037,x:45.75,y:209.15},0).wait(1).to({scaleX:0.8979,scaleY:0.9963,x:46.8,y:206.6},0).wait(1).to({scaleX:0.8887,scaleY:0.9902,x:47.65,y:204.45},0).wait(1).to({scaleX:0.8813,scaleY:0.9853,x:48.3,y:202.7},0).wait(1).to({scaleX:0.8754,scaleY:0.9814,x:48.9,y:201.35},0).wait(1).to({scaleX:0.871,scaleY:0.9785,x:49.3,y:200.35},0).wait(1).to({scaleX:0.868,scaleY:0.9765,x:49.6,y:199.6},0).wait(1).to({scaleX:0.8663,scaleY:0.9754,x:49.75,y:199.25},0).wait(1).to({regX:30.8,regY:73.7,scaleX:0.8658,scaleY:0.975,x:48.75,y:217.75},0).wait(240).to({regX:30.9,scaleX:1.1066,scaleY:1.2462,x:29.35,y:213.6},0).to({y:275.6},30,cjs.Ease.quadInOut).wait(140).to({regX:30.7,regY:73.8,scaleX:1.1493,scaleY:1.2943,x:23.55,y:289.95},33,cjs.Ease.quadInOut).wait(136).to({regX:31.9,regY:54.6,scaleX:1.1494,scaleY:1.2945,x:24.9,y:265.15},0).wait(1).to({scaleX:1.1499,scaleY:1.295},0).wait(1).to({scaleX:1.1507,scaleY:1.296,x:24.8,y:265.25},0).wait(1).to({scaleX:1.152,scaleY:1.2973,x:24.7,y:265.4},0).wait(1).to({scaleX:1.1536,scaleY:1.2991,x:24.6,y:265.6},0).wait(1).to({scaleX:1.1556,scaleY:1.3014,x:24.4,y:265.8},0).wait(1).to({scaleX:1.1581,scaleY:1.3042,x:24.2,y:266.05},0).wait(1).to({scaleX:1.1611,scaleY:1.3076,x:23.95,y:266.4},0).wait(1).to({scaleX:1.1646,scaleY:1.3115,x:23.65,y:266.8},0).wait(1).to({scaleX:1.1686,scaleY:1.316,x:23.35,y:267.25},0).wait(1).to({scaleX:1.1731,scaleY:1.3211,x:22.9,y:267.75},0).wait(1).to({scaleX:1.1781,scaleY:1.3268,x:22.5,y:268.3},0).wait(1).to({scaleX:1.1836,scaleY:1.333,x:22.05,y:268.95},0).wait(1).to({scaleX:1.1895,scaleY:1.3396,x:21.55,y:269.6},0).wait(1).to({scaleX:1.1957,scaleY:1.3466,x:21.05,y:270.25},0).wait(1).to({scaleX:1.2021,scaleY:1.3538,x:20.5,y:270.95},0).wait(1).to({scaleX:1.2086,scaleY:1.3611,x:19.95,y:271.7},0).wait(1).to({scaleX:1.215,scaleY:1.3683,x:19.4,y:272.4},0).wait(1).to({scaleX:1.2212,scaleY:1.3753,x:18.85,y:273.15},0).wait(1).to({scaleX:1.2272,scaleY:1.382,x:18.35,y:273.75},0).wait(1).to({scaleX:1.2327,scaleY:1.3883,x:17.9,y:274.4},0).wait(1).to({scaleX:1.2379,scaleY:1.3941,x:17.5,y:274.95},0).wait(1).to({scaleX:1.2425,scaleY:1.3993,x:17.1,y:275.5},0).wait(1).to({scaleX:1.2467,scaleY:1.404,x:16.7,y:275.95},0).wait(1).to({scaleX:1.2503,scaleY:1.4081,x:16.45,y:276.4},0).wait(1).to({scaleX:1.2535,scaleY:1.4116,x:16.15,y:276.75},0).wait(1).to({scaleX:1.2562,scaleY:1.4147,x:15.9,y:277},0).wait(1).to({scaleX:1.2584,scaleY:1.4172,x:15.75,y:277.3},0).wait(1).to({scaleX:1.2603,scaleY:1.4193,x:15.6,y:277.5},0).wait(1).to({scaleX:1.2618,scaleY:1.421,x:15.45,y:277.65},0).wait(1).to({scaleX:1.2629,scaleY:1.4222,x:15.4,y:277.75},0).wait(1).to({scaleX:1.2636,scaleY:1.4231,x:15.3,y:277.85},0).wait(1).to({scaleX:1.264,scaleY:1.4235,x:15.25,y:277.9},0).wait(1).to({regX:30.7,regY:73.8,scaleX:1.2642,scaleY:1.4237,x:13.7,y:305.25},0).wait(94).to({regX:30.9,scaleX:0.7677,scaleY:0.8646,x:55.35,y:208.2},0).to({_off:true},93).wait(35));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_16).wait(15).to({_off:false},0).wait(1018));

	// book
	this.book1 = new lib.book_1();
	this.book1.name = "book1";
	this.book1.parent = this;
	this.book1.setTransform(-201.2,278.75,0.5077,0.5076,0,0,0,305.7,114.2);

	this.timeline.addTween(cjs.Tween.get(this.book1).wait(15).to({x:112.1,y:277.45},0).wait(89).to({regX:305.6,regY:114.3,scaleX:0.7064,scaleY:0.7062,x:105.75,y:370.3},0).wait(67).to({regX:306,regY:114,scaleX:0.706,scaleY:0.7059,x:106.1,y:369.9},0).wait(1).to({scaleX:0.7048,scaleY:0.7047,y:369.4},0).wait(1).to({scaleX:0.7028,scaleY:0.7027,x:106.15,y:368.45},0).wait(1).to({scaleX:0.6999,scaleY:0.6998,x:106.25,y:367.05},0).wait(1).to({scaleX:0.6959,scaleY:0.6958,x:106.4,y:365.2},0).wait(1).to({scaleX:0.6909,scaleY:0.6908,x:106.55,y:362.85},0).wait(1).to({scaleX:0.6847,scaleY:0.6846,x:106.75,y:360},0).wait(1).to({scaleX:0.6774,scaleY:0.6773,x:106.95,y:356.55},0).wait(1).to({scaleX:0.6688,scaleY:0.6687,x:107.25,y:352.5},0).wait(1).to({scaleX:0.6589,scaleY:0.6588,x:107.55,y:347.95},0).wait(1).to({scaleX:0.648,scaleY:0.6479,x:107.9,y:342.8},0).wait(1).to({scaleX:0.6361,scaleY:0.636,x:108.3,y:337.25},0).wait(1).to({scaleX:0.6234,scaleY:0.6233,x:108.65,y:331.35},0).wait(1).to({scaleX:0.6104,scaleY:0.6103,x:109.05,y:325.25},0).wait(1).to({scaleX:0.5973,scaleY:0.5972,x:109.5,y:319.15},0).wait(1).to({scaleX:0.5845,scaleY:0.5844,x:109.9,y:313.15},0).wait(1).to({scaleX:0.5723,scaleY:0.5723,x:110.3,y:307.5},0).wait(1).to({scaleX:0.5611,scaleY:0.561,x:110.65,y:302.25},0).wait(1).to({scaleX:0.5509,scaleY:0.5508,x:110.95,y:297.5},0).wait(1).to({scaleX:0.5418,scaleY:0.5418,x:111.25,y:293.25},0).wait(1).to({scaleX:0.534,scaleY:0.5339,x:111.5,y:289.55},0).wait(1).to({scaleX:0.5273,scaleY:0.5272,x:111.7,y:286.45},0).wait(1).to({scaleX:0.5217,scaleY:0.5216,x:111.9,y:283.8},0).wait(1).to({scaleX:0.5171,scaleY:0.5171,x:112.05,y:281.7},0).wait(1).to({scaleX:0.5135,scaleY:0.5135,x:112.15,y:280.05},0).wait(1).to({scaleX:0.5109,scaleY:0.5109,x:112.2,y:278.8},0).wait(1).to({scaleX:0.509,scaleY:0.509,x:112.25,y:277.95},0).wait(1).to({scaleX:0.508,scaleY:0.508,x:112.3,y:277.45},0).wait(1).to({regX:305.7,regY:114.2,scaleX:0.5077,scaleY:0.5076,x:112.1},0).wait(240).to({alpha:0},9).to({_off:true},1).wait(584));

	// ch
	this.ch1 = new lib.character1_container();
	this.ch1.name = "ch1";
	this.ch1.parent = this;
	this.ch1.setTransform(-187,232.35,0.5077,0.5077,0,0,0,0.1,0.3);

	this.timeline.addTween(cjs.Tween.get(this.ch1).wait(15).to({x:126.3},0).wait(89).to({regY:0.4,scaleX:0.7064,scaleY:0.7064,x:125.85,y:307.55},0).wait(67).to({regX:-9.2,regY:-230.7,scaleX:0.706,scaleY:0.706,x:119.3,y:144.25},0).wait(1).to({scaleX:0.7048,scaleY:0.7048,y:144.05},0).wait(1).to({scaleX:0.7028,scaleY:0.7028,x:119.35,y:143.75},0).wait(1).to({scaleX:0.6999,scaleY:0.6999,y:143.35},0).wait(1).to({scaleX:0.6959,scaleY:0.6959,x:119.4,y:142.75},0).wait(1).to({scaleX:0.6909,scaleY:0.6909,x:119.45,y:142},0).wait(1).to({scaleX:0.6847,scaleY:0.6847,x:119.5,y:141.1},0).wait(1).to({scaleX:0.6774,scaleY:0.6774,x:119.6,y:140},0).wait(1).to({scaleX:0.6688,scaleY:0.6688,x:119.7,y:138.7},0).wait(1).to({scaleX:0.659,scaleY:0.659,x:119.85,y:137.3},0).wait(1).to({scaleX:0.648,scaleY:0.648,x:119.95,y:135.65},0).wait(1).to({scaleX:0.6361,scaleY:0.6361,x:120.1,y:133.9},0).wait(1).to({scaleX:0.6234,scaleY:0.6234,x:120.2,y:132.1},0).wait(1).to({scaleX:0.6104,scaleY:0.6104,x:120.4,y:130.15},0).wait(1).to({scaleX:0.5973,scaleY:0.5973,x:120.5,y:128.2},0).wait(1).to({scaleX:0.5845,scaleY:0.5845,x:120.65,y:126.3},0).wait(1).to({scaleX:0.5723,scaleY:0.5723,x:120.8,y:124.55},0).wait(1).to({scaleX:0.5611,scaleY:0.5611,x:120.95,y:122.9},0).wait(1).to({scaleX:0.5509,scaleY:0.5509,x:121.05,y:121.4},0).wait(1).to({scaleX:0.5419,scaleY:0.5419,x:121.15,y:120.05},0).wait(1).to({scaleX:0.534,scaleY:0.534,x:121.25,y:118.9},0).wait(1).to({scaleX:0.5273,scaleY:0.5273,x:121.3,y:117.9},0).wait(1).to({scaleX:0.5217,scaleY:0.5217,x:121.35,y:117.1},0).wait(1).to({scaleX:0.5171,scaleY:0.5171,x:121.45,y:116.4},0).wait(1).to({scaleX:0.5135,scaleY:0.5135,x:121.5,y:115.9},0).wait(1).to({scaleX:0.5109,scaleY:0.5109,y:115.5},0).wait(1).to({scaleX:0.5091,scaleY:0.5091,y:115.2},0).wait(1).to({scaleX:0.508,scaleY:0.508,x:121.55,y:115.1},0).wait(1).to({regX:0.1,regY:0.3,scaleX:0.5077,scaleY:0.5077,x:126.3,y:232.35},0).wait(240).to({alpha:0},9).to({_off:true},1).wait(584));

	// bg
	this.bg1 = new lib.bg_zoom_half();
	this.bg1.name = "bg1";
	this.bg1.parent = this;
	this.bg1.setTransform(-356.55,-18.75,0.5077,0.5077,0,0,0,-0.3,-0.1);

	this.timeline.addTween(cjs.Tween.get(this.bg1).wait(15).to({x:-43.25,y:-20.15},0).wait(89).to({regX:-0.4,scaleX:0.7064,scaleY:0.7064,x:-110.05,y:-43.8},0).wait(67).to({regX:306,regY:350,scaleX:0.706,scaleY:0.706,x:106.45,y:203.4},0).wait(1).to({scaleX:0.7048,scaleY:0.7048,y:203.15},0).wait(1).to({scaleX:0.7028,scaleY:0.7028,x:106.5,y:202.7},0).wait(1).to({scaleX:0.6999,scaleY:0.6999,x:106.6,y:202},0).wait(1).to({scaleX:0.6959,scaleY:0.6959,x:106.7,y:201.1},0).wait(1).to({scaleX:0.6909,scaleY:0.6909,x:106.85,y:199.9},0).wait(1).to({scaleX:0.6847,scaleY:0.6847,x:107.1,y:198.5},0).wait(1).to({scaleX:0.6774,scaleY:0.6774,x:107.25,y:196.85},0).wait(1).to({scaleX:0.6688,scaleY:0.6688,x:107.55,y:194.8},0).wait(1).to({scaleX:0.659,scaleY:0.659,x:107.85,y:192.55},0).wait(1).to({scaleX:0.648,scaleY:0.648,x:108.15,y:190.05},0).wait(1).to({scaleX:0.6361,scaleY:0.6361,x:108.5,y:187.3},0).wait(1).to({scaleX:0.6234,scaleY:0.6234,x:108.85,y:184.35},0).wait(1).to({scaleX:0.6104,scaleY:0.6104,x:109.25,y:181.35},0).wait(1).to({scaleX:0.5973,scaleY:0.5973,x:109.65,y:178.3},0).wait(1).to({scaleX:0.5845,scaleY:0.5845,x:110,y:175.35},0).wait(1).to({scaleX:0.5723,scaleY:0.5723,x:110.4,y:172.55},0).wait(1).to({scaleX:0.5611,scaleY:0.5611,x:110.75,y:170},0).wait(1).to({scaleX:0.5509,scaleY:0.5509,x:111,y:167.6},0).wait(1).to({scaleX:0.5419,scaleY:0.5419,x:111.3,y:165.55},0).wait(1).to({scaleX:0.534,scaleY:0.534,x:111.5,y:163.7},0).wait(1).to({scaleX:0.5273,scaleY:0.5273,x:111.7,y:162.15},0).wait(1).to({scaleX:0.5217,scaleY:0.5217,x:111.9,y:160.9},0).wait(1).to({scaleX:0.5171,scaleY:0.5171,x:112.05,y:159.85},0).wait(1).to({scaleX:0.5135,scaleY:0.5135,x:112.15,y:159},0).wait(1).to({scaleX:0.5109,scaleY:0.5109,x:112.2,y:158.35},0).wait(1).to({scaleX:0.5091,scaleY:0.5091,x:112.25,y:157.95},0).wait(1).to({scaleX:0.508,scaleY:0.508,x:112.3,y:157.7},0).wait(1).to({regX:-0.3,regY:-0.1,scaleX:0.5077,scaleY:0.5077,x:-43.25,y:-20.15},0).wait(240).to({alpha:0},9).to({_off:true},1).wait(584));

	// book2
	this.book2 = new lib.book_1();
	this.book2.name = "book2";
	this.book2.parent = this;
	this.book2.setTransform(110.2,289.8,0.647,0.647,0,0,0,305.7,114.2);
	this.book2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.book2).wait(439).to({_off:false},0).to({y:349.8},30,cjs.Ease.quadInOut).to({_off:true},1).wait(435).to({_off:false,regX:305.4,regY:114.4,scaleX:0.4559,scaleY:0.4557,x:112.65,y:260.7},0).to({_off:true},93).wait(35));

	// ch2
	this.ch2 = new lib.character1_container();
	this.ch2.name = "ch2";
	this.ch2.parent = this;
	this.ch2.setTransform(789.55,233.75,0.5077,0.5077,0,0,0,0.1,0.3);

	this.timeline.addTween(cjs.Tween.get(this.ch2).wait(439).to({scaleX:0.647,scaleY:0.647,x:128.6,y:232.3},0).to({y:292.3},30,cjs.Ease.quadInOut).wait(140).to({regX:0.2,regY:0.4,scaleX:0.7762,scaleY:0.7761,x:128.35,y:328.35},33,cjs.Ease.quadInOut).wait(143).to({regX:-9.2,regY:-230.7,scaleX:0.7764,scaleY:0.7763,x:121.05,y:148.95},0).wait(1).to({scaleX:0.7769,scaleY:0.7768,y:149},0).wait(1).to({scaleX:0.7778,scaleY:0.7777},0).wait(1).to({scaleX:0.7791,scaleY:0.7791},0).wait(1).to({scaleX:0.7809,scaleY:0.7809,x:121,y:149.05},0).wait(1).to({scaleX:0.7832,scaleY:0.7832,x:121.05,y:149.1},0).wait(1).to({scaleX:0.7861,scaleY:0.786,x:121},0).wait(1).to({scaleX:0.7894,scaleY:0.7894,x:121.05,y:149.2},0).wait(1).to({scaleX:0.7934,scaleY:0.7933,x:121,y:149.25},0).wait(1).to({scaleX:0.7978,scaleY:0.7978,y:149.3},0).wait(1).to({scaleX:0.8027,scaleY:0.8027,y:149.4},0).wait(1).to({scaleX:0.808,scaleY:0.8079,y:149.5},0).wait(1).to({scaleX:0.8135,scaleY:0.8134,y:149.6},0).wait(1).to({scaleX:0.819,scaleY:0.8189,y:149.7},0).wait(1).to({scaleX:0.8243,scaleY:0.8243,x:120.95,y:149.75},0).wait(1).to({scaleX:0.8294,scaleY:0.8293,y:149.85},0).wait(1).to({scaleX:0.834,scaleY:0.8339,x:121,y:149.9},0).wait(1).to({scaleX:0.8381,scaleY:0.8381,y:149.95},0).wait(1).to({scaleX:0.8417,scaleY:0.8417,x:120.95,y:150.05},0).wait(1).to({scaleX:0.8448,scaleY:0.8448,x:121},0).wait(1).to({scaleX:0.8474,scaleY:0.8473,x:120.95,y:150.1},0).wait(1).to({scaleX:0.8495,scaleY:0.8494,x:121,y:150.15},0).wait(1).to({scaleX:0.8511,scaleY:0.851,x:120.95},0).wait(1).to({scaleX:0.8523,scaleY:0.8523,y:150.2},0).wait(1).to({scaleX:0.8532,scaleY:0.8531},0).wait(1).to({scaleX:0.8536,scaleY:0.8536,y:150.25},0).wait(1).to({regX:0.3,regY:0.4,scaleX:0.8538,scaleY:0.8537,x:129.05,y:347.55},0).wait(94).to({regX:0.1,regY:0.5,scaleX:0.4559,scaleY:0.4559,x:125.7,y:220.15},0).to({_off:true},93).wait(35));

	// bg2
	this.bg2 = new lib.bg_zoom_half();
	this.bg2.name = "bg2";
	this.bg2.parent = this;
	this.bg2.setTransform(619.75,-18.75,0.5077,0.5077,0,0,0,-0.3,-0.1);

	this.timeline.addTween(cjs.Tween.get(this.bg2).wait(439).to({scaleX:0.647,scaleY:0.647,x:-87.8,y:-89.5},0).to({y:-29.5},30,cjs.Ease.quadInOut).wait(140).to({regY:-0.2,scaleX:0.7762,scaleY:0.7762,x:-131.25,y:-57.75},33,cjs.Ease.quadInOut).wait(143).to({regX:306,regY:350,scaleX:0.7764,scaleY:0.7764,x:106.5,y:214.1},0).wait(1).to({scaleX:0.7769,scaleY:0.7769,y:214.15},0).wait(1).to({scaleX:0.7778,scaleY:0.7778,y:214.25},0).wait(1).to({scaleX:0.7791,scaleY:0.7791,x:106.45,y:214.4},0).wait(1).to({scaleX:0.7809,scaleY:0.7809,y:214.55},0).wait(1).to({scaleX:0.7832,scaleY:0.7832,x:106.4,y:214.8},0).wait(1).to({scaleX:0.7861,scaleY:0.7861,x:106.35,y:215.05},0).wait(1).to({scaleX:0.7894,scaleY:0.7894,x:106.25,y:215.4},0).wait(1).to({scaleX:0.7934,scaleY:0.7934,x:106.15,y:215.85},0).wait(1).to({scaleX:0.7978,scaleY:0.7978,x:106.1,y:216.25},0).wait(1).to({scaleX:0.8027,scaleY:0.8027,x:106,y:216.75},0).wait(1).to({scaleX:0.808,scaleY:0.808,x:105.9,y:217.25},0).wait(1).to({scaleX:0.8135,scaleY:0.8135,x:105.75,y:217.8},0).wait(1).to({scaleX:0.819,scaleY:0.819,x:105.7,y:218.4},0).wait(1).to({scaleX:0.8243,scaleY:0.8243,x:105.6,y:218.9},0).wait(1).to({scaleX:0.8294,scaleY:0.8294,x:105.5,y:219.45},0).wait(1).to({scaleX:0.834,scaleY:0.834,x:105.4,y:219.85},0).wait(1).to({scaleX:0.8381,scaleY:0.8381,x:105.3,y:220.3},0).wait(1).to({scaleX:0.8417,scaleY:0.8417,x:105.2,y:220.65},0).wait(1).to({scaleX:0.8448,scaleY:0.8448,x:105.15,y:220.95},0).wait(1).to({scaleX:0.8474,scaleY:0.8474,x:105.1,y:221.2},0).wait(1).to({scaleX:0.8495,scaleY:0.8495,y:221.4},0).wait(1).to({scaleX:0.8511,scaleY:0.8511,x:105.05,y:221.6},0).wait(1).to({scaleX:0.8523,scaleY:0.8523,x:105,y:221.7},0).wait(1).to({scaleX:0.8532,scaleY:0.8532,y:221.8},0).wait(1).to({scaleX:0.8536,scaleY:0.8536},0).wait(1).to({regX:-0.4,regY:-0.2,scaleX:0.8538,scaleY:0.8538,x:-156.6,y:-77.15},0).wait(94).to({regX:-0.6,regY:-0.4,scaleX:0.4559,scaleY:0.4559,x:-26.8,y:-6.75},0).to({_off:true},93).wait(35));
	...
	this.timeline.addTween(cjs.Tween.get(this.toggle_btn).to({_off:true},986).wait(47));
	...
	this.timeline.addTween(cjs.Tween.get(this.stage_btn).to({_off:true},998).wait(30).to({_off:false},0).wait(5));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-282,-720,1212.6,1383);
// library properties:
lib.properties = {
	id: '_423_2',
	width: 240,
	...
	opacity: 1.00,
	manifest: [
		{src:"images/bg.jpg?1605090643233", id:"_423_2_bg"},
		{src:"images/book.png?1605090643233", id:"_423_2_book"},
		{src:"images/book2.png?1605090643233", id:"_423_2_book2"},
		{src:"images/book2_blur.png?1605090643233", id:"_423_2_book2_blur"},
		{src:"images/ch_base.png?1605090643233", id:"_423_2_ch_base"},
		{src:"images/ch_face10.png?1605090643233", id:"_423_2_ch_face10"},
		{src:"images/ch_face12.png?1605090643233", id:"_423_2_ch_face12"},
		{src:"images/ch_face2.png?1605090643233", id:"_423_2_ch_face2"},
		{src:"images/ch_face3.png?1605090643233", id:"_423_2_ch_face3"},
		{src:"images/ch_face4.png?1605090643233", id:"_423_2_ch_face4"},
		{src:"images/ch_face5.png?1605090643233", id:"_423_2_ch_face5"},
		{src:"images/ch_face6.png?1605090643233", id:"_423_2_ch_face6"},
		{src:"images/ch_face7.png?1605090643233", id:"_423_2_ch_face7"},
		{src:"images/ch_face8.png?1605090643233", id:"_423_2_ch_face8"},
		{src:"images/ch_face9.png?1605090643233", id:"_423_2_ch_face9"},
		{src:"images/finish.jpg?1605090643233", id:"_423_2_finish"},
		{src:"images/finish_blur.jpg?1605090643233", id:"finish_blur"},
		{src:"images/fire.png?1605090643233", id:"fire"},
		{src:"images/steam1111.png?1605090643233", id:"steam1111"},
		{src:"images/steam.png?1605090643233", id:"steam"},
		{src:"images/tie_fp.png?1605090643233", id:"tie_fp"},
		{src:"images/tie_sp.png?1605090643233", id:"tie_sp"}
	],
	preloads: []
};
