...
(lib.bg = function() {
	this.initialize(img._488_2_bg);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,1144,1400);


(lib.bg2 = function() {
	this.initialize(img._488_2_bg2);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,1144,1400);


(lib.ch_base = function() {
	this.initialize(img._488_2_ch_base);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,1144,1400);


(lib.ch_face2 = function() {
	this.initialize(img._488_2_ch_face2);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,168,208);


(lib.ch_face3 = function() {
	this.initialize(img._488_2_ch_face3);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,168,208);


(lib.ch_face4 = function() {
	this.initialize(img._488_2_ch_face4);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,168,208);


(lib.ch_face5 = function() {
	this.initialize(img._488_2_ch_face5);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,168,208);


(lib.ch_face6 = function() {
	this.initialize(img._488_2_ch_face6);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,168,208);


(lib.ch_face7 = function() {
	this.initialize(img._488_2_ch_face7);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,168,208);


(lib.eff = function() {
	this.initialize(img._488_2_eff);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,960,669);


(lib.eff2 = function() {
	this.initialize(img._488_2_eff2);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,700,646);


(lib.eff3 = function() {
	this.initialize(img._488_2_eff3);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,850,743);


(lib.finish = function() {
	this.initialize(img._488_2_finish);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,480,620);


(lib.finish_blur = function() {
	this.initialize(img._488_2_finish_blur);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,480,620);


(lib.ke_egao = function() {
	this.initialize(img._488_2_ke_egao);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,104,80);


(lib.ke_odoroku = function() {
	this.initialize(img._488_2_ke_odoroku);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,104,80);


(lib.ke_tujo_mukure = function() {
	this.initialize(img._488_2_ke_tujo_mukure);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,104,80);


(lib.tie_fp = function() {
	this.initialize(img._488_2_tie_fp);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,240,32);


(lib.tie_sp = function() {
	this.initialize(img._488_2_tie_sp);
}).prototype = p = new cjs.Bitmap();
...
(lib.eff3_1 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(-212.5,-185.75,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.eff3_1, new cjs.Rectangle(-212.5,-185.7,425,371.5), null);
...
(lib.eff2_1 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(-175,-161.5,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.eff2_1, new cjs.Rectangle(-175,-161.5,350,323), null);


(lib.eff_1 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// レイヤー_1
	this.instance = new lib.eff();
	this.instance.parent = this;
	this.instance.setTransform(-240,-167.25,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.eff_1, new cjs.Rectangle(-240,-167.2,480,334.5), null);
...
}).prototype = getMCSymbolPrototype(lib.character1_face_eyeclose, new cjs.Rectangle(0,0,84,104), null);
...
}).prototype = getMCSymbolPrototype(lib.character1_base, new cjs.Rectangle(-120,-396,572,700), null);


(lib.ch_hair_2 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// レイヤー_3 (mask)
	var mask = new cjs.Shape();
	mask._off = true;
	mask.graphics.p("An9GGIAAsLIP7AAIAAMLg");
	mask.setTransform(52,40);

	// ke_tujo_mukure.png
	this.instance = new lib.ke_tujo_mukure();
	this.instance.parent = this;
...
p.nominalBounds = new cjs.Rectangle(1,1,102,78);
...
(lib.ch_hair = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({_off:true},2).wait(3).to({_off:false},0).wait(5));

	// ke_odoroku.png
	this.instance_1 = new lib.ke_odoroku();
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(2).to({_off:false},0).to({_off:true},1).wait(7));

	// ke_egao.png
	this.instance_2 = new lib.ke_egao();
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(3).to({_off:false},0).to({_off:true},2).wait(5));
...
p.nominalBounds = new cjs.Rectangle(0,0,572,700);
...
(lib.tie = function(mode,startPosition,loop) {
	...
	// txt
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#333333").s().p("");
	this.shape.setTransform(31.975,0.4);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#333333").s().p("AgHBMIAAg0IgtAAIAAAMIgQAAIAAhUIA9AAIAAgbIAPAAIAAAbIA9AAIAABUIgQAAIAAgMIgtAAIAAA0gAAIAJIAtAAIAAgqIgtAAgAg0AJIAtAAIAAgqIgtAAg");
	this.shape_1.setTransform(16,0.425);
	...
	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#333333").s().p("");
	this.shape_3.setTransform(-16,0.4);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#333333").s().p("");
...
(lib.eff_m = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(9,-28.75);

	this.timeline.addTween(cjs.Tween.get(this.instance).to({alpha:0},30,cjs.Ease.quadInOut).to({alpha:1},28,cjs.Ease.quadInOut).wait(1));

	// eff3.png
	this.instance_1 = new lib.eff3_1();
	this.instance_1.parent = this;
	this.instance_1.setTransform(10.5,-34.25);
	this.instance_1.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({alpha:1},30,cjs.Ease.quadInOut).to({alpha:0},28,cjs.Ease.quadInOut).wait(1));

	// eff2.png
	this.instance_2 = new lib.eff2_1();
	this.instance_2.parent = this;
	this.instance_2.setTransform(24,-3.5);
	this.instance_2.alpha = 0.5;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(1).to({alpha:0.566},0).wait(1).to({alpha:0.6295},0).wait(1).to({alpha:0.6891},0).wait(1).to({alpha:0.7439},0).wait(1).to({alpha:0.7932},0).wait(1).to({alpha:0.8368},0).wait(1).to({alpha:0.8746},0).wait(1).to({alpha:0.9069},0).wait(1).to({alpha:0.9339},0).wait(1).to({alpha:0.9558},0).wait(1).to({alpha:0.973},0).wait(1).to({alpha:0.9859},0).wait(1).to({alpha:0.9948},0).wait(1).to({alpha:1},0).wait(1).to({alpha:0},30,cjs.Ease.quadInOut).wait(1).to({alpha:0.0041},0).wait(1).to({alpha:0.0121},0).wait(1).to({alpha:0.0245},0).wait(1).to({alpha:0.0414},0).wait(1).to({alpha:0.0633},0).wait(1).to({alpha:0.0905},0).wait(1).to({alpha:0.1233},0).wait(1).to({alpha:0.1618},0).wait(1).to({alpha:0.206},0).wait(1).to({alpha:0.2558},0).wait(1).to({alpha:0.3103},0).wait(1).to({alpha:0.3687},0).wait(1).to({alpha:0.4297},0).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-231,-220,480,378);
...
(lib.character1_face = function(mode,startPosition,loop) {
	...
	var mask = new cjs.Shape();
	mask._off = true;
	mask.graphics.p("AmZH+IAAv7IMzAAIAAP7g");
	mask.setTransform(42,52);
...
p.nominalBounds = new cjs.Rectangle(1,1,87.8,102);


(lib.bg_s = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// レイヤー_1
	this.bg1 = new lib.bg2_1();
	this.bg1.name = "bg1";
	this.bg1.parent = this;
	this.bg1.setTransform(-135.45,-165.6,0.4722,0.4722,0,0,0,-0.8,-0.7);
	this.bg1.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.bg1).to({alpha:1},12).wait(41).to({alpha:0},12).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-135,-165.2,270.1,330.5);
...
(lib.window = function(mode,startPosition,loop) {
	...
	// dummy
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#000000").s().p("");
	this.shape.setTransform(61.7,12);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#000000").s().p("");
	this.shape_1.setTransform(45.75,11.6);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#000000").s().p("");
	this.shape_2.setTransform(29.6,11.9);
...
(lib.character1_face_container = function(mode,startPosition,loop) {
	...
	var mask = new cjs.Shape();
	mask._off = true;
	var mask_graphics_15 = new cjs.Graphics().p("ADJDbIhAgiIgdh8IhigmIhiA2IhugMQg7gZgfgkQgpgigKglIAfgZIAwhNIBbg1IBxAPIBnA8IAAAAIgaB7IBtA5IBNhaQBdgVAmBiIACBNIgsB+g");
	...
	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:null,x:0,y:0}).wait(15).to({graphics:mask_graphics_15,x:36.725,y:45.1}).wait(6).to({graphics:mask_graphics_21,x:31.25,y:41.8}).wait(6));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(15).to({_off:false},0).wait(1).to({alpha:1},0).wait(1).to({regX:42,regY:52,x:42,y:52,alpha:0.3015},0).wait(1).to({alpha:0.0922},0).wait(1).to({regX:35,regY:30,x:35,y:30,alpha:0},0).wait(2).to({alpha:0.1992},0).wait(1).to({alpha:1},0).wait(1).to({regX:42,regY:52,x:42,y:52,alpha:0.3015},0).wait(1).to({alpha:0.0922},0).wait(1).to({regX:35,regY:30,x:35,y:30,alpha:0},0).wait(2));

	// aho
	this.hair = new lib.ch_hair();
	this.hair.name = "hair";
	this.hair.parent = this;
	this.hair.setTransform(50,-40,0.5,0.5,0,0,0,80,52);
	...
	this.timeline.addTween(cjs.Tween.get(this.f2).wait(5).to({alpha:0.1992},0).wait(1).to({regX:45,regY:52,x:45,y:52,alpha:0.6441},0).wait(1).to({alpha:0.911},0).wait(1).to({regX:35,regY:30,x:35,y:30,alpha:1},0).wait(19));
	...
	this.timeline.addTween(cjs.Tween.get(this.f1_alpha).wait(5).to({alpha:0.8008},0).wait(1).to({regX:45,regY:52,x:45,y:52,alpha:0.7118},0).wait(1).to({alpha:0.4449},0).wait(1).to({regX:35,regY:30,x:35,y:30,alpha:0},0).wait(19));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-248,-164,572,700);
...
(lib.character1_body = function(mode,startPosition,loop) {
	...
	// ke
	this.instance = new lib.ch_hair_2();
	this.instance.parent = this;
	this.instance.setTransform(25,-355.7,0.5,0.5,0,0,0,80,52);
	this.instance._off = true;
	...
	this.b.name = "b";
	this.b.parent = this;
	this.b.setTransform(-153,-83.7);

	this.timeline.addTween(cjs.Tween.get(this.b).wait(2));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-273,-479.7,583.2,700);
...
(lib.character1_container = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(64.45,-348.45,1.1645,1.1645,0,0,180);
	this.instance._off = true;

	this.instance_1 = new lib.heart();
	this.instance_1.parent = this;
	this.instance_1.setTransform(72.9,-328,0.4532,0.4532,0,0,180);
	this.instance_1.alpha = 0;
	this.instance_1.compositeOperation = "lighter";
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(313).to({_off:false},0).wait(1).to({regX:1.2,regY:1.8,skewX:33.7496,skewY:213.7496,x:90.05,y:-357.45,alpha:0.4141},0).wait(1).to({regX:0,regY:0,skewX:44.9995,skewY:224.9995,x:101.7,y:-361.75,alpha:0.2188},0).to({_off:true},1).wait(1).to({_off:false,skewX:0,skewY:180,x:64.45,y:-348.45,alpha:1},0).wait(1).to({regX:1.2,regY:1.8,skewX:33.7496,skewY:213.7496,x:90.05,y:-357.45,alpha:0.4141},0).wait(1).to({regX:0,regY:0,skewX:44.9995,skewY:224.9995,x:101.7,y:-361.75,alpha:0.2188},0).to({_off:true},1).wait(5).to({_off:false,skewX:0,skewY:180,x:64.45,y:-348.45,alpha:1},0).wait(1).to({regX:1.2,regY:1.8,skewX:33.7496,skewY:213.7496,x:90.05,y:-357.45,alpha:0.4141},0).wait(1).to({regX:0,regY:0,skewX:44.9995,skewY:224.9995,x:101.7,y:-361.75,alpha:0.2188},0).to({_off:true},1).wait(1).to({_off:false,skewX:0,skewY:180,x:64.45,y:-348.45,alpha:1},0).wait(1).to({regX:1.2,regY:1.8,skewX:33.7496,skewY:213.7496,x:90.05,y:-357.45,alpha:0.4141},0).wait(1).to({regX:0,regY:0,skewX:44.9995,skewY:224.9995,x:101.7,y:-361.75,alpha:0.2188},0).to({_off:true},1).wait(130));
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(370).to({_off:false},0).wait(1).to({regX:2.3,regY:1,scaleX:0.8633,scaleY:0.8633,x:74.65,y:-342.15,alpha:0.375},0).wait(1).to({regX:0,regY:0,scaleX:1,scaleY:1,x:77.9,y:-348,alpha:0.5},0).wait(1).to({regX:2.3,regY:1,scaleX:0.9896,scaleY:0.9896,x:75.35,y:-345.85,alpha:0.4444},0).wait(1).to({scaleX:0.9586,scaleY:0.9586,x:74.8,y:-342.6,alpha:0.2778},0).wait(1).to({regX:0,regY:0,scaleX:0.9068,scaleY:0.9068,x:75.9,y:-338,alpha:0},0).to({_off:true},1).wait(86));

	// effect_look_to_right
	this.instance_2 = new lib.spread_flower_pink("synched",0,false);
	this.instance_2.parent = this;
	this.instance_2.setTransform(6.3,-275.8,1.4807,1.4807,0,0,180);

	this.instance_3 = new lib.good_effect("synched",0,false);
	this.instance_3.parent = this;
	this.instance_3.setTransform(6.35,-275.85,1.481,1.481);

	this.instance_4 = new lib.notice();
	this.instance_4.parent = this;
	this.instance_4.setTransform(90.05,-323.9,1.1857,1.1857,169.9438,0,0,-29.1,20.5);
	this.instance_4._off = true;

	this.instance_5 = new lib.laugh("synched",0);
	this.instance_5.parent = this;
	this.instance_5.setTransform(88.1,-326.2,0.9697,0.9697,0,-35.8379,144.1731,-30.2,20.6);
	this.instance_5._off = true;

	this.instance_6 = new lib.chord("synched",0,false);
	this.instance_6.parent = this;
	this.instance_6.setTransform(72.9,-278.15,1.0026,1.0026,-6.2632,0,0,-23.4,76.9);

	this.instance_7 = new lib.question();
	this.instance_7.parent = this;
	this.instance_7.setTransform(78.25,-340.95,1.053,1.053,29.448);
	this.instance_7.alpha = 0;
	this.instance_7._off = true;

	this.instance_8 = new lib.mc_exclamation("synched",0,false);
	this.instance_8.parent = this;
	this.instance_8.setTransform(71.95,-356.35,1.0929,1.0929,0,30,-150.0007,-0.1,0.1);

	this.instance_9 = new lib.drop1a("synched",0);
	this.instance_9.parent = this;
	this.instance_9.setTransform(57.6,-338.85,1,1,0,0,0,-0.5,0.2);
	this.instance_9._off = true;

	this.instance_10 = new lib.drop2_v2("synched",0);
	this.instance_10.parent = this;
	this.instance_10.setTransform(66.25,-338.7,0.9876,0.9876,0,-14.9998,165.0002);
	this.instance_10._off = true;

	this.instance_11 = new lib.shock("synched",0);
	this.instance_11.parent = this;
	this.instance_11.setTransform(72.7,-331.65,1.3878,1.3878,0,121.2396,-58.7604);

	this.instance_12 = new lib.sigh("synched",0);
	this.instance_12.parent = this;
	this.instance_12.setTransform(46.25,-208.5,1,1,0,0,180);
	this.instance_12.alpha = 0.6016;
	this.instance_12._off = true;

	this.instance_13 = new lib.heart("synched",0);
	this.instance_13.parent = this;
	this.instance_13.setTransform(72.9,-328,0.4532,0.4532,0,0,180);
	this.instance_13._off = true;

	this.instance_14 = new lib.angry("synched",0);
	this.instance_14.parent = this;
	this.instance_14.setTransform(59.35,-319.1,0.5276,0.5276);
	this.instance_14._off = true;

	this.instance_15 = new lib.mc_punpun();
	this.instance_15.parent = this;
	this.instance_15.setTransform(-51.6,-368.25,1.1377,1.1377);

	this.instance_16 = new lib.concent_wrapper("synched",0,false);
	this.instance_16.parent = this;
	this.instance_16.setTransform(6.1,-276.4,1,1,0,0,0,-0.5,-0.1);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(133).to({_off:false},0).to({_off:true},2).wait(1).to({_off:false,scaleX:1.1864,scaleY:1.1864,rotation:169.9437,y:-323.95},0).wait(3).to({regX:-28.8,x:89.65,y:-323.8,alpha:0.6944},0).wait(1).to({alpha:0.4444},0).wait(1).to({alpha:0.25},0).wait(1).to({alpha:0.1111},0).wait(1).to({alpha:0.0278},0).wait(1).to({regX:-29.1,x:90.05,y:-323.95,alpha:0},0).to({_off:true},1).wait(2).to({_off:false,scaleX:1.1857,scaleY:1.1857,rotation:169.9438,y:-323.9,alpha:1},0).to({_off:true},2).wait(1).to({_off:false,scaleX:1.1864,scaleY:1.1864,rotation:169.9437,y:-323.95},0).wait(3).to({regX:-28.8,x:89.65,y:-323.8,alpha:0.6944},0).wait(1).to({alpha:0.4444},0).wait(1).to({alpha:0.25},0).wait(1).to({alpha:0.1111},0).wait(1).to({alpha:0.0278},0).wait(1).to({regX:-29.1,x:90.05,y:-323.95,alpha:0},0).to({_off:true},1).wait(303));
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(160).to({_off:false},0).wait(15).to({regY:20.4,skewX:-35.8269,x:88,y:-326.3},0).wait(1).to({regX:-31.4,regY:22.1,x:89.85,y:-325.55,alpha:0.5625,startPosition:1},0).wait(1).to({alpha:0.25,startPosition:2},0).wait(1).to({alpha:0.0625,startPosition:3},0).wait(1).to({regX:-30.2,regY:20.4,x:88,y:-326.3,alpha:0,startPosition:19},0).to({_off:true},1).wait(282));
	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(202).to({_off:false},0).wait(1).to({regX:-0.2,regY:0.2,x:85.9,y:-353.9,alpha:0.5556},0).wait(1).to({x:90.7,y:-361.75,alpha:0.8889},0).wait(1).to({regX:0,regY:0,x:92.65,y:-364.55,alpha:1},0).wait(1).to({regX:-0.2,regY:0.2,x:92,y:-363.8},0).wait(1).to({x:90.95,y:-361.95},0).wait(1).to({x:89.2,y:-358.85},0).wait(1).to({regX:0,regY:0,x:87.05,y:-354.65},0).to({x:87.8,y:-356},2).wait(8).to({regX:-0.2,regY:0.2,x:87.15,y:-355.3,alpha:0.9298},0).wait(1).to({x:86.05,y:-353.35,alpha:0.692},0).wait(1).to({x:84.45,y:-350.5,alpha:0.339},0).wait(1).to({x:83.25,y:-348.4,alpha:0.0788},0).wait(1).to({regX:0,regY:0,y:-347.85,alpha:0},0).to({_off:true},1).wait(6).to({_off:false,x:78.25,y:-340.95},0).wait(1).to({regX:-0.2,regY:0.2,x:85.9,y:-353.9,alpha:0.5556},0).wait(1).to({x:90.7,y:-361.75,alpha:0.8889},0).wait(1).to({regX:0,regY:0,x:92.65,y:-364.55,alpha:1},0).wait(1).to({regX:-0.2,regY:0.2,x:92,y:-363.8},0).wait(1).to({x:90.95,y:-361.95},0).wait(1).to({x:89.2,y:-358.85},0).wait(1).to({regX:0,regY:0,x:87.05,y:-354.65},0).to({x:87.8,y:-356},2).wait(3).to({regX:-0.2,regY:0.2,x:87.15,y:-355.3,alpha:0.9298},0).wait(1).to({x:86.05,y:-353.35,alpha:0.692},0).wait(1).to({x:84.45,y:-350.5,alpha:0.339},0).wait(1).to({x:83.25,y:-348.4,alpha:0.0788},0).wait(1).to({regX:0,regY:0,y:-347.85,alpha:0},0).to({_off:true},1).wait(215));
	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(268).to({_off:false},0).wait(1).to({regX:0.5,regY:-0.6,x:58.6,y:-335.15},0).wait(1).to({y:-331.3},0).wait(1).to({y:-328.05},0).wait(1).to({y:-325.4},0).wait(1).to({y:-323.3},0).wait(1).to({y:-321.8},0).wait(1).to({y:-320.9},0).wait(1).to({regX:-0.5,regY:0.2,x:57.6,y:-319.85},0).wait(9).to({startPosition:0},0).wait(1).to({regX:0.5,regY:-0.6,x:58.6,y:-320.65,alpha:0.4444},0).wait(1).to({alpha:0.1111},0).wait(1).to({regX:-0.5,regY:0.2,x:57.6,y:-319.85,alpha:0},0).to({_off:true},1).wait(173));
	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(313).to({_off:false},0).wait(1).to({scaleX:1.1203,scaleY:1.1203,skewX:18.7494,skewY:198.7494,x:97.675,y:-334.0875,alpha:0.4141},0).wait(1).to({scaleX:1.1645,scaleY:1.1645,skewX:29.9991,skewY:209.9991,x:108.15,y:-332.55,alpha:0.2188},0).to({_off:true},1).wait(1).to({_off:false,scaleX:0.9876,scaleY:0.9876,skewX:-14.9998,skewY:165.0002,x:66.25,y:-338.7,alpha:1},0).wait(1).to({scaleX:1.1203,scaleY:1.1203,skewX:18.7494,skewY:198.7494,x:97.675,y:-338.475,alpha:0.4141},0).wait(1).to({scaleX:1.1645,scaleY:1.1645,skewX:29.9991,skewY:209.9991,x:108.15,y:-338.4,alpha:0.2188},0).to({_off:true},1).wait(5).to({_off:false,scaleX:0.9876,scaleY:0.9876,skewX:-14.9998,skewY:165.0002,x:66.25,y:-338.7,alpha:1},0).wait(1).to({scaleX:1.1203,scaleY:1.1203,skewX:18.7494,skewY:198.7494,x:97.675,y:-334.0875,alpha:0.4141},0).wait(1).to({scaleX:1.1645,scaleY:1.1645,skewX:29.9991,skewY:209.9991,x:108.15,y:-332.55,alpha:0.2188},0).to({_off:true},1).wait(1).to({_off:false,scaleX:0.9876,scaleY:0.9876,skewX:-14.9998,skewY:165.0002,x:66.25,y:-338.7,alpha:1},0).wait(1).to({scaleX:1.1203,scaleY:1.1203,skewX:18.7494,skewY:198.7494,x:97.675,y:-338.475,alpha:0.4141},0).wait(1).to({scaleX:1.1645,scaleY:1.1645,skewX:29.9991,skewY:209.9991,x:108.15,y:-338.4,alpha:0.2188},0).to({_off:true},1).wait(130));
	this.timeline.addTween(cjs.Tween.get(this.instance_12).wait(351).to({_off:false},0).wait(1).to({x:47.25,y:-207.5,alpha:1},0).wait(1).to({regX:0.9,x:47.35,y:-206.55,alpha:0.8965},0).wait(1).to({x:48.7,y:-205.35,alpha:0.7636},0).wait(1).to({x:50.3,y:-203.9,alpha:0.6048},0).wait(1).to({x:52.1,y:-202.3,alpha:0.4229},0).wait(1).to({x:54.1,y:-200.45,alpha:0.2205},0).wait(1).to({regX:0,x:57.25,y:-198.5,alpha:0},0).to({_off:true},1).wait(103));
	this.timeline.addTween(cjs.Tween.get(this.instance_13).wait(370).to({_off:false},0).wait(1).to({regX:2.3,regY:1,scaleX:0.8633,scaleY:0.8633,x:74.65,y:-342.15},0).wait(1).to({regX:0,regY:0,scaleX:1,scaleY:1,x:77.9,y:-348},0).wait(1).to({regX:2.3,regY:1,scaleX:0.9896,scaleY:0.9896,x:75.35,y:-345.85},0).wait(1).to({scaleX:0.9586,scaleY:0.9586,x:74.8,y:-342.6},0).wait(1).to({regX:0,regY:0,scaleX:0.9068,scaleY:0.9068,x:75.9,y:-338},0).to({scaleX:1,scaleY:1,x:76.9,y:-342},2).wait(3).to({scaleX:1.1165,scaleY:1.1165},0).wait(1).to({regX:2.3,regY:1,scaleX:0.8111,scaleY:0.8111,x:74.3,y:-341,alpha:0.3262},0).wait(1).to({regX:0,regY:0,scaleX:0.7092,scaleY:0.7092,x:75.9,y:-341.75,alpha:0.1016},0).to({_off:true},1).wait(79));
	this.timeline.addTween(cjs.Tween.get(this.instance_14).wait(389).to({_off:false},0).wait(1).to({scaleX:1.0714,scaleY:1.0714,y:-322.85},0).wait(1).to({scaleX:1.2527,scaleY:1.2527,y:-324.1},0).wait(1).to({scaleX:0.9864,scaleY:0.9864},0).wait(1).to({scaleX:0.8976,scaleY:0.8976},0).wait(5).to({startPosition:0},0).wait(1).to({alpha:0.5009},0).wait(1).to({alpha:0.2014},0).wait(1).to({alpha:0.1016},0).to({_off:true},1).wait(60));

	// eff
	this.instance_17 = new lib.eff_m();
	this.instance_17.parent = this;
	this.instance_17.setTransform(0,-158);
	this.instance_17.compositeOperation = "lighter";

	this.timeline.addTween(cjs.Tween.get(this.instance_17).wait(462));
	...
	this.timeline.addTween(cjs.Tween.get(this.c).wait(9).to({regX:13,regY:-129.7,x:13,y:-133.7},0).wait(1).to({regX:0,regY:0,x:0,y:-4.8},0).wait(1).to({regX:13,regY:-129.7,x:13,y:-134},0).wait(1).to({y:-132.35},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({y:1},0).wait(1).to({y:0},0).wait(1).to({y:2},0).wait(1).to({regX:13,regY:-129.7,x:13,y:-135.2},0).wait(1).to({regX:0,regY:0,x:0,y:-8},0).wait(1).to({regX:13,regY:-129.7,x:13,y:-135.45},0).wait(1).to({y:-128.5},0).wait(1).to({regX:0,regY:0,x:0,y:4},0).wait(1).to({regX:13,regY:-129.7,x:13,y:-126.45},0).wait(1).to({y:-128.85},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({y:2},0).wait(1).to({y:-7},0).wait(1).to({regX:13,regY:-129.7,x:13,y:-134.65},0).wait(1).to({y:-128.75},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({y:-7},0).wait(1).to({regX:13,regY:-129.7,x:13,y:-134.65},0).wait(1).to({y:-128.75},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({regX:13,regY:-129.7,x:13,y:-128.8},0).wait(1).to({y:-129.45},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({y:6},0).wait(1).to({regX:13,regY:-129.7,x:13,y:-138.7},0).wait(1).to({regX:0,regY:0,x:0,y:-14},0).wait(1).to({regX:13,regY:-129.7,x:13,y:-142.65},0).wait(1).to({y:-139.05},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({regX:13,regY:-129.7,x:13,y:-127.7},0).wait(1).to({regX:0,regY:0,x:0,y:-1},0).wait(1).to({regX:13,regY:-129.7,x:13,y:-129.95},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({y:6},0).wait(1).to({regX:13,regY:-129.7,x:13,y:-138.7},0).wait(1).to({regX:0,regY:0,x:0,y:-14},0).wait(1).to({regX:13,regY:-129.7,x:13,y:-142.65},0).wait(1).to({y:-139.05},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({regX:13,regY:-129.7,x:13,y:-127.7},0).wait(1).to({regX:0,regY:0,x:0,y:-1},0).wait(1).to({regX:13,regY:-129.7,x:13,y:-129.95},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(2).to({regX:13,regY:-129.7,x:13,y:-129.1},0).wait(1).to({y:-126.7},0).wait(1).to({y:-124.35},0).wait(1).to({regX:0,regY:0,x:0,y:6},0).wait(1).to({regX:13,regY:-129.7,x:13,y:-124.35},0).wait(1).to({y:-126.7},0).wait(1).to({y:-129.1},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(2).to({regX:13,regY:-129.7,x:13,y:-129.55},0).wait(1).to({y:-129},0).wait(1).to({y:-127.9},0).wait(1).to({y:-126.55},0).wait(1).to({y:-125.45},0).wait(1).to({y:-124.9},0).wait(1).to({regX:0,regY:0,x:0,y:5},0).wait(1).to({regX:13,regY:-129.7,x:13,y:-124.9},0).wait(1).to({y:-125.45},0).wait(1).to({y:-126.55},0).wait(1).to({y:-127.9},0).wait(1).to({y:-129},0).wait(1).to({y:-129.55},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({y:6},2).wait(1).to({regX:13,regY:-129.7,x:13,y:-124.95},0).wait(1).to({y:-128.5},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).to({y:6},2).wait(1).to({regX:13,regY:-129.7,x:13,y:-127.5},0).wait(1).to({y:-129.35},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(2).to({regX:13,regY:-129.7,rotation:0.0163,x:13.05,y:-129.65},0).wait(1).to({rotation:0.0729,x:13.25,y:-129.35},0).wait(1).to({rotation:0.1837,x:13.75,y:-128.75},0).wait(1).to({rotation:0.3594,x:14.5,y:-127.85},0).wait(1).to({scaleX:0.9999,scaleY:0.9999,rotation:0.5799,x:15.45,y:-126.7},0).wait(1).to({rotation:0.7798,x:16.3,y:-125.6},0).wait(1).to({rotation:0.9131,x:16.85,y:-124.9},0).wait(1).to({rotation:0.9816,x:17.15,y:-124.55},0).wait(1).to({regX:0.1,regY:0.1,rotation:1.0012,x:2,y:5},0).wait(1).to({regX:13,regY:-129.7,rotation:0.9881,x:17.1,y:-124.65},0).wait(1).to({rotation:0.9435,x:16.9,y:-124.85},0).wait(1).to({rotation:0.8573,x:16.55,y:-125.3},0).wait(1).to({rotation:0.7198,x:15.95,y:-126.1},0).wait(1).to({rotation:0.5338,x:15.15,y:-127.05},0).wait(1).to({scaleX:1,scaleY:1,rotation:0.335,x:14.3,y:-128.05},0).wait(1).to({rotation:0.1739,x:13.6,y:-128.9},0).wait(1).to({rotation:0.0697,x:13.15,y:-129.5},0).wait(1).to({rotation:0.0157,x:13,y:-129.7},0).wait(1).to({regX:0,regY:0,rotation:0,x:0,y:0},0).wait(2).to({regX:13,regY:-129.7,rotation:0.0244,x:13.05,y:-129.65},0).wait(1).to({rotation:0.1092,x:13.35,y:-129.35},0).wait(1).to({rotation:0.275,x:13.95,y:-128.75},0).wait(1).to({rotation:0.538,x:14.9,y:-127.85},0).wait(1).to({scaleX:0.9999,scaleY:0.9999,rotation:0.8681,x:16.1,y:-126.65},0).wait(1).to({rotation:1.1673,x:17.2,y:-125.55},0).wait(1).to({rotation:1.367,x:17.9,y:-124.8},0).wait(1).to({rotation:1.4695,x:18.25,y:-124.4},0).wait(1).to({regX:0,regY:0,rotation:1.4989,x:1.95,y:4.95},0).wait(1).to({regX:13,regY:-129.7,rotation:1.4793,x:18.25,y:-124.45},0).wait(1).to({rotation:1.4124,x:18,y:-124.7},0).wait(1).to({rotation:1.2834,x:17.55,y:-125.15},0).wait(1).to({rotation:1.0775,x:16.8,y:-125.9},0).wait(1).to({scaleX:1,scaleY:1,rotation:0.7991,x:15.8,y:-126.9},0).wait(1).to({rotation:0.5016,x:14.75,y:-128},0).wait(1).to({rotation:0.2603,x:13.85,y:-128.85},0).wait(1).to({rotation:0.1043,x:13.3,y:-129.45},0).wait(1).to({rotation:0.0235,x:13.05,y:-129.7},0).wait(1).to({regX:0,regY:0,rotation:0,x:0,y:0},0).wait(16).to({regX:13,regY:-129.7,x:13,y:-135.25},0).wait(1).to({y:-137.15},0).wait(1).to({regX:0,regY:0,x:0,y:-8},0).wait(1).to({regX:13,regY:-129.7,x:13,y:-137.05},0).wait(1).to({y:-134.95},0).wait(1).to({regX:0,regY:0,x:0,y:2},0).wait(1).to({y:1},0).wait(1).to({y:0},0).wait(28).to({regX:13,regY:-129.7,rotation:0.0244,x:13.05,y:-129.65},0).wait(1).to({rotation:0.1092,x:13.35,y:-129.35},0).wait(1).to({rotation:0.275,x:13.95,y:-128.75},0).wait(1).to({rotation:0.538,x:14.9,y:-127.85},0).wait(1).to({scaleX:0.9999,scaleY:0.9999,rotation:0.8681,x:16.1,y:-126.65},0).wait(1).to({rotation:1.1673,x:17.2,y:-125.55},0).wait(1).to({rotation:1.367,x:17.9,y:-124.8},0).wait(1).to({rotation:1.4695,x:18.25,y:-124.4},0).wait(1).to({regX:0,regY:0,rotation:1.4989,x:1.95,y:4.95},0).wait(1).to({regX:13,regY:-129.7,rotation:1.479,x:18.25,y:-124.45},0).wait(1).to({rotation:1.4111,x:18,y:-124.7},0).wait(1).to({rotation:1.2801,x:17.55,y:-125.15},0).wait(1).to({rotation:1.0711,x:16.75,y:-125.9},0).wait(1).to({rotation:0.7884,x:15.8,y:-126.9},0).wait(1).to({scaleX:1,scaleY:1,rotation:0.4865,x:14.7,y:-128},0).wait(1).to({rotation:0.2415,x:13.8,y:-128.85},0).wait(1).to({rotation:0.0832,x:13.25,y:-129.45},0).wait(1).to({rotation:0.0011,x:13,y:-129.7},0).wait(1).to({regX:0,regY:0,rotation:-0.0227,x:0,y:0},0).wait(1).to({rotation:0},0).wait(1).to({regX:13,regY:-129.7,rotation:0.1421,x:13.45,y:-129.2},0).wait(1).to({rotation:0.6998,x:15.5,y:-127.25},0).wait(1).to({scaleX:0.9999,scaleY:0.9999,rotation:1.327,x:17.75,y:-124.95},0).wait(1).to({regX:0,regY:0,rotation:1.4989,x:1.95,y:4.95},0).wait(18).to({regX:13,regY:-129.7,rotation:1.4399,x:18.1,y:-124.55},0).wait(1).to({rotation:1.2196,x:17.3,y:-125.35},0).wait(1).to({rotation:0.7884,x:15.8,y:-126.9},0).wait(1).to({scaleX:1,scaleY:1,rotation:0.3138,x:14.05,y:-128.6},0).wait(1).to({rotation:0.0482,x:13.1,y:-129.55},0).wait(1).to({regX:0,regY:0,rotation:-0.0227,x:0,y:0},0).wait(1).to({rotation:0},0).wait(1).to({regX:13,regY:-129.7,rotation:0.0865,x:13.3,y:-129.45},0).wait(1).to({rotation:0.4213,x:14.5,y:-128.2},0).wait(1).to({scaleX:0.9999,scaleY:0.9999,rotation:0.9973,x:16.55,y:-126.1},0).wait(1).to({rotation:1.3945,x:18,y:-124.7},0).wait(1).to({regX:0,regY:0,rotation:1.4989,x:1.95,y:4.95},0).wait(8).to({regX:13,regY:-129.7,rotation:1.4399,x:18.1,y:-124.55},0).wait(1).to({rotation:1.2196,x:17.3,y:-125.35},0).wait(1).to({rotation:0.7884,x:15.8,y:-126.9},0).wait(1).to({scaleX:1,scaleY:1,rotation:0.3138,x:14.05,y:-128.6},0).wait(1).to({rotation:0.0482,x:13.1,y:-129.55},0).wait(1).to({regX:0,regY:0,rotation:-0.0227,x:0,y:0},0).wait(5).to({rotation:0},0).wait(1).to({regX:13,regY:-129.7,x:13,y:-138.1},0).wait(1).to({regX:0,regY:0,x:0,y:-10},0).wait(1).to({regX:13,regY:-129.7,x:13,y:-138.9},0).wait(1).to({y:-136.15},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({y:1},0).wait(1).to({y:0},0).wait(9).to({x:1,y:4},1,cjs.Ease.get(1)).wait(1).to({regX:13,regY:-129.7,x:10.25,y:-121.95},0).wait(1).to({regX:0,regY:0,x:-4,y:9},0).to({x:0,y:13},4).wait(11).to({regX:13,regY:-129.7,x:13,y:-117.45},0).wait(1).to({y:-120.4},0).wait(1).to({y:-125.35},0).wait(1).to({y:-128.8},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(5).to({y:-1},0).wait(1).to({regX:13,regY:-129.7,x:13,y:-128.7},0).wait(1).to({y:-122.75},0).wait(1).to({regX:0,regY:0,x:0,y:9},0).to({y:8},2).wait(1).to({y:9},0).wait(6).to({regX:13,regY:-129.7,x:13,y:-121.9},0).wait(1).to({y:-126.2},0).wait(1).to({y:-130.5},0).wait(1).to({regX:0,regY:0,x:0,y:-2},0).wait(1).to({regX:13,regY:-129.7,x:13,y:-130.2},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(13).to({x:1,y:4},1,cjs.Ease.get(1)).wait(1).to({regX:13,regY:-129.7,x:10.25,y:-121.95},0).wait(1).to({regX:0,regY:0,x:-4,y:9},0).to({x:0,y:13},4).wait(8).to({regX:13,regY:-129.7,x:13,y:-118.95},0).wait(1).to({y:-126.7},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({y:2},0).wait(1).to({regX:13,regY:-129.7,x:13,y:-130.7},0).wait(1).to({regX:0,regY:0,x:0,y:-2},0).wait(1).to({regX:13,regY:-129.7,x:13,y:-129.85},0).wait(1).to({regX:0,regY:0,x:0,y:2},0).wait(1).to({regX:13,regY:-129.7,x:13,y:-129.2},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(2).to({regX:13,regY:-129.7,x:13,y:-129.1},0).wait(1).to({y:-126.7},0).wait(1).to({y:-124.35},0).wait(1).to({regX:0,regY:0,x:0,y:6},0).wait(1).to({regX:13,regY:-129.7,x:13,y:-124.3},0).wait(1).to({y:-124.6},0).wait(1).to({regX:0,regY:0,x:0,y:5},0).wait(5).to({regX:13,regY:-129.7,x:13,y:-125.1},0).wait(1).to({y:-126.6},0).wait(1).to({y:-128.85},0).wait(1).to({y:-130.3},0).wait(1).to({regX:0,regY:0,x:0,y:-1},0).wait(1).to({regX:13,regY:-129.7,x:13,y:-129.95},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({y:5},0).wait(1).to({regX:13,regY:-129.7,x:13,y:-137.3},0).wait(1).to({regX:0,regY:0,x:0,y:-10},0).wait(1).to({regX:13,regY:-129.7,x:13,y:-138.9},0).wait(1).to({y:-136.15},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({y:1},0).wait(1).to({y:0},0).wait(9).to({regX:13,regY:-129.7,x:13,y:-137.2},0).wait(1).to({regX:0,regY:0,x:0,y:-10},0).wait(2).to({regX:13,regY:-129.7,x:13,y:-137.7},0).wait(1).to({y:-131.7},0).wait(1).to({regX:0,regY:0,x:0,y:8},0).to({y:5},2).wait(7).to({regX:13,regY:-129.7,x:13,y:-125.05},0).wait(1).to({y:-126.25},0).wait(1).to({y:-128.2},0).wait(1).to({y:-129.4},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({y:2},0).wait(1).to({y:-7},0).wait(1).to({regX:13,regY:-129.7,x:13,y:-134.65},0).wait(1).to({y:-128.75},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({y:-7},0).wait(1).to({regX:13,regY:-129.7,x:13,y:-134.65},0).wait(1).to({y:-128.75},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({regX:13,regY:-129.7,x:13,y:-128.8},0).wait(1).to({y:-129.45},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(2).to({regX:13,regY:-129.7,x:16,y:-126.3},0).wait(1).to({regX:0,regY:0,x:4,y:4.55},0).to({x:-2,y:8.8},2).wait(1).to({regX:13,regY:-129.7,x:12.15,y:-120.25},0).wait(1).to({x:12.8,y:-119.85},0).wait(1).to({regX:0,regY:0,x:0,y:10},0).wait(5).to({regX:13,regY:-129.7,x:13,y:-120.4},0).wait(1).to({y:-122.85},0).wait(1).to({y:-126.55},0).wait(1).to({y:-129.05},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(30));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-399.7,-676.7,813.5,910);
...
// stage content:
(lib._488_2 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{end0:14,scene1:15,end1:185,scene2:186,end2:338,scene3:339,end3:515,scene4:516,end4:641,scene5:642,end5:788,scene6:789,end6:905,scene7:906,end7:1031});
	...
	this.frame_539 = function() {
		exportRoot._g.m1 = this.m.t[exportRoot._g.idx][1];
		exportRoot._g.m2 = "知って……";
		exportRoot._u.setText();
	}
	this.frame_566 = function() {
		exportRoot._g.m2 = this.m.t[exportRoot._g.idx][2];
		exportRoot._g.m3 = "たものが､";
		exportRoot._u.setText();
	...
	this.frame_835 = function() {
		exportRoot._g.m2 = this.m.t[exportRoot._g.idx][2];
		exportRoot._g.m3 = "綺麗な庭を歩くことも､";
		exportRoot._u.setText();
	}
	this.frame_869 = function() {
		exportRoot._g.m3 = this.m.t[exportRoot._g.idx][3];
		exportRoot._g.m4 = "たかもしれませんし♪";
		exportRoot._u.setText();
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(14).call(this.frame_14).wait(1).call(this.frame_15).wait(26).call(this.frame_41).wait(19).call(this.frame_60).wait(40).call(this.frame_100).wait(56).call(this.frame_156).wait(29).call(this.frame_185).wait(1).call(this.frame_186).wait(17).call(this.frame_203).wait(52).call(this.frame_255).wait(38).call(this.frame_293).wait(9).call(this.frame_302).wait(11).call(this.frame_313).wait(25).call(this.frame_338).wait(1).call(this.frame_339).wait(20).call(this.frame_359).wait(29).call(this.frame_388).wait(46).call(this.frame_434).wait(28).call(this.frame_462).wait(20).call(this.frame_482).wait(21).call(this.frame_503).wait(12).call(this.frame_515).wait(1).call(this.frame_516).wait(23).call(this.frame_539).wait(27).call(this.frame_566).wait(35).call(this.frame_601).wait(40).call(this.frame_641).wait(1).call(this.frame_642).wait(17).call(this.frame_659).wait(30).call(this.frame_689).wait(34).call(this.frame_723).wait(22).call(this.frame_745).wait(15).call(this.frame_760).wait(11).call(this.frame_771).wait(17).call(this.frame_788).wait(1).call(this.frame_789).wait(20).call(this.frame_809).wait(26).call(this.frame_835).wait(34).call(this.frame_869).wait(26).call(this.frame_895).wait(10).call(this.frame_905).wait(1).call(this.frame_906).wait(19).call(this.frame_925).wait(39).call(this.frame_964).wait(28).call(this.frame_992).wait(28).call(this.frame_1020).wait(11).call(this.frame_1031).wait(5));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(15).to({_off:false},0).to({alpha:0.1016},3).to({_off:true},1).wait(1017));
	...
	this.timeline.addTween(cjs.Tween.get(this.window_1).wait(15).to({y:301.1},0).wait(1).to({regX:132.8,regY:98.8,x:134.8,y:398.6},0).wait(1).to({y:394.65},0).wait(1).to({y:388},0).wait(1).to({y:378.75},0).wait(1).to({y:367.25},0).wait(1).to({y:354.25},0).wait(1).to({y:340.85},0).wait(1).to({y:328.45},0).wait(1).to({y:318.45},0).wait(1).to({y:312},0).wait(1).to({regX:0,regY:0,x:2,y:211},0).wait(1).to({regX:132.8,regY:98.8,x:134.8,y:310.3},0).wait(1).to({y:311.9},0).wait(1).to({regX:0,regY:0,x:2,y:214},0).wait(952).to({regX:132.8,regY:98.8,x:134.8,y:313.9},0).wait(1).to({y:317.75},0).wait(1).to({y:325},0).wait(1).to({y:336.4},0).wait(1).to({y:351.7},0).wait(1).to({y:368.85},0).wait(1).to({y:384.15},0).wait(1).to({y:395.55},0).wait(1).to({y:402.8},0).wait(1).to({y:406.65},0).wait(1).to({regX:0,regY:0,x:2,y:309},0).to({_off:true},1).wait(44));
	...
	this.timeline.addTween(cjs.Tween.get(this.window_2).wait(992).to({_off:false},0).wait(1).to({regX:16.8,regY:-1.3,x:136.8,y:320.2},0).wait(1).to({y:318.5},0).wait(1).to({y:315.2},0).wait(1).to({y:309.85},0).wait(1).to({y:302.4},0).wait(1).to({y:294.05},0).wait(1).to({y:287.1},0).wait(1).to({y:282.55},0).wait(1).to({y:280.25},0).wait(1).to({regX:0,regY:0,x:120,y:280.9},0).to({y:282.9},3).wait(31));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_8},{t:this.instance_7},{t:this.instance_6},{t:this.instance_5},{t:this.instance_4}]},992).wait(44));
	...
	this.timeline.addTween(cjs.Tween.get(this.glitters).wait(992).to({_off:false},0).wait(44));
	...
	this.timeline.addTween(cjs.Tween.get(this.ranko_finish_blur).wait(992).to({_off:false},0).wait(1).to({regX:120,regY:155,x:120,y:155,alpha:0.8489},0).wait(1).to({alpha:0.8403},0).wait(1).to({alpha:0.8253},0).wait(1).to({alpha:0.8029},0).wait(1).to({alpha:0.7723},0).wait(1).to({alpha:0.7324},0).wait(1).to({alpha:0.6823},0).wait(1).to({alpha:0.6211},0).wait(1).to({alpha:0.5487},0).wait(1).to({alpha:0.4662},0).wait(1).to({alpha:0.3767},0).wait(1).to({alpha:0.2865},0).wait(1).to({alpha:0.2036},0).wait(1).to({alpha:0.1357},0).wait(1).to({alpha:0.0874},0).wait(1).to({alpha:0.0595},0).wait(1).to({regX:0,regY:0,x:0,y:0,alpha:0.0508},0).to({_off:true},1).wait(26));
	...
	this.timeline.addTween(cjs.Tween.get(this.fns).wait(992).to({_off:false},0).wait(44));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(980).to({_off:false},0).to({alpha:0.8984},11).to({_off:true},1).wait(44));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(906).to({_off:false},0).to({alpha:0},7).to({_off:true},1).wait(122));
	...
	this.timeline.addTween(cjs.Tween.get(this.lighter_tgt).wait(642).to({_off:false},0).to({alpha:1},38).to({_off:true},226).wait(130));
	...
	this.timeline.addTween(cjs.Tween.get(this.lighter_tgt_1).wait(642).to({_off:false},0).to({alpha:0.4492},38).to({_off:true},226).wait(130));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_13).wait(15).to({_off:false},0).to({_off:true},977).wait(44));

	// 0eff
	this.instance_14 = new lib.eff_m();
	this.instance_14.parent = this;
	this.instance_14.setTransform(120.6,163.8,0.3436,0.3593,-92.7412,0,0,-0.1,0);
	this.instance_14.compositeOperation = "lighter";

	this.timeline.addTween(cjs.Tween.get(this.instance_14).to({_off:true},15).wait(1021));

	// 0eff
	this.instance_15 = new lib.eff_m();
	this.instance_15.parent = this;
	this.instance_15.setTransform(114.5,173.75,0.5706,0.5966);
	this.instance_15.compositeOperation = "lighter";

	this.timeline.addTween(cjs.Tween.get(this.instance_15).to({_off:true},15).wait(1021));

	// 0bg
	this.bg1 = new lib.bg2_1();
	this.bg1.name = "bg1";
	this.bg1.parent = this;
	this.bg1.setTransform(-48.4,-75.1,0.7,0.7);

	this.timeline.addTween(cjs.Tween.get(this.bg1).to({_off:true},15).wait(1021));
	...
	this.timeline.addTween(cjs.Tween.get(this.ch1).wait(15).to({regX:0.5,regY:0.3,scaleX:0.4875,scaleY:0.4875,x:118.4,y:220.7},0).to({regX:0.1,regY:0.1,scaleX:0.4482,scaleY:0.4482,y:213.25},26,cjs.Ease.get(1)).wait(145).to({regX:0.7,regY:0.4,scaleX:0.6045,scaleY:0.6045,x:116.1,y:245.2},63,cjs.Ease.quadInOut).wait(267).to({alpha:0},12).to({_off:true},1).wait(507));

	// eff
	this.instance_16 = new lib.eff_m();
	this.instance_16.parent = this;
	this.instance_16.setTransform(111.35,165.1,0.5569,0.5569,0,0,0,0.2,0.2);
	this.instance_16.compositeOperation = "lighter";

	this.timeline.addTween(cjs.Tween.get(this.instance_16).to({_off:true},15).wait(1021));

	// bg
	this.bg1_1 = new lib.bg_zoom_half();
	this.bg1_1.name = "bg1_1";
	this.bg1_1.parent = this;
	this.bg1_1.setTransform(-12.2,-9.7,0.4771,0.4771,0,0,0,-0.4,-0.2);
	this.bg1_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.bg1_1).wait(15).to({_off:false},0).to({regX:-0.1,regY:0,scaleX:0.4482,scaleY:0.4482,x:-4.1,y:-1.8},26,cjs.Ease.get(1)).wait(145).to({regX:-0.6,regY:-0.4,scaleX:0.6045,scaleY:0.6045,x:-49.7,y:-45.3},63,cjs.Ease.quadInOut).wait(267).to({alpha:0},12).to({_off:true},1).wait(507));

	// bg_c
	this.instance_17 = new lib.bg_s();
	this.instance_17.parent = this;
	this.instance_17.setTransform(134.1,157.15,1,1,0,0,0,-0.2,-0.1);
	this.instance_17._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_17).wait(809).to({_off:false},0).to({x:106.6},66,cjs.Ease.quadInOut).to({_off:true},1).wait(160));

	// ch
	this.ch2 = new lib.character1_container();
	this.ch2.name = "ch2";
	this.ch2.parent = this;
	this.ch2.setTransform(-429.6,568.15,1.0745,1.0745,0,0,0,0.8,0.5);

	this.timeline.addTween(cjs.Tween.get(this.ch2).to({_off:true},15).wait(501).to({_off:false,x:117.7,y:391},0).to({y:401},41,cjs.Ease.quadInOut).wait(85).to({regY:0.6,scaleX:1.3884,scaleY:1.3884,x:114.45,y:494.25},38,cjs.Ease.quadInOut).wait(226).to({regX:1,regY:0.7,scaleX:0.4515,scaleY:0.4515,x:117.3,y:214.1},0).to({_off:true},86).wait(44));

	// bg
	this.bg1_2 = new lib.bg_zoom_half();
	this.bg1_2.name = "bg1_2";
	this.bg1_2.parent = this;
	this.bg1_2.setTransform(-177.1,-125.25,1.0745,1.0745,0,0,0,-0.7,-0.5);
	this.bg1_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.bg1_2).wait(516).to({_off:false},0).to({y:-115.25},41,cjs.Ease.quadInOut).wait(85).to({scaleX:1.3884,scaleY:1.3884,x:-266.4,y:-172.9},38,cjs.Ease.quadInOut).wait(226).to({regY:-0.6,scaleX:0.4515,scaleY:0.4515,x:-6.6,y:-2.8},0).to({_off:true},86).wait(44));
	...
	this.timeline.addTween(cjs.Tween.get(this.toggle_btn).to({_off:true},980).wait(56));
	...
	this.timeline.addTween(cjs.Tween.get(this.stage_btn).to({_off:true},992).wait(39).to({_off:false},0).wait(5));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-603.7,-720,1223.7,1524.3);
// library properties:
lib.properties = {
	id: '_488_2',
	width: 240,
	...
	opacity: 1.00,
	manifest: [
		{src:"images/bg.jpg?1658717255574", id:"_488_2_bg"},
		{src:"images/bg2.jpg?1658717255574", id:"_488_2_bg2"},
		{src:"images/ch_base.png?1658717255574", id:"_488_2_ch_base"},
		{src:"images/ch_face2.png?1658717255574", id:"_488_2_ch_face2"},
		{src:"images/ch_face3.png?1658717255574", id:"_488_2_ch_face3"},
		{src:"images/ch_face4.png?1658717255574", id:"_488_2_ch_face4"},
		{src:"images/ch_face5.png?1658717255574", id:"_488_2_ch_face5"},
		{src:"images/ch_face6.png?1658717255574", id:"_488_2_ch_face6"},
		{src:"images/ch_face7.png?1658717255574", id:"_488_2_ch_face7"},
		{src:"images/eff.png?1658717255574", id:"_488_2_eff"},
		{src:"images/eff2.png?1658717255574", id:"_488_2_eff2"},
		{src:"images/eff3.png?1658717255574", id:"_488_2_eff3"},
		{src:"images/finish.jpg?1658717255574", id:"_488_2_finish"},
		{src:"images/finish_blur.jpg?1658717255574", id:"_488_2_finish_blur"},
		{src:"images/ke_egao.png?1658717255574", id:"_488_2_ke_egao"},
		{src:"images/ke_odoroku.png?1658717255574", id:"_488_2_ke_odoroku"},
		{src:"images/ke_tujo_mukure.png?1658717255574", id:"_488_2_ke_tujo_mukure"},
		{src:"images/tie_fp.png?1658717255574", id:"_488_2_tie_fp"},
		{src:"images/tie_sp.png?1658717255574", id:"_488_2_tie_sp"}
	],
	preloads: []
};
