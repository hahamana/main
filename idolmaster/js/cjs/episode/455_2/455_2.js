...
(lib.bg = function() {
	this.initialize(img._455_2_bg);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,1900,1900);


(lib.ch_base = function() {
	this.initialize(img._455_2_ch_base);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,1900,1900);


(lib.ch_face2 = function() {
	this.initialize(img._455_2_ch_face2);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,384,340);


(lib.ch_face3 = function() {
	this.initialize(img._455_2_ch_face3);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,384,340);


(lib.ch_face4 = function() {
	this.initialize(img._455_2_ch_face4);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,384,340);


(lib.ch_face5 = function() {
	this.initialize(img._455_2_ch_face5);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,384,340);


(lib.ch_face6 = function() {
	this.initialize(img._455_2_ch_face6);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,384,340);


(lib.ch_face7 = function() {
	this.initialize(img._455_2_ch_face7);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,384,340);


(lib.ch_face8 = function() {
	this.initialize(img._455_2_ch_face8);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,384,340);


(lib.ch_face9 = function() {
	this.initialize(img._455_2_ch_face9);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,384,340);


(lib.finish = function() {
	this.initialize(img._455_2_finish);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,480,620);


(lib.finish_blur = function() {
	this.initialize(img._455_2_finish_blur);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,480,620);


(lib.tie_fp = function() {
	this.initialize(img._455_2_tie_fp);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,240,32);


(lib.tie_sp = function() {
	this.initialize(img._455_2_tie_sp);
}).prototype = p = new cjs.Bitmap();
...
}).prototype = getMCSymbolPrototype(lib.character1_face_eyeclose, new cjs.Rectangle(0,0,192,170), null);
...
}).prototype = getMCSymbolPrototype(lib.character1_base, new cjs.Rectangle(-120,-396,950,950), null);
...
p.nominalBounds = new cjs.Rectangle(0,0,950,950);
...
(lib.tie = function(mode,startPosition,loop) {
	...
	// txt
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#333333").s().p("Ag5AuIAAgOIAyAAIAAg/IgsAAIAAgPIBmAAIAAAPIgqAAIAAA/IAwAAIAAAOg");
	this.shape.setTransform(15.95,2.05);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#333333").s().p("Ag4AxQAagGASgJQARgJAMgNQALgMAGgOQAGgPACgSIgRABIgXAAIgXAAIgVAAIgPAAIgGAAIAAgRIAHAAIARAAIAYAAIAaAAIAZAAIATAAIAJAAQgCAigMAaQgMAZgXARQgWARgjAIg");
	this.shape_1.setTransform(0.175,0.875);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#333333").s().p("AhCA5QAUgIAMgMQANgMAGgPQAGgPACgUIgwAAIAAgQIAyAAIAAgOIAAgOIARAAIAAAOIAAAOIA3AAIAAAYIgBAXIgBAWIgDAOQgDALgGAGQgGAFgIACQgIABgHAAIgIAAIgFAAIgIgSIALABIALAAIAHAAQAFgBADgDQAEgDACgGIABgNIABgRIABgRIAAgPIgnAAQgCAXgHAQQgGASgMAOQgOAOgUAKg");
	this.shape_2.setTransform(-16.55,0.45);
...
(lib.character1_face = function(mode,startPosition,loop) {
	...
	mask._off = true;
	mask.graphics.p("Au1NIIAA6PIdrAAIAAaPg");
	mask.setTransform(96,85);
...
p.nominalBounds = new cjs.Rectangle(1,1,190,168);
...
(lib.window = function(mode,startPosition,loop) {
	...
	// dummy
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#000000").s().p("Ag+A0QAdgMAUgQQATgRANgWQAMgXAGgfIAaAFQgEAVgIATQgIAUgMAQQgMARgRAPQgRAOgZAMg");
	this.shape.setTransform(55.575,12.075);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#000000").s().p("AgJAaIg8AFIgBgWIA6gDIgCgbIg1ADIgCgVIA1gEIgCgcIAVgCIADAdIA4gEIACAVIg4AEIADAbIA7gEIABAVIg6AEIAFAvIgXABg");
	this.shape_1.setTransform(39.9,11.85);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#000000").s().p("AgFAlQgLgMgNgLQgNgLgMgHIATgNIAPAKIARAOQALgHAJgJQAIgIAGgJQAGgIACgIIhtABIAAgWICNAAQgBAOgGANQgGANgIALQgIALgJAIQgKAJgJAHIAMANIAKAMIgTAQQgLgOgLgNg");
	this.shape_2.setTransform(23.975,12.525);
...
(lib.character1_face_container = function(mode,startPosition,loop) {
	...
	this.frame_0 = function() {
		...
		this.face_blink_ary = [1, 1, 1, 1, 0, 0, 1, 0, 0, 1, 0, 0, 1, 1, 1]; 
	...
	var mask = new cjs.Shape();
	mask._off = true;
	var mask_graphics_15 = new cjs.Graphics().p("");
	...
	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:null,x:0,y:0}).wait(15).to({graphics:mask_graphics_15,x:100.0711,y:62.8078}).wait(6).to({graphics:mask_graphics_21,x:31.25,y:41.8}).wait(6));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(15).to({_off:false},0).wait(1).to({alpha:1},0).wait(1).to({regX:96,regY:85,x:96,y:85,alpha:0.3015},0).wait(1).to({alpha:0.0922},0).wait(1).to({regX:35,regY:30,x:35,y:30,alpha:0},0).wait(2).to({alpha:0.1992},0).wait(1).to({alpha:1},0).wait(1).to({regX:96,regY:85,x:96,y:85,alpha:0.3015},0).wait(1).to({alpha:0.0922},0).wait(1).to({regX:35,regY:30,x:35,y:30,alpha:0},0).wait(2));
	...
	this.timeline.addTween(cjs.Tween.get(this.f2).wait(5).to({alpha:0.1992},0).wait(1).to({regX:96,regY:85,x:96,y:85,alpha:0.6441},0).wait(1).to({alpha:0.911},0).wait(1).to({regX:35,regY:30,x:35,y:30,alpha:1},0).wait(19));
	...
	this.timeline.addTween(cjs.Tween.get(this.f1_alpha).wait(5).to({alpha:0.8008},0).wait(1).to({regX:96,regY:85,x:96,y:85,alpha:0.7118},0).wait(1).to({alpha:0.4449},0).wait(1).to({regX:35,regY:30,x:35,y:30,alpha:0},0).wait(19));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-378,-281,950,950);
...
(lib.character1_body = function(mode,startPosition,loop) {
	...
	this.f.name = "f";
	this.f.parent = this;
	this.f.setTransform(-10.3,-417.25);
	...
	this.b.name = "b";
	this.b.parent = this;
	this.b.setTransform(-268.3,-302.25);

	this.timeline.addTween(cjs.Tween.get(this.b).wait(2));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-388.3,-698.2,950,950);
...
(lib.character1_container = function(mode,startPosition,loop) {
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(7).call(this.frame_7).wait(1).call(this.frame_8).wait(7).call(this.frame_15).wait(1).call(this.frame_16).wait(8).call(this.frame_24).wait(1).call(this.frame_25).wait(11).call(this.frame_36).wait(1).call(this.frame_37).wait(9).call(this.frame_46).wait(1).call(this.frame_47).wait(9).call(this.frame_56).wait(1).call(this.frame_57).wait(8).call(this.frame_65).wait(1).call(this.frame_66).wait(14).call(this.frame_80).wait(1).call(this.frame_81).wait(10).call(this.frame_91).wait(1).call(this.frame_92).wait(19).call(this.frame_111).wait(1).call(this.frame_112).wait(8).call(this.frame_120).wait(1).call(this.frame_121).wait(10).call(this.frame_131).wait(1).call(this.frame_132).wait(13).call(this.frame_145).wait(1).call(this.frame_146).wait(13).call(this.frame_159).wait(1).call(this.frame_160).wait(20).call(this.frame_180).wait(1).call(this.frame_181).wait(19).call(this.frame_200).wait(1).call(this.frame_201).wait(27).call(this.frame_228).wait(1).call(this.frame_229).wait(11).call(this.frame_240).wait(1).call(this.frame_241).wait(10).call(this.frame_251).wait(1).call(this.frame_252).wait(15).call(this.frame_267).wait(1).call(this.frame_268).wait(26).call(this.frame_294).wait(1).call(this.frame_295).wait(17).call(this.frame_312).wait(1).call(this.frame_313).wait(11).call(this.frame_324).wait(1).call(this.frame_325).wait(17).call(this.frame_342).wait(1).call(this.frame_343).wait(6).call(this.frame_349).wait(1).call(this.frame_350).wait(18).call(this.frame_368).wait(1).call(this.frame_369).wait(14).call(this.frame_383).wait(1).call(this.frame_384).wait(19).call(this.frame_403).wait(1).call(this.frame_404).wait(11).call(this.frame_415).wait(1).call(this.frame_416).wait(16).call(this.frame_432).wait(1).call(this.frame_433).wait(8).call(this.frame_441).wait(1).call(this.frame_442).wait(8).call(this.frame_450).wait(1));

	// effect2
	this.instance = new lib.drop1_v2("synched",0);
	this.instance.parent = this;
	this.instance.setTransform(23.7,-419.3,1.3618,1.3618);
	this.instance._off = true;

	this.instance_1 = new lib.heart();
	this.instance_1.parent = this;
	this.instance_1.setTransform(11.2,-359.8,0.53,0.53);
	this.instance_1.alpha = 0;
	this.instance_1.compositeOperation = "lighter";
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(313).to({_off:false},0).wait(1).to({regX:1.2,regY:1.8,rotation:-33.7497,x:-6.25,y:-429.75,alpha:0.4141},0).wait(1).to({regX:0,regY:0,rotation:-44.9995,x:-19.8,y:-434.85,alpha:0.2188},0).to({_off:true},1).wait(1).to({_off:false,rotation:0,x:23.7,y:-419.3,alpha:1},0).wait(1).to({regX:1.2,regY:1.8,rotation:-33.7497,x:-6.25,y:-429.75,alpha:0.4141},0).wait(1).to({regX:0,regY:0,rotation:-44.9995,x:-19.8,y:-434.85,alpha:0.2188},0).to({_off:true},1).wait(5).to({_off:false,rotation:0,x:23.7,y:-419.3,alpha:1},0).wait(1).to({regX:1.2,regY:1.8,rotation:-33.7497,x:-6.25,y:-429.75,alpha:0.4141},0).wait(1).to({regX:0,regY:0,rotation:-44.9995,x:-19.8,y:-434.85,alpha:0.2188},0).to({_off:true},1).wait(1).to({_off:false,rotation:0,x:23.7,y:-419.3,alpha:1},0).wait(1).to({regX:1.2,regY:1.8,rotation:-33.7497,x:-6.25,y:-429.75,alpha:0.4141},0).wait(1).to({regX:0,regY:0,rotation:-44.9995,x:-19.8,y:-434.85,alpha:0.2188},0).to({_off:true},1).wait(119));
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(370).to({_off:false},0).wait(1).to({regX:2.3,regY:1,scaleX:1.0095,scaleY:1.0095,x:9.15,y:-376.35,alpha:0.375},0).wait(1).to({regX:0,regY:0,scaleX:1.1694,scaleY:1.1694,x:5.35,y:-383.2,alpha:0.5},0).wait(1).to({regX:2.3,regY:1,scaleX:1.1573,scaleY:1.1573,x:8.25,y:-380.75,alpha:0.4444},0).wait(1).to({scaleX:1.1209,scaleY:1.1209,x:8.95,y:-376.9,alpha:0.2778},0).wait(1).to({regX:0,regY:0,scaleX:1.0603,scaleY:1.0603,x:7.7,y:-371.5,alpha:0},0).to({_off:true},1).wait(75));

	// effect
	this.instance_2 = new lib.spread_flower_pink("synched",0,false);
	this.instance_2.parent = this;
	this.instance_2.setTransform(87.05,-309.2,1.7316,1.7316);

	this.instance_3 = new lib.good_effect("synched",0,false);
	this.instance_3.parent = this;
	this.instance_3.setTransform(87.05,-309.2,1.7318,1.7318);

	this.instance_4 = new lib.notice();
	this.instance_4.parent = this;
	this.instance_4.setTransform(3.15,-414.65,1.3881,1.3881,0,-169.8309,10.1691,-29.1,20.5);
	this.instance_4._off = true;

	this.instance_5 = new lib.laugh("synched",0);
	this.instance_5.parent = this;
	this.instance_5.setTransform(-21,-408.3,1.6609,1.6609,35.8423,0,0,-30.2,20.5);
	this.instance_5._off = true;

	this.instance_6 = new lib.chord("synched",0,false);
	this.instance_6.parent = this;
	this.instance_6.setTransform(11.15,-312.05,1.1728,1.1728,-61.4997,0,0,-23.4,76.8);

	this.instance_7 = new lib.question();
	this.instance_7.parent = this;
	this.instance_7.setTransform(10.5,-410.95,1.2314,1.2314,-28.4908);
	this.instance_7.alpha = 0;
	this.instance_7._off = true;

	this.instance_8 = new lib.mc_exclamation("synched",0,false);
	this.instance_8.parent = this;
	this.instance_8.setTransform(7.95,-428.2,1.2781,1.2781,-29.9995,0,0,0.1,0.1);

	this.instance_9 = new lib.drop1a("synched",0);
	this.instance_9.parent = this;
	this.instance_9.setTransform(14.3,-406.4,1.1694,1.1694,0,0,0,-0.5,0.2);
	this.instance_9._off = true;

	this.instance_10 = new lib.drop2_v2("synched",0);
	this.instance_10.parent = this;
	this.instance_10.setTransform(21.6,-407.9,1.1549,1.1549,14.9994);
	this.instance_10._off = true;

	this.instance_11 = new lib.shock("synched",0);
	this.instance_11.parent = this;
	this.instance_11.setTransform(10.4,-412.2,1.6229,1.6229,-121.2393);

	this.instance_12 = new lib.sigh("synched",0);
	this.instance_12.parent = this;
	this.instance_12.setTransform(36.7,-231.65,1.1694,1.1694);
	this.instance_12.alpha = 0.6016;
	this.instance_12._off = true;

	this.instance_13 = new lib.heart("synched",0);
	this.instance_13.parent = this;
	this.instance_13.setTransform(11.2,-359.8,0.53,0.53);
	this.instance_13._off = true;

	this.instance_14 = new lib.angry("synched",0);
	this.instance_14.parent = this;
	this.instance_14.setTransform(172.55,-383.3,0.6169,0.6169,0,0,0,0.1,0);
	this.instance_14._off = true;

	this.instance_15 = new lib.mc_punpun();
	this.instance_15.parent = this;
	this.instance_15.setTransform(19.25,-440.75,1.3305,1.3305);

	this.instance_16 = new lib.concent_wrapper("synched",0,false);
	this.instance_16.parent = this;
	this.instance_16.setTransform(86.7,-309.85,1.1694,1.1694,0,0,0,-0.5,-0.1);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_2}]},37).to({state:[{t:this.instance_3}]},10).to({state:[]},10).to({state:[{t:this.instance_4}]},76).to({state:[]},2).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},2).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[]},1).to({state:[{t:this.instance_4}]},2).to({state:[]},2).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},2).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[]},1).to({state:[{t:this.instance_5}]},1).to({state:[{t:this.instance_5}]},15).to({state:[{t:this.instance_5}]},1).to({state:[{t:this.instance_5}]},1).to({state:[{t:this.instance_5}]},1).to({state:[{t:this.instance_5}]},1).to({state:[]},1).to({state:[{t:this.instance_6}]},1).to({state:[]},20).to({state:[{t:this.instance_7}]},1).to({state:[{t:this.instance_7}]},1).to({state:[{t:this.instance_7}]},1).to({state:[{t:this.instance_7}]},1).to({state:[{t:this.instance_7}]},1).to({state:[{t:this.instance_7}]},1).to({state:[{t:this.instance_7}]},1).to({state:[{t:this.instance_7}]},1).to({state:[{t:this.instance_7}]},2).to({state:[{t:this.instance_7}]},7).to({state:[{t:this.instance_7}]},1).to({state:[{t:this.instance_7}]},1).to({state:[{t:this.instance_7}]},1).to({state:[{t:this.instance_7}]},1).to({state:[{t:this.instance_7}]},1).to({state:[]},1).to({state:[{t:this.instance_7}]},6).to({state:[{t:this.instance_7}]},1).to({state:[{t:this.instance_7}]},1).to({state:[{t:this.instance_7}]},1).to({state:[{t:this.instance_7}]},1).to({state:[{t:this.instance_7}]},1).to({state:[{t:this.instance_7}]},1).to({state:[{t:this.instance_7}]},1).to({state:[{t:this.instance_7}]},2).to({state:[{t:this.instance_7}]},2).to({state:[{t:this.instance_7}]},1).to({state:[{t:this.instance_7}]},1).to({state:[{t:this.instance_7}]},1).to({state:[{t:this.instance_7}]},1).to({state:[{t:this.instance_7}]},1).to({state:[]},1).to({state:[{t:this.instance_8}]},5).to({state:[{t:this.instance_9}]},16).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},9).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[]},1).to({state:[{t:this.instance_10}]},24).to({state:[{t:this.instance_10}]},1).to({state:[{t:this.instance_10}]},1).to({state:[]},1).to({state:[{t:this.instance_10}]},1).to({state:[{t:this.instance_10}]},1).to({state:[{t:this.instance_10}]},1).to({state:[]},1).to({state:[{t:this.instance_10}]},5).to({state:[{t:this.instance_10}]},1).to({state:[{t:this.instance_10}]},1).to({state:[]},1).to({state:[{t:this.instance_10}]},1).to({state:[{t:this.instance_10}]},1).to({state:[{t:this.instance_10}]},1).to({state:[]},1).to({state:[{t:this.instance_11}]},11).to({state:[]},1).to({state:[{t:this.instance_11}]},1).to({state:[]},1).to({state:[{t:this.instance_11}]},1).to({state:[]},1).to({state:[{t:this.instance_12}]},3).to({state:[{t:this.instance_12}]},1).to({state:[{t:this.instance_12}]},1).to({state:[{t:this.instance_12}]},1).to({state:[{t:this.instance_12}]},1).to({state:[{t:this.instance_12}]},1).to({state:[{t:this.instance_12}]},1).to({state:[{t:this.instance_12}]},1).to({state:[]},1).to({state:[{t:this.instance_13}]},11).to({state:[{t:this.instance_13}]},1).to({state:[{t:this.instance_13}]},1).to({state:[{t:this.instance_13}]},1).to({state:[{t:this.instance_13}]},1).to({state:[{t:this.instance_13}]},1).to({state:[{t:this.instance_13}]},2).to({state:[{t:this.instance_13}]},3).to({state:[{t:this.instance_13}]},1).to({state:[{t:this.instance_13}]},1).to({state:[]},1).to({state:[{t:this.instance_14}]},6).to({state:[{t:this.instance_14}]},1).to({state:[{t:this.instance_14}]},1).to({state:[{t:this.instance_14}]},1).to({state:[{t:this.instance_14}]},1).to({state:[{t:this.instance_14}]},5).to({state:[{t:this.instance_14}]},1).to({state:[{t:this.instance_14}]},1).to({state:[{t:this.instance_14}]},1).to({state:[]},1).to({state:[{t:this.instance_15}]},2).to({state:[]},12).to({state:[{t:this.instance_16}]},17).to({state:[]},9).wait(9));
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(133).to({_off:false},0).to({_off:true},2).wait(1).to({_off:false},0).wait(3).to({regX:-28.8,x:3.55,y:-414.5,alpha:0.6944},0).wait(1).to({alpha:0.4444},0).wait(1).to({alpha:0.25},0).wait(1).to({alpha:0.1111},0).wait(1).to({alpha:0.0278},0).wait(1).to({regX:-29.1,x:3.15,y:-414.65,alpha:0},0).to({_off:true},1).wait(2).to({_off:false,alpha:1},0).to({_off:true},2).wait(1).to({_off:false},0).wait(3).to({regX:-28.8,x:3.55,y:-414.5,alpha:0.6944},0).wait(1).to({alpha:0.4444},0).wait(1).to({alpha:0.25},0).wait(1).to({alpha:0.1111},0).wait(1).to({alpha:0.0278},0).wait(1).to({regX:-29.1,x:3.15,y:-414.65,alpha:0},0).to({_off:true},1).wait(292));
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(160).to({_off:false},0).wait(15).to({startPosition:0},0).wait(1).to({regX:-31.4,regY:22.1,x:-24.25,y:-407.35,alpha:0.5625,startPosition:1},0).wait(1).to({alpha:0.25,startPosition:2},0).wait(1).to({alpha:0.0625,startPosition:3},0).wait(1).to({regX:-30.2,regY:20.5,x:-21,y:-408.3,alpha:0,startPosition:19},0).to({_off:true},1).wait(271));
	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(202).to({_off:false},0).wait(1).to({regX:-0.2,regY:0.2,x:2.4,y:-426.65,alpha:0.5556},0).wait(1).to({x:-2.35,y:-436.25,alpha:0.8889},0).wait(1).to({regX:0,regY:0,x:-3.9,y:-439.85,alpha:1},0).wait(1).to({regX:-0.2,regY:0.2,x:-3.6,y:-438.8},0).wait(1).to({x:-2.4,y:-436.6},0).wait(1).to({x:-0.45,y:-432.95},0).wait(1).to({regX:0,regY:0,x:2.4,y:-428.15},0).to({x:1.55,y:-429.7},2).wait(8).to({regX:-0.2,regY:0.2,x:1.8,y:-428.7,alpha:0.9298},0).wait(1).to({x:3.05,y:-426.45,alpha:0.692},0).wait(1).to({x:4.9,y:-423.05,alpha:0.339},0).wait(1).to({x:6.3,y:-420.55,alpha:0.0788},0).wait(1).to({regX:0,regY:0,x:6.75,y:-420.15,alpha:0},0).to({_off:true},1).wait(6).to({_off:false,x:9.95,y:-410.5},0).wait(1).to({regX:-0.2,regY:0.2,x:1.8,y:-426.2,alpha:0.5556},0).wait(1).to({x:-2.95,y:-435.85,alpha:0.8889},0).wait(1).to({regX:0,regY:0,x:-4.4,y:-439.35,alpha:1},0).wait(1).to({regX:-0.2,regY:0.2,x:-4.1,y:-438.3},0).wait(1).to({x:-2.9,y:-436.1},0).wait(1).to({x:-0.95,y:-432.4},0).wait(1).to({regX:0,regY:0,x:1.9,y:-427.7},0).to({x:1,y:-429.25},2).wait(3).to({regX:-0.2,regY:0.2,x:1.25,y:-428.25,alpha:0.9298},0).wait(1).to({x:2.5,y:-425.95,alpha:0.692},0).wait(1).to({x:4.35,y:-422.6,alpha:0.339},0).wait(1).to({x:5.7,y:-420.1,alpha:0.0788},0).wait(1).to({regX:0,regY:0,x:6.25,y:-419.65,alpha:0},0).to({_off:true},1).wait(204));
	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(268).to({_off:false},0).wait(1).to({regX:0.5,regY:-0.6,x:15.5,y:-402.1},0).wait(1).to({y:-397.6},0).wait(1).to({y:-393.8},0).wait(1).to({y:-390.7},0).wait(1).to({y:-388.25},0).wait(1).to({y:-386.5},0).wait(1).to({y:-385.5},0).wait(1).to({regX:-0.5,regY:0.1,x:14.3,y:-384.3},0).wait(9).to({startPosition:0},0).wait(1).to({regX:0.5,regY:-0.6,x:15.5,y:-385.1,alpha:0.4444},0).wait(1).to({alpha:0.1111},0).wait(1).to({regX:-0.5,regY:0.1,x:14.3,y:-384.3,alpha:0},0).to({_off:true},1).wait(162));
	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(313).to({_off:false},0).wait(1).to({scaleX:1.3101,scaleY:1.3101,rotation:-18.7494,x:-15.1613,y:-402.4714,alpha:0.4141},0).wait(1).to({scaleX:1.3618,scaleY:1.3618,rotation:-29.999,x:-27.35,y:-400.7,alpha:0.2188},0).to({_off:true},1).wait(1).to({_off:false,scaleX:1.1549,scaleY:1.1549,rotation:14.9994,x:21.6,y:-407.9,alpha:1},0).wait(1).to({scaleX:1.3101,scaleY:1.3101,rotation:-18.7494,x:-15.1613,y:-407.6089,alpha:0.4141},0).wait(1).to({scaleX:1.3618,scaleY:1.3618,rotation:-29.999,x:-27.35,y:-407.55,alpha:0.2188},0).to({_off:true},1).wait(5).to({_off:false,scaleX:1.1549,scaleY:1.1549,rotation:14.9994,x:21.6,y:-407.9,alpha:1},0).wait(1).to({scaleX:1.3101,scaleY:1.3101,rotation:-18.7494,x:-15.1613,y:-402.4714,alpha:0.4141},0).wait(1).to({scaleX:1.3618,scaleY:1.3618,rotation:-29.999,x:-27.35,y:-400.7,alpha:0.2188},0).to({_off:true},1).wait(1).to({_off:false,scaleX:1.1549,scaleY:1.1549,rotation:14.9994,x:21.6,y:-407.9,alpha:1},0).wait(1).to({scaleX:1.3101,scaleY:1.3101,rotation:-18.7494,x:-15.1613,y:-407.6089,alpha:0.4141},0).wait(1).to({scaleX:1.3618,scaleY:1.3618,rotation:-29.999,x:-27.35,y:-407.55,alpha:0.2188},0).to({_off:true},1).wait(119));
	this.timeline.addTween(cjs.Tween.get(this.instance_12).wait(351).to({_off:false},0).wait(1).to({x:35.5,y:-230.45,alpha:1},0).wait(1).to({regX:0.9,x:35.3,y:-229.35,alpha:0.8965},0).wait(1).to({x:33.75,y:-227.95,alpha:0.7636},0).wait(1).to({x:31.9,y:-226.25,alpha:0.6048},0).wait(1).to({x:29.75,y:-224.35,alpha:0.4229},0).wait(1).to({x:27.4,y:-222.2,alpha:0.2205},0).wait(1).to({regX:0,x:23.85,y:-219.95,alpha:0},0).to({_off:true},1).wait(92));
	this.timeline.addTween(cjs.Tween.get(this.instance_13).wait(370).to({_off:false},0).wait(1).to({regX:2.3,regY:1,scaleX:1.0095,scaleY:1.0095,x:9.15,y:-376.35},0).wait(1).to({regX:0,regY:0,scaleX:1.1694,scaleY:1.1694,x:5.35,y:-383.2},0).wait(1).to({regX:2.3,regY:1,scaleX:1.1573,scaleY:1.1573,x:8.25,y:-380.75},0).wait(1).to({scaleX:1.1209,scaleY:1.1209,x:8.95,y:-376.9},0).wait(1).to({regX:0,regY:0,scaleX:1.0603,scaleY:1.0603,x:7.7,y:-371.5},0).to({scaleX:1.1694,scaleY:1.1694,x:6.5,y:-376.15},2).wait(3).to({scaleX:1.3057,scaleY:1.3057},0).wait(1).to({regX:2.3,regY:1,scaleX:0.9484,scaleY:0.9484,x:9.55,y:-374.95,alpha:0.3262},0).wait(1).to({regX:0,regY:0,scaleX:0.8294,scaleY:0.8294,x:7.7,y:-375.85,alpha:0.1016},0).to({_off:true},1).wait(68));
	this.timeline.addTween(cjs.Tween.get(this.instance_14).wait(389).to({_off:false},0).wait(1).to({regX:0,scaleX:1.2529,scaleY:1.2529,x:172.4451,y:-387.6875},0).wait(1).to({scaleX:1.4649,scaleY:1.4649,x:172.5,y:-389.15},0).wait(1).to({scaleX:1.1534,scaleY:1.1534},0).wait(1).to({scaleX:1.0496,scaleY:1.0496},0).wait(5).to({startPosition:0},0).wait(1).to({alpha:0.5009},0).wait(1).to({alpha:0.2014},0).wait(1).to({alpha:0.1016},0).to({_off:true},1).wait(49));
	...
	this.timeline.addTween(cjs.Tween.get(this.c).wait(9).to({regX:86.7,regY:-223.2,x:86.7,y:-231.6},0).wait(1).to({regX:0,regY:0,x:0,y:-10},0).wait(1).to({regX:86.7,regY:-223.2,x:86.7,y:-232.4},0).wait(1).to({y:-229.65},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({y:1},0).wait(1).to({y:0},0).wait(1).to({y:2},0).wait(1).to({regX:86.7,regY:-223.2,x:86.7,y:-228.7},0).wait(1).to({regX:0,regY:0,x:0,y:-8},0).wait(1).to({regX:86.7,regY:-223.2,x:86.7,y:-228.95},0).wait(1).to({y:-222},0).wait(1).to({regX:0,regY:0,x:0,y:4},0).wait(1).to({regX:86.7,regY:-223.2,x:86.7,y:-219.95},0).wait(1).to({y:-222.35},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({y:2},0).wait(1).to({y:-7},0).wait(1).to({regX:86.7,regY:-223.2,x:86.7,y:-228.15},0).wait(1).to({y:-222.25},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({y:-7},0).wait(1).to({regX:86.7,regY:-223.2,x:86.7,y:-228.15},0).wait(1).to({y:-222.25},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({regX:86.7,regY:-223.2,x:86.7,y:-222.3},0).wait(1).to({y:-222.95},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({y:6},0).wait(1).to({regX:86.7,regY:-223.2,x:86.7,y:-232.2},0).wait(1).to({regX:0,regY:0,x:0,y:-14},0).wait(1).to({regX:86.7,regY:-223.2,x:86.7,y:-236.15},0).wait(1).to({y:-232.55},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({regX:86.7,regY:-223.2,x:86.7,y:-221.2},0).wait(1).to({regX:0,regY:0,x:0,y:-1},0).wait(1).to({regX:86.7,regY:-223.2,x:86.7,y:-223.45},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({y:6},0).wait(1).to({regX:86.7,regY:-223.2,x:86.7,y:-232.2},0).wait(1).to({regX:0,regY:0,x:0,y:-14},0).wait(1).to({regX:86.7,regY:-223.2,x:86.7,y:-236.15},0).wait(1).to({y:-232.55},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({regX:86.7,regY:-223.2,x:86.7,y:-221.2},0).wait(1).to({regX:0,regY:0,x:0,y:-1},0).wait(1).to({regX:86.7,regY:-223.2,x:86.7,y:-223.45},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(2).to({regX:86.7,regY:-223.2,x:86.7,y:-222.6},0).wait(1).to({y:-220.2},0).wait(1).to({y:-217.85},0).wait(1).to({regX:0,regY:0,x:0,y:6},0).wait(1).to({regX:86.7,regY:-223.2,x:86.7,y:-217.85},0).wait(1).to({y:-220.2},0).wait(1).to({y:-222.6},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(2).to({regX:86.7,regY:-223.2,x:86.7,y:-223.05},0).wait(1).to({y:-222.5},0).wait(1).to({y:-221.4},0).wait(1).to({y:-220.05},0).wait(1).to({y:-218.95},0).wait(1).to({y:-218.4},0).wait(1).to({regX:0,regY:0,x:0,y:5},0).wait(1).to({regX:86.7,regY:-223.2,x:86.7,y:-218.4},0).wait(1).to({y:-218.95},0).wait(1).to({y:-220.05},0).wait(1).to({y:-221.4},0).wait(1).to({y:-222.5},0).wait(1).to({y:-223.05},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({y:6},2).wait(1).to({regX:86.7,regY:-223.2,x:86.7,y:-218.45},0).wait(1).to({y:-222},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).to({y:6},2).wait(1).to({regX:86.7,regY:-223.2,x:86.7,y:-221},0).wait(1).to({y:-222.85},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(2).to({regX:86.7,regY:-223.2,rotation:-0.02,x:86.65,y:-223.2},0).wait(1).to({rotation:-0.0893,x:86.35,y:-223.05},0).wait(1).to({rotation:-0.2249,x:85.8,y:-222.7},0).wait(1).to({rotation:-0.44,x:85,y:-222.15},0).wait(1).to({rotation:-0.7099,x:83.95,y:-221.5},0).wait(1).to({rotation:-0.9547,x:83,y:-220.95},0).wait(1).to({rotation:-1.118,x:82.35,y:-220.55},0).wait(1).to({rotation:-1.2018,x:82,y:-220.3},0).wait(1).to({regX:0,regY:0,rotation:-1.2258,x:0,y:4.75},0).wait(1).to({regX:86.7,regY:-223.2,rotation:-1.2101,x:82,y:-220.35},0).wait(1).to({rotation:-1.1564,x:82.2,y:-220.45},0).wait(1).to({rotation:-1.0529,x:82.6,y:-220.7},0).wait(1).to({rotation:-0.8876,x:83.25,y:-221.1},0).wait(1).to({rotation:-0.6641,x:84.1,y:-221.7},0).wait(1).to({rotation:-0.4253,x:85.05,y:-222.3},0).wait(1).to({rotation:-0.2317,x:85.8,y:-222.75},0).wait(1).to({rotation:-0.1065,x:86.3,y:-223.05},0).wait(1).to({rotation:-0.0416,x:86.55,y:-223.2},0).wait(1).to({regX:0,regY:0,rotation:-0.0227,x:0,y:0},0).wait(1).to({rotation:0},0).wait(1).to({regX:86.7,regY:-223.2,rotation:-0.02,x:86.65,y:-223.2},0).wait(1).to({rotation:-0.0893,x:86.35,y:-223.05},0).wait(1).to({rotation:-0.2249,x:85.8,y:-222.7},0).wait(1).to({rotation:-0.44,x:85,y:-222.15},0).wait(1).to({rotation:-0.7099,x:83.95,y:-221.5},0).wait(1).to({rotation:-0.9547,x:83,y:-220.95},0).wait(1).to({rotation:-1.118,x:82.35,y:-220.55},0).wait(1).to({rotation:-1.2018,x:82,y:-220.3},0).wait(1).to({regX:0,regY:0,rotation:-1.2258,x:0,y:4.75},0).wait(1).to({regX:86.7,regY:-223.2,rotation:-1.2098,x:82,y:-220.35},0).wait(1).to({rotation:-1.1551,x:82.2,y:-220.45},0).wait(1).to({rotation:-1.0496,x:82.6,y:-220.7},0).wait(1).to({rotation:-0.8812,x:83.25,y:-221.1},0).wait(1).to({rotation:-0.6535,x:84.15,y:-221.7},0).wait(1).to({rotation:-0.4102,x:85.1,y:-222.25},0).wait(1).to({rotation:-0.2129,x:85.85,y:-222.7},0).wait(1).to({rotation:-0.0853,x:86.35,y:-223.05},0).wait(1).to({rotation:-0.0192,x:86.65,y:-223.2},0).wait(1).to({regX:0,regY:0,rotation:0,x:0,y:0},0).wait(16).to({regX:86.7,regY:-223.2,x:86.7,y:-228.75},0).wait(1).to({y:-230.65},0).wait(1).to({regX:0,regY:0,x:0,y:-8},0).wait(1).to({regX:86.7,regY:-223.2,x:86.7,y:-230.55},0).wait(1).to({y:-228.45},0).wait(1).to({regX:0,regY:0,x:0,y:2},0).wait(1).to({y:1},0).wait(1).to({y:0},0).wait(7).to({regX:86.7,regY:-223.2,x:86.7,y:-231.6},0).wait(1).to({regX:0,regY:0,x:0,y:-10},0).wait(1).to({regX:86.7,regY:-223.2,x:86.7,y:-232.4},0).wait(1).to({y:-229.65},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({y:1},0).wait(1).to({y:0},0).wait(15).to({regX:86.7,regY:-223.2,rotation:-0.0253,x:86.6,y:-223.15},0).wait(1).to({rotation:-0.1129,x:86.35,y:-222.7},0).wait(1).to({rotation:-0.2845,x:85.95,y:-222},0).wait(1).to({rotation:-0.5565,x:85.25,y:-220.85},0).wait(1).to({scaleX:0.9999,scaleY:0.9999,rotation:-0.898,x:84.35,y:-219.3},0).wait(1).to({rotation:-1.2075,x:83.5,y:-218},0).wait(1).to({rotation:-1.4141,x:82.95,y:-217.05},0).wait(1).to({rotation:-1.5201,x:82.7,y:-216.6},0).wait(1).to({regX:0,regY:0,rotation:-1.5505,x:2,y:9},0).wait(1).to({regX:86.7,regY:-223.2,rotation:-1.5305,x:82.65,y:-216.55},0).wait(1).to({rotation:-1.4624,x:82.8,y:-216.85},0).wait(1).to({rotation:-1.3309,x:83.15,y:-217.4},0).wait(1).to({rotation:-1.121,x:83.7,y:-218.4},0).wait(1).to({rotation:-0.8372,x:84.5,y:-219.65},0).wait(1).to({scaleX:1,scaleY:1,rotation:-0.534,x:85.25,y:-221},0).wait(1).to({rotation:-0.2881,x:85.9,y:-222.1},0).wait(1).to({rotation:-0.1291,x:86.3,y:-222.8},0).wait(1).to({rotation:-0.0467,x:86.5,y:-223.15},0).wait(1).to({regX:0,regY:0,rotation:-0.0227,x:0,y:0},0).wait(1).to({rotation:0},0).wait(1).to({regX:86.7,regY:-223.2,rotation:-0.147,x:86.3,y:-222.95},0).wait(1).to({rotation:-0.7239,x:84.8,y:-221.95},0).wait(1).to({scaleX:0.9999,scaleY:0.9999,rotation:-1.3727,x:83.05,y:-220.8},0).wait(1).to({regX:0,regY:0,rotation:-1.5505,x:2,y:5},0).wait(18).to({regX:86.7,regY:-223.2,rotation:-1.4885,x:82.75,y:-220.55},0).wait(1).to({rotation:-1.2569,x:83.35,y:-220.9},0).wait(1).to({rotation:-0.8036,x:84.6,y:-221.65},0).wait(1).to({rotation:-0.3046,x:85.95,y:-222.45},0).wait(1).to({regX:0,regY:0,rotation:-0.0254,x:0.15,y:0.35},0).to({scaleX:1,scaleY:1,rotation:-0.0227,x:0,y:0},1).wait(1).to({rotation:0},0).wait(1).to({regX:86.7,regY:-223.2,rotation:-0.0894,x:86.45,y:-223.1},0).wait(1).to({rotation:-0.4358,x:85.55,y:-222.45},0).wait(1).to({scaleX:0.9999,scaleY:0.9999,rotation:-1.0316,x:84,y:-221.4},0).wait(1).to({rotation:-1.4426,x:82.9,y:-220.65},0).wait(1).to({regX:0,regY:0,rotation:-1.5505,x:2,y:5},0).wait(8).to({regX:86.7,regY:-223.2,rotation:-1.4913,x:82.75,y:-220.55},0).wait(1).to({rotation:-1.2701,x:83.3,y:-220.95},0).wait(1).to({rotation:-0.8372,x:84.5,y:-221.75},0).wait(1).to({scaleX:1,scaleY:1,rotation:-0.3606,x:85.7,y:-222.65},0).wait(1).to({rotation:-0.094,x:86.4,y:-223.15},0).wait(1).to({regX:0,regY:0,rotation:-0.0227,x:0,y:0},0).wait(5).to({rotation:0},0).wait(1).to({regX:86.7,regY:-223.2,x:86.7,y:-231.6},0).wait(1).to({regX:0,regY:0,x:0,y:-10},0).wait(1).to({regX:86.7,regY:-223.2,x:86.7,y:-232.4},0).wait(1).to({y:-229.65},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({y:1},0).wait(1).to({y:0},0).wait(9).to({x:1,y:4},1,cjs.Ease.get(1)).wait(1).to({regX:86.7,regY:-223.2,x:83.95,y:-215.45},0).wait(1).to({regX:0,regY:0,x:-4,y:9},0).to({x:0,y:13},4).wait(11).to({regX:86.7,regY:-223.2,x:86.7,y:-210.95},0).wait(1).to({y:-213.9},0).wait(1).to({y:-218.85},0).wait(1).to({y:-222.3},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(5).to({y:-1},0).wait(1).to({regX:86.7,regY:-223.2,x:86.7,y:-222.2},0).wait(1).to({y:-216.25},0).wait(1).to({regX:0,regY:0,x:0,y:9},0).to({y:8},2).wait(1).to({y:9},0).wait(6).to({regX:86.7,regY:-223.2,x:86.7,y:-215.4},0).wait(1).to({y:-219.7},0).wait(1).to({y:-224},0).wait(1).to({regX:0,regY:0,x:0,y:-2},0).wait(1).to({regX:86.7,regY:-223.2,x:86.7,y:-223.7},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(2).to({regX:86.7,regY:-223.2,x:86.7,y:-229.9},0).wait(1).to({regX:0,regY:0,x:0,y:-8},0).wait(1).to({regX:86.7,regY:-223.2,x:86.7,y:-230.05},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({regX:86.7,regY:-223.2,x:86.7,y:-231.6},0).wait(1).to({regX:0,regY:0,x:0,y:-10},0).wait(1).to({regX:86.7,regY:-223.2,x:86.7,y:-232.4},0).wait(1).to({y:-229.65},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({y:1},0).wait(1).to({y:0},0).wait(1).to({x:1,y:4},1,cjs.Ease.get(1)).wait(1).to({regX:86.7,regY:-223.2,x:83.95,y:-215.45},0).wait(1).to({regX:0,regY:0,x:-4,y:9},0).to({x:0,y:13},4).wait(8).to({regX:86.7,regY:-223.2,x:86.7,y:-212.45},0).wait(1).to({y:-220.2},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({y:2},0).wait(1).to({regX:86.7,regY:-223.2,x:86.7,y:-224.2},0).wait(1).to({regX:0,regY:0,x:0,y:-2},0).wait(1).to({regX:86.7,regY:-223.2,x:86.7,y:-223.35},0).wait(1).to({regX:0,regY:0,x:0,y:2},0).wait(1).to({regX:86.7,regY:-223.2,x:86.7,y:-222.7},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(2).to({regX:86.7,regY:-223.2,x:86.7,y:-222.6},0).wait(1).to({y:-220.2},0).wait(1).to({y:-217.85},0).wait(1).to({regX:0,regY:0,x:0,y:6},0).wait(1).to({regX:86.7,regY:-223.2,x:86.7,y:-217.8},0).wait(1).to({y:-218.1},0).wait(1).to({regX:0,regY:0,x:0,y:5},0).wait(5).to({regX:86.7,regY:-223.2,x:86.7,y:-218.6},0).wait(1).to({y:-220.1},0).wait(1).to({y:-222.35},0).wait(1).to({y:-223.8},0).wait(1).to({regX:0,regY:0,x:0,y:-1},0).wait(1).to({regX:86.7,regY:-223.2,x:86.7,y:-223.45},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({y:5},0).wait(1).to({regX:86.7,regY:-223.2,x:86.7,y:-230.8},0).wait(1).to({regX:0,regY:0,x:0,y:-10},0).wait(1).to({regX:86.7,regY:-223.2,x:86.7,y:-232.4},0).wait(1).to({y:-229.65},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({y:1},0).wait(1).to({y:0},0).wait(9).to({regX:86.7,regY:-223.2,x:86.7,y:-230.7},0).wait(1).to({regX:0,regY:0,x:0,y:-10},0).wait(2).to({regX:86.7,regY:-223.2,x:86.7,y:-231.2},0).wait(1).to({y:-225.2},0).wait(1).to({regX:0,regY:0,x:0,y:8},0).to({y:5},2).wait(7).to({regX:86.7,regY:-223.2,x:86.7,y:-218.55},0).wait(1).to({y:-219.75},0).wait(1).to({y:-221.7},0).wait(1).to({y:-222.9},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({y:2},0).wait(1).to({y:-7},0).wait(1).to({regX:86.7,regY:-223.2,x:86.7,y:-228.15},0).wait(1).to({y:-222.25},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({y:-7},0).wait(1).to({regX:86.7,regY:-223.2,x:86.7,y:-228.15},0).wait(1).to({y:-222.25},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({regX:86.7,regY:-223.2,x:86.7,y:-222.3},0).wait(1).to({y:-222.95},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(2).to({regX:86.7,regY:-223.2,x:89.7,y:-219.8},0).wait(1).to({regX:0,regY:0,x:4,y:4.55},0).to({x:-2,y:8.8},2).wait(1).to({regX:86.7,regY:-223.2,x:85.85,y:-213.75},0).wait(1).to({x:86.5,y:-213.35},0).wait(1).to({regX:0,regY:0,x:0,y:10},0).wait(5).to({regX:86.7,regY:-223.2,x:86.7,y:-213.9},0).wait(1).to({y:-216.35},0).wait(1).to({y:-220.05},0).wait(1).to({y:-222.55},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(11).to({regX:86.7,regY:-223.2,x:86.7,y:-222.95},0).wait(1).to({y:-221.8},0).wait(1).to({y:-220.7},0).wait(1).to({regX:0,regY:0,x:0,y:2.8},0).wait(1).to({regX:86.7,regY:-223.2,x:86.7,y:-220.7},0).wait(1).to({y:-221.8},0).wait(1).to({y:-222.95},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-456.9,-778,1038.6,1049.3);
...
// stage content:
(lib._455_2 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{end0:14,scene1:15,end1:234,scene2:235,end2:415,scene3:416,end3:579,scene4:580,end4:733,scene5:734,end5:882,scene6:883,end6:1043,scene7:1044,end7:1241});
	...
	this.frame_616 = function() {
		exportRoot._g.m1 = this.m.t[exportRoot._g.idx][1];
		exportRoot._g.m2 = "たけど､";
		exportRoot._u.setText();
		exportRoot._u.setFace("ch1", 2);
	}
	this.frame_637 = function() {
		exportRoot._g.m2 = "たけど､雨足が強かったもの｡";
		exportRoot._u.setText();
		exportRoot._u.setFace("ch1", 1);
	}
	this.frame_666 = function() {
		exportRoot._g.m2 = this.m.t[exportRoot._g.idx][2];
		exportRoot._g.m3 = "の傘じゃ､";
		exportRoot._u.setText();
		exportRoot._u.setFace("ch1", 6);
	}
	...
	this.frame_734 = function() {
		exportRoot._g.m1 = "貴方と仕事帰りに寄り道なん";
		exportRoot._g.m2 = "て……";
		exportRoot._g.m3 = "";
		exportRoot._g.m4 = "";
		exportRoot._u.setText();
	...
	this.frame_1061 = function() {
		exportRoot._g.m1 = "ﾃﾞｰﾀ? 削除しないわよ? ";
		exportRoot._u.setText();
		exportRoot._u.setFace("ch2", 1);
	}
	this.frame_1089 = function() {
		exportRoot._g.m1 = this.m.t[exportRoot._g.idx][1];
		exportRoot._g.m2 = "私と貴方だけの秘密｡";
		exportRoot._u.setText();
		exportRoot._u.setFace("ch2", 6);
	}
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(14).call(this.frame_14).wait(1).call(this.frame_15).wait(14).call(this.frame_29).wait(19).call(this.frame_48).wait(53).call(this.frame_101).wait(18).call(this.frame_119).wait(20).call(this.frame_139).wait(44).call(this.frame_183).wait(20).call(this.frame_203).wait(31).call(this.frame_234).wait(1).call(this.frame_235).wait(24).call(this.frame_259).wait(31).call(this.frame_290).wait(28).call(this.frame_318).wait(39).call(this.frame_357).wait(19).call(this.frame_376).wait(14).call(this.frame_390).wait(2).call(this.frame_392).wait(23).call(this.frame_415).wait(1).call(this.frame_416).wait(18).call(this.frame_434).wait(32).call(this.frame_466).wait(34).call(this.frame_500).wait(22).call(this.frame_522).wait(2).call(this.frame_524).wait(31).call(this.frame_555).wait(24).call(this.frame_579).wait(1).call(this.frame_580).wait(13).call(this.frame_593).wait(23).call(this.frame_616).wait(21).call(this.frame_637).wait(29).call(this.frame_666).wait(18).call(this.frame_684).wait(29).call(this.frame_713).wait(20).call(this.frame_733).wait(1).call(this.frame_734).wait(55).call(this.frame_789).wait(18).call(this.frame_807).wait(30).call(this.frame_837).wait(18).call(this.frame_855).wait(27).call(this.frame_882).wait(1).call(this.frame_883).wait(14).call(this.frame_897).wait(23).call(this.frame_920).wait(27).call(this.frame_947).wait(25).call(this.frame_972).wait(27).call(this.frame_999).wait(17).call(this.frame_1016).wait(27).call(this.frame_1043).wait(1).call(this.frame_1044).wait(17).call(this.frame_1061).wait(28).call(this.frame_1089).wait(67).call(this.frame_1156).wait(34).call(this.frame_1190).wait(27).call(this.frame_1217).wait(24).call(this.frame_1241).wait(5));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1246));
	...
	this.timeline.addTween(cjs.Tween.get(this.sender).wait(1241).to({_off:false},0).wait(5));
	...
	this.timeline.addTween(cjs.Tween.get(this.loader).wait(1246));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(15).to({alpha:0.1992},3,cjs.Ease.get(1)).to({_off:true},1).wait(1227));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(12).to({_off:false},0).to({_off:true},3).wait(1231));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(15).to({alpha:0.1016},3).to({_off:true},1).wait(1227));
	...
	this.timeline.addTween(cjs.Tween.get(this.window_1).wait(15).to({y:301.1},0).wait(1).to({regX:132.8,regY:98.8,x:134.8,y:398.6},0).wait(1).to({y:394.65},0).wait(1).to({y:388},0).wait(1).to({y:378.75},0).wait(1).to({y:367.25},0).wait(1).to({y:354.25},0).wait(1).to({y:340.85},0).wait(1).to({y:328.45},0).wait(1).to({y:318.45},0).wait(1).to({y:312},0).wait(1).to({regX:0,regY:0,x:2,y:211},0).wait(1).to({regX:132.8,regY:98.8,x:134.8,y:310.3},0).wait(1).to({y:311.9},0).wait(1).to({regX:0,regY:0,x:2,y:214},0).wait(1147).to({regX:132.8,regY:98.8,x:134.8,y:313.9},0).wait(1).to({y:317.75},0).wait(1).to({y:325},0).wait(1).to({y:336.4},0).wait(1).to({y:351.7},0).wait(1).to({y:368.85},0).wait(1).to({y:384.15},0).wait(1).to({y:395.55},0).wait(1).to({y:402.8},0).wait(1).to({y:406.65},0).wait(1).to({regX:0,regY:0,x:2,y:309},0).to({_off:true},1).wait(59));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_8},{t:this.instance_7},{t:this.instance_6},{t:this.instance_5},{t:this.instance_4}]},1187).wait(59));
	...
	this.timeline.addTween(cjs.Tween.get(this.glitters).wait(1187).to({_off:false},0).wait(59));
	...
	this.timeline.addTween(cjs.Tween.get(this.ranko_finish_blur).wait(1187).to({_off:false},0).wait(1).to({regX:120,regY:155,x:120,y:155,alpha:0.8489},0).wait(1).to({alpha:0.8403},0).wait(1).to({alpha:0.8253},0).wait(1).to({alpha:0.8029},0).wait(1).to({alpha:0.7723},0).wait(1).to({alpha:0.7324},0).wait(1).to({alpha:0.6823},0).wait(1).to({alpha:0.6211},0).wait(1).to({alpha:0.5487},0).wait(1).to({alpha:0.4662},0).wait(1).to({alpha:0.3767},0).wait(1).to({alpha:0.2865},0).wait(1).to({alpha:0.2036},0).wait(1).to({alpha:0.1357},0).wait(1).to({alpha:0.0874},0).wait(1).to({alpha:0.0595},0).wait(1).to({regX:0,regY:0,x:0,y:0,alpha:0.0508},0).to({_off:true},1).wait(41));
	...
	this.timeline.addTween(cjs.Tween.get(this.fns).wait(1187).to({_off:false},0).wait(59));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(1175).to({_off:false},0).to({alpha:0.8984},11).to({_off:true},1).wait(59));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(580).to({_off:false},0).to({alpha:0},7).to({_off:true},1).wait(456).to({_off:false,alpha:1},0).to({alpha:0},7).to({_off:true},1).wait(194));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_12},{t:this.instance_11}]}).to({state:[]},15).wait(1231));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_13).wait(15).to({_off:false},0).wait(1).to({regX:1,x:121,y:-3.2},0).wait(1).to({y:-6.85},0).wait(1).to({y:-12.75},0).wait(1).to({y:-20.7},0).wait(1).to({y:-30.4},0).wait(1).to({y:-41.5},0).wait(1).to({y:-53.55},0).wait(1).to({y:-65.9},0).wait(1).to({y:-78.05},0).wait(1).to({y:-89.25},0).wait(1).to({y:-98.95},0).wait(1).to({y:-106.45},0).wait(1).to({y:-111.3},0).wait(1).to({regX:0,x:120,y:-113},0).wait(73).to({regX:1,x:121,y:-113.7},0).wait(1).to({y:-115.85},0).wait(1).to({y:-119.3},0).wait(1).to({y:-123.9},0).wait(1).to({y:-129.55},0).wait(1).to({y:-136.05},0).wait(1).to({y:-143.2},0).wait(1).to({y:-150.8},0).wait(1).to({y:-158.6},0).wait(1).to({y:-166.4},0).wait(1).to({y:-173.9},0).wait(1).to({y:-180.9},0).wait(1).to({y:-187.1},0).wait(1).to({y:-192.3},0).wait(1).to({y:-196.25},0).wait(1).to({y:-198.75},0).wait(1).to({regX:0,x:120,y:-199.65},0).to({_off:true},1).wait(1127));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_14).wait(15).to({_off:false},0).wait(1).to({regX:1,x:121,y:308.45},0).wait(1).to({y:309.8},0).wait(1).to({y:312.05},0).wait(1).to({y:315.05},0).wait(1).to({y:318.75},0).wait(1).to({y:322.95},0).wait(1).to({y:327.5},0).wait(1).to({y:332.15},0).wait(1).to({y:336.75},0).wait(1).to({y:341},0).wait(1).to({y:344.65},0).wait(1).to({y:347.5},0).wait(1).to({y:349.35},0).wait(1).to({regX:0,x:120,y:350},0).wait(73).to({regX:1,x:121,y:351.3},0).wait(1).to({y:355.2},0).wait(1).to({y:361.5},0).wait(1).to({y:369.9},0).wait(1).to({y:380.2},0).wait(1).to({y:392},0).wait(1).to({y:405.05},0).wait(1).to({y:418.9},0).wait(1).to({y:433.15},0).wait(1).to({y:447.35},0).wait(1).to({y:461.05},0).wait(1).to({y:473.8},0).wait(1).to({y:485.1},0).wait(1).to({y:494.6},0).wait(1).to({y:501.8},0).wait(1).to({y:506.4},0).wait(1).to({regX:0,x:120,y:508},0).to({_off:true},1).wait(1127));
	...
	this.timeline.addTween(cjs.Tween.get(this.lighter_tgt).wait(883).to({_off:false},0).to({alpha:1},36,cjs.Ease.quadInOut).wait(125).to({_off:true},1).wait(201));
	...
	this.timeline.addTween(cjs.Tween.get(this.lighter_tgt_1).wait(883).to({_off:false},0).to({alpha:0.4492},36,cjs.Ease.quadInOut).wait(125).to({_off:true},1).wait(201));
	...
	this.timeline.addTween(cjs.Tween.get(this.ch1).wait(15).to({regX:0.7,regY:0.5,scaleX:0.4152,scaleY:0.4152,x:43.15,y:257.45},0).to({x:73.7},65,cjs.Ease.quadInOut).wait(123).to({regX:1,regY:0.6,scaleX:0.3724,scaleY:0.3724,x:87,y:219.5},31,cjs.Ease.quadInOut).wait(55).to({regX:0.8,scaleX:0.4615,scaleY:0.4615,x:68.25,y:276.8},68,cjs.Ease.quadInOut).wait(109).to({regX:1,regY:0.7,scaleX:0.5682,scaleY:0.5682,x:59.9,y:313.55},58,cjs.Ease.quadInOut).wait(56).to({regX:0.9,scaleX:0.3799,scaleY:0.3799,x:99.75,y:260.75},0).wait(36).to({x:78.3,y:251.75},50,cjs.Ease.quadInOut).wait(68).to({alpha:0},17,cjs.Ease.quadOut).to({_off:true},1).wait(494));
	...
	this.timeline.addTween(cjs.Tween.get(this.bg1).wait(15).to({regX:-0.4,regY:-0.4,scaleX:0.4152,scaleY:0.4152,x:-118.55,y:-32.8},0).to({x:-88},65,cjs.Ease.quadInOut).wait(123).to({regY:-0.6,scaleX:0.3724,scaleY:0.3724,x:-58.05,y:-40.85},31,cjs.Ease.quadInOut).wait(55).to({regY:-0.5,scaleX:0.4615,scaleY:0.4615,x:-111.5,y:-45.95},68,cjs.Ease.quadInOut).wait(109).to({regX:-0.5,scaleX:0.5682,scaleY:0.5682,x:-161.45,y:-83.7},58,cjs.Ease.quadInOut).wait(56).to({regX:-0.4,regY:-0.6,scaleX:0.3799,scaleY:0.3799,x:-48.3,y:-5.05},0).wait(36).to({x:-69.75,y:-14.05},50,cjs.Ease.quadInOut).wait(68).to({alpha:0},17,cjs.Ease.quadOut).to({_off:true},1).wait(494));

	// ch2
	this.ch2 = new lib.character1_container();
	this.ch2.name = "ch2";
	this.ch2.parent = this;
	this.ch2.setTransform(78.3,251.75,0.3799,0.3799,0,0,0,0.9,0.7);
	this.ch2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.ch2).wait(719).to({_off:false},0).wait(15).to({regX:1,scaleX:0.5089,scaleY:0.5089,x:62.6,y:289.4},0).to({y:303.2},17,cjs.Ease.quadOut).wait(132).to({regX:1.1,scaleX:0.6323,scaleY:0.6323,x:52.7,y:344.75},36,cjs.Ease.quadInOut).wait(125).to({regX:0.3,regY:0.1,scaleX:0.3252,scaleY:0.3252,x:86,y:227.1},0).wait(127).to({_off:true},16).wait(59));

	// bg2
	this.bg1_1 = new lib.bg_zoom_half();
	this.bg1_1.name = "bg1_1";
	this.bg1_1.parent = this;
	this.bg1_1.setTransform(-69.75,-14.05,0.3799,0.3799,0,0,0,-0.4,-0.6);
	this.bg1_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.bg1_1).wait(719).to({_off:false},0).wait(15).to({regX:-0.5,scaleX:0.5089,scaleY:0.5089,x:-135.75,y:-66.6},0).to({y:-52.8},17,cjs.Ease.quadOut).wait(132).to({regX:-0.6,regY:-0.7,scaleX:0.6323,scaleY:0.6323,x:-193.8,y:-97.55},36,cjs.Ease.quadInOut).wait(125).to({regX:-0.1,regY:-0.1,scaleX:0.3252,scaleY:0.3252,x:-40.45,y:-0.05},0).wait(127).to({_off:true},16).wait(59));
	...
	this.timeline.addTween(cjs.Tween.get(this.toggle_btn).wait(1171).to({_off:true},4).wait(71));
	...
	this.timeline.addTween(cjs.Tween.get(this.stage_btn).wait(1171).to({_off:true},16).wait(54).to({_off:false},0).wait(5));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-282,-720,1486.6,1647.4);
// library properties:
lib.properties = {
	id: '_455_2',
	width: 240,
	...
	opacity: 1.00,
	manifest: [
		{src:"images/bg.jpg", id:"_455_2_bg"},
		{src:"images/ch_base.png", id:"_455_2_ch_base"},
		{src:"images/ch_face2.png", id:"_455_2_ch_face2"},
		{src:"images/ch_face3.png", id:"_455_2_ch_face3"},
		{src:"images/ch_face4.png", id:"_455_2_ch_face4"},
		{src:"images/ch_face5.png", id:"_455_2_ch_face5"},
		{src:"images/ch_face6.png", id:"_455_2_ch_face6"},
		{src:"images/ch_face7.png", id:"_455_2_ch_face7"},
		{src:"images/ch_face8.png", id:"_455_2_ch_face8"},
		{src:"images/ch_face9.png", id:"_455_2_ch_face9"},
		{src:"images/finish.jpg", id:"_455_2_finish"},
		{src:"images/finish_blur.jpg", id:"_455_2_finish_blur"},
		{src:"images/tie_fp.png", id:"_455_2_tie_fp"},
		{src:"images/tie_sp.png", id:"_455_2_tie_sp"}
	],
	preloads: []
};
