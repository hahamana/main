...
(lib.bg = function() {
	this.initialize(img._401_4_bg);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,1200,1136);


(lib.ch_base = function() {
	this.initialize(img._401_4_ch_base);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,1200,1136);


(lib.ch_face2 = function() {
	this.initialize(img._401_4_ch_face2);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,200,264);


(lib.ch_face3 = function() {
	this.initialize(img._401_4_ch_face3);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,200,264);


(lib.ch_face4 = function() {
	this.initialize(img._401_4_ch_face4);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,200,264);


(lib.ch_face5 = function() {
	this.initialize(img._401_4_ch_face5);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,200,264);


(lib.ch_face6 = function() {
	this.initialize(img._401_4_ch_face6);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,200,264);


(lib.finish = function() {
	this.initialize(img._401_4_finish);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,480,620);


(lib.finish_blur = function() {
	this.initialize(img._401_4_finish_blur);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,480,620);


(lib.tie_fp = function() {
	this.initialize(img._401_4_tie_fp);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,240,32);


(lib.tie_sp = function() {
	this.initialize(img._401_4_tie_sp);
}).prototype = p = new cjs.Bitmap();
...
}).prototype = getMCSymbolPrototype(lib.character1_face_eyeclose, new cjs.Rectangle(0,0,100,132), null);
...
}).prototype = getMCSymbolPrototype(lib.character1_base, new cjs.Rectangle(-120,-396,600,568), null);
...
p.nominalBounds = new cjs.Rectangle(0,0,600,568);
...
(lib.tie = function(mode,startPosition,loop) {
	...
	// txt
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#333333").s().p("");
	...
	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#333333").s().p("");
	this.shape_2.setTransform(-8,0.425);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#333333").s().p("");
	this.shape_3.setTransform(-24.025,0.4);
...
(lib.character1_face = function(mode,startPosition,loop) {
	...
	mask._off = true;
	mask.graphics.p("AgjB5Qg0gFgQgTQgOgPgCgEQgEgLgKgUIgOgpQgDgPAMgNQAKgMAhgMIAxgSQANgGA3ggQA1gbATAKQAXALAQAYQAQAZAAAbQAAAdglA0QglA3gdALQgWAIgeAAIgdgCg");
	mask.setTransform(61.944,71.7754);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(6).to({_off:false},0).to({_off:true},2).wait(12));

	// mask_face (mask)
	var mask_1 = new cjs.Shape();
	mask_1._off = true;
	mask_1.graphics.p("AnkKPIAA0TIPTAAIAAUTg");
	mask_1.setTransform(49.4893,65.5009);
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_3}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_5}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_7}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_7}]},1).to({state:[]},1).wait(12));

	// body
	this.b = new lib.character1_base();
	this.b.name = "b";
	this.b.parent = this;
	this.b.setTransform(-120,288);
...
p.nominalBounds = new cjs.Rectangle(1,1,98,130);
...
(lib.character1_face_container = function(mode,startPosition,loop) {
	...
	this.frame_0 = function() {
		...
		this.face_blink_ary = [1, 1, 0, 0, 1, 0, 1, 0, 1, 1, 1, 1, 1, 1, 1]; 
	...
	var mask = new cjs.Shape();
	mask._off = true;
	var mask_graphics_15 = new cjs.Graphics().p("");
	...
	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:null,x:0,y:0}).wait(15).to({graphics:mask_graphics_15,x:51.635,y:37.3172}).wait(6).to({graphics:mask_graphics_21,x:31.25,y:41.8}).wait(6));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(15).to({_off:false},0).wait(1).to({alpha:1},0).wait(1).to({regX:50,regY:66,x:50,y:66,alpha:0.3015},0).wait(1).to({alpha:0.0922},0).wait(1).to({regX:35,regY:30,x:35,y:30,alpha:0},0).wait(2).to({alpha:0.1992},0).wait(1).to({alpha:1},0).wait(1).to({regX:50,regY:66,x:50,y:66,alpha:0.3015},0).wait(1).to({alpha:0.0922},0).wait(1).to({regX:35,regY:30,x:35,y:30,alpha:0},0).wait(2));
	...
	this.timeline.addTween(cjs.Tween.get(this.f2).wait(5).to({alpha:0.1992},0).wait(1).to({regX:49.5,regY:65.5,x:49.5,y:65.5,alpha:0.6441},0).wait(1).to({alpha:0.911},0).wait(1).to({regX:35,regY:30,x:35,y:30,alpha:1},0).wait(19));
	...
	this.timeline.addTween(cjs.Tween.get(this.f1_alpha).wait(5).to({alpha:0.8008},0).wait(1).to({regX:49.5,regY:65.5,x:49.5,y:65.5,alpha:0.7118},0).wait(1).to({alpha:0.4449},0).wait(1).to({regX:35,regY:30,x:35,y:30,alpha:0},0).wait(19));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-240,-108,600,568);
...
(lib.character1_body = function(mode,startPosition,loop) {
	...
	this.b.name = "b";
	this.b.parent = this;
	this.b.setTransform(-232,-32);

	this.timeline.addTween(cjs.Tween.get(this.b).wait(2));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-352,-428,662.2,568);
...
(lib.character1_container = function(mode,startPosition,loop) {
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(7).call(this.frame_7).wait(1).call(this.frame_8).wait(7).call(this.frame_15).wait(1).call(this.frame_16).wait(8).call(this.frame_24).wait(1).call(this.frame_25).wait(11).call(this.frame_36).wait(1).call(this.frame_37).wait(9).call(this.frame_46).wait(1).call(this.frame_47).wait(9).call(this.frame_56).wait(1).call(this.frame_57).wait(8).call(this.frame_65).wait(1).call(this.frame_66).wait(14).call(this.frame_80).wait(1).call(this.frame_81).wait(10).call(this.frame_91).wait(1).call(this.frame_92).wait(19).call(this.frame_111).wait(1).call(this.frame_112).wait(8).call(this.frame_120).wait(1).call(this.frame_121).wait(10).call(this.frame_131).wait(1).call(this.frame_132).wait(13).call(this.frame_145).wait(1).call(this.frame_146).wait(13).call(this.frame_159).wait(1).call(this.frame_160).wait(20).call(this.frame_180).wait(1).call(this.frame_181).wait(19).call(this.frame_200).wait(1).call(this.frame_201).wait(27).call(this.frame_228).wait(1).call(this.frame_229).wait(11).call(this.frame_240).wait(1).call(this.frame_241).wait(10).call(this.frame_251).wait(1).call(this.frame_252).wait(15).call(this.frame_267).wait(1).call(this.frame_268).wait(26).call(this.frame_294).wait(1).call(this.frame_295).wait(17).call(this.frame_312).wait(1).call(this.frame_313).wait(11).call(this.frame_324).wait(1).call(this.frame_325).wait(17).call(this.frame_342).wait(1).call(this.frame_343).wait(6).call(this.frame_349).wait(1).call(this.frame_350).wait(18).call(this.frame_368).wait(1).call(this.frame_369).wait(14).call(this.frame_383).wait(1).call(this.frame_384).wait(16).call(this.frame_400).wait(1).call(this.frame_401).wait(8).call(this.frame_409).wait(1).call(this.frame_410).wait(8).call(this.frame_418).wait(8).call(this.frame_426).wait(1).call(this.frame_427).wait(14).call(this.frame_441).wait(1).call(this.frame_442).wait(7).call(this.frame_449).wait(1).call(this.frame_450).wait(6).call(this.frame_456).wait(1).call(this.frame_457).wait(6).call(this.frame_463).wait(6).call(this.frame_469).wait(1).call(this.frame_470).wait(11).call(this.frame_481).wait(1).call(this.frame_482).wait(13).call(this.frame_495).wait(1));

	// effect2
	this.instance = new lib.drop1_v2("synched",0);
	this.instance.parent = this;
	this.instance.setTransform(-110.95,-360.4,1.1645,1.1645);
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(313).to({_off:false},0).wait(1).to({regX:1.2,regY:1.8,rotation:-33.7496,x:-136.55,y:-369.4,alpha:0.4141},0).wait(1).to({regX:0,regY:0,rotation:-44.9995,x:-148.2,y:-373.7,alpha:0.2188},0).to({_off:true},1).wait(1).to({_off:false,rotation:0,x:-110.95,y:-360.4,alpha:1},0).wait(1).to({regX:1.2,regY:1.8,rotation:-33.7496,x:-136.55,y:-369.4,alpha:0.4141},0).wait(1).to({regX:0,regY:0,rotation:-44.9995,x:-148.2,y:-373.7,alpha:0.2188},0).to({_off:true},1).wait(5).to({_off:false,rotation:0,x:-110.95,y:-360.4,alpha:1},0).wait(1).to({regX:1.2,regY:1.8,rotation:-33.7496,x:-136.55,y:-369.4,alpha:0.4141},0).wait(1).to({regX:0,regY:0,rotation:-44.9995,x:-148.2,y:-373.7,alpha:0.2188},0).to({_off:true},1).wait(1).to({_off:false,rotation:0,x:-110.95,y:-360.4,alpha:1},0).wait(1).to({regX:1.2,regY:1.8,rotation:-33.7496,x:-136.55,y:-369.4,alpha:0.4141},0).wait(1).to({regX:0,regY:0,rotation:-44.9995,x:-148.2,y:-373.7,alpha:0.2188},0).to({_off:true},1).wait(164));

	// effect
	this.instance_1 = new lib.spread_flower_pink("synched",0,false);
	this.instance_1.parent = this;
	this.instance_1.setTransform(-56.8,-280.25,1.4808,1.4808);

	this.instance_2 = new lib.good_effect("synched",0,false);
	this.instance_2.parent = this;
	this.instance_2.setTransform(-56.8,-278.25,1.481,1.481);

	this.instance_3 = new lib.notice();
	this.instance_3.parent = this;
	this.instance_3.setTransform(-128.5,-356.3,1.187,1.187,0,-169.8305,10.1695,-29.1,20.4);
	this.instance_3._off = true;

	this.instance_4 = new lib.laugh("synched",0);
	this.instance_4.parent = this;
	this.instance_4.setTransform(-149.4,-351,1.4204,1.4204,35.8424,0,0,-30.3,20.6);
	this.instance_4._off = true;

	this.instance_5 = new lib.chord("synched",0,false);
	this.instance_5.parent = this;
	this.instance_5.setTransform(-121.6,-268.65,1.0029,1.0029,-61.4995,0,0,-23.4,76.9);

	this.instance_6 = new lib.question();
	this.instance_6.parent = this;
	this.instance_6.setTransform(-122.25,-353.25,1.053,1.053,-28.4906);
	this.instance_6.alpha = 0;
	this.instance_6._off = true;

	this.instance_7 = new lib.mc_exclamation("synched",0,false);
	this.instance_7.parent = this;
	this.instance_7.setTransform(-124.5,-367.95,1.0929,1.0929,-29.9996,0,0,0,0.1);

	this.instance_8 = new lib.drop1a("synched",0);
	this.instance_8.parent = this;
	this.instance_8.setTransform(-119,-349.35,1,1,0,0,0,-0.5,0.2);
	this.instance_8._off = true;

	this.instance_9 = new lib.drop2_v2("synched",0);
	this.instance_9.parent = this;
	this.instance_9.setTransform(-112.75,-350.65,0.9876,0.9876,14.9998);
	this.instance_9._off = true;

	this.instance_10 = new lib.shock("synched",0);
	this.instance_10.parent = this;
	this.instance_10.setTransform(-122.35,-354.3,1.3878,1.3878,-121.2396);

	this.instance_11 = new lib.sigh("synched",0);
	this.instance_11.parent = this;
	this.instance_11.setTransform(-99.85,-199.9);
	this.instance_11.alpha = 0.6016;
	this.instance_11._off = true;

	this.instance_12 = new lib.heart("synched",0);
	this.instance_12.parent = this;
	this.instance_12.setTransform(-121.65,-309.5,0.4532,0.4532);
	this.instance_12._off = true;

	this.instance_13 = new lib.concent_wrapper("synched",0,false);
	this.instance_13.parent = this;
	this.instance_13.setTransform(-57.05,-266.8,1,1,0,0,0,-0.5,-0.1);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_1}]},37).to({state:[{t:this.instance_2}]},10).to({state:[]},10).to({state:[{t:this.instance_3}]},76).to({state:[]},2).to({state:[{t:this.instance_3}]},1).to({state:[{t:this.instance_3}]},2).to({state:[{t:this.instance_3}]},1).to({state:[{t:this.instance_3}]},1).to({state:[{t:this.instance_3}]},1).to({state:[{t:this.instance_3}]},1).to({state:[{t:this.instance_3}]},1).to({state:[{t:this.instance_3}]},1).to({state:[]},1).to({state:[{t:this.instance_3}]},2).to({state:[]},2).to({state:[{t:this.instance_3}]},1).to({state:[{t:this.instance_3}]},2).to({state:[{t:this.instance_3}]},1).to({state:[{t:this.instance_3}]},1).to({state:[{t:this.instance_3}]},1).to({state:[{t:this.instance_3}]},1).to({state:[{t:this.instance_3}]},1).to({state:[{t:this.instance_3}]},1).to({state:[]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},15).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[]},1).to({state:[{t:this.instance_5}]},1).to({state:[]},20).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},2).to({state:[{t:this.instance_6}]},7).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[]},1).to({state:[{t:this.instance_6}]},6).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},2).to({state:[{t:this.instance_6}]},2).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[]},1).to({state:[{t:this.instance_7}]},5).to({state:[{t:this.instance_8}]},16).to({state:[{t:this.instance_8}]},1).to({state:[{t:this.instance_8}]},1).to({state:[{t:this.instance_8}]},1).to({state:[{t:this.instance_8}]},1).to({state:[{t:this.instance_8}]},1).to({state:[{t:this.instance_8}]},1).to({state:[{t:this.instance_8}]},1).to({state:[{t:this.instance_8}]},1).to({state:[{t:this.instance_8}]},9).to({state:[{t:this.instance_8}]},1).to({state:[{t:this.instance_8}]},1).to({state:[{t:this.instance_8}]},1).to({state:[]},1).to({state:[{t:this.instance_9}]},24).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[]},1).to({state:[{t:this.instance_9}]},5).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[]},1).to({state:[{t:this.instance_10}]},11).to({state:[]},1).to({state:[{t:this.instance_10}]},1).to({state:[]},1).to({state:[{t:this.instance_10}]},1).to({state:[]},1).to({state:[{t:this.instance_11}]},3).to({state:[{t:this.instance_11}]},1).to({state:[{t:this.instance_11}]},1).to({state:[{t:this.instance_11}]},1).to({state:[{t:this.instance_11}]},1).to({state:[{t:this.instance_11}]},1).to({state:[{t:this.instance_11}]},1).to({state:[{t:this.instance_11}]},1).to({state:[]},1).to({state:[{t:this.instance_12}]},11).to({state:[{t:this.instance_12}]},1).to({state:[{t:this.instance_12}]},1).to({state:[{t:this.instance_12}]},1).to({state:[{t:this.instance_12}]},1).to({state:[{t:this.instance_12}]},1).to({state:[{t:this.instance_12}]},2).to({state:[{t:this.instance_12}]},3).to({state:[{t:this.instance_12}]},1).to({state:[{t:this.instance_12}]},1).to({state:[]},1).to({state:[{t:this.instance_13}]},18).to({state:[]},9).wait(86));
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(133).to({_off:false},0).to({_off:true},2).wait(1).to({_off:false},0).wait(3).to({regX:-28.8,regY:20.5,x:-128.1,alpha:0.6944},0).wait(1).to({alpha:0.4444},0).wait(1).to({alpha:0.25},0).wait(1).to({alpha:0.1111},0).wait(1).to({alpha:0.0278},0).wait(1).to({regX:-29.1,regY:20.4,x:-128.5,alpha:0},0).to({_off:true},1).wait(2).to({_off:false,alpha:1},0).to({_off:true},2).wait(1).to({_off:false},0).wait(3).to({regX:-28.8,regY:20.5,x:-128.1,alpha:0.6944},0).wait(1).to({alpha:0.4444},0).wait(1).to({alpha:0.25},0).wait(1).to({alpha:0.1111},0).wait(1).to({alpha:0.0278},0).wait(1).to({regX:-29.1,regY:20.4,x:-128.5,alpha:0},0).to({_off:true},1).wait(337));
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(160).to({_off:false},0).wait(15).to({startPosition:0},0).wait(1).to({regX:-31.4,regY:22.1,scaleX:1.4203,scaleY:1.4203,x:-151.9,y:-350.15,alpha:0.5625,startPosition:1},0).wait(1).to({alpha:0.25,startPosition:2},0).wait(1).to({alpha:0.0625,startPosition:3},0).wait(1).to({regX:-30.3,regY:20.6,scaleX:1.4204,scaleY:1.4204,x:-149.4,y:-351,alpha:0,startPosition:19},0).to({_off:true},1).wait(316));
	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(202).to({_off:false},0).wait(1).to({regX:-0.2,regY:0.2,x:-129.2,y:-366.65,alpha:0.5556},0).wait(1).to({x:-133.3,y:-374.9,alpha:0.8889},0).wait(1).to({regX:0,regY:0,x:-134.6,y:-377.95,alpha:1},0).wait(1).to({regX:-0.2,regY:0.2,x:-134.35,y:-377},0).wait(1).to({x:-133.35,y:-375.15},0).wait(1).to({x:-131.65,y:-372},0).wait(1).to({regX:0,regY:0,x:-129.2,y:-367.95},0).to({x:-129.95,y:-369.3},2).wait(8).to({regX:-0.2,regY:0.2,x:-129.7,y:-368.4,alpha:0.9298},0).wait(1).to({x:-128.65,y:-366.45,alpha:0.692},0).wait(1).to({x:-127.05,y:-363.55,alpha:0.339},0).wait(1).to({x:-125.9,y:-361.4,alpha:0.0788},0).wait(1).to({regX:0,regY:0,x:-125.45,y:-361.1,alpha:0},0).to({_off:true},1).wait(6).to({_off:false,x:-122.7,y:-352.85},0).wait(1).to({regX:-0.2,regY:0.2,x:-129.65,y:-366.25,alpha:0.5556},0).wait(1).to({x:-133.75,y:-374.5,alpha:0.8889},0).wait(1).to({regX:0,regY:0,x:-135.05,y:-377.55,alpha:1},0).wait(1).to({regX:-0.2,regY:0.2,x:-134.8,y:-376.6},0).wait(1).to({x:-133.8,y:-374.75},0).wait(1).to({x:-132.1,y:-371.6},0).wait(1).to({regX:0,regY:0,x:-129.65,y:-367.55},0).to({x:-130.4,y:-368.9},2).wait(3).to({regX:-0.2,regY:0.2,x:-130.15,y:-368,alpha:0.9298},0).wait(1).to({x:-129.1,y:-366.05,alpha:0.692},0).wait(1).to({x:-127.5,y:-363.15,alpha:0.339},0).wait(1).to({x:-126.35,y:-361,alpha:0.0788},0).wait(1).to({regX:0,regY:0,x:-125.9,y:-360.7,alpha:0},0).to({_off:true},1).wait(249));
	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(268).to({_off:false},0).wait(1).to({regX:0.5,regY:-0.6,x:-118,y:-345.65},0).wait(1).to({y:-341.8},0).wait(1).to({y:-338.55},0).wait(1).to({y:-335.9},0).wait(1).to({y:-333.8},0).wait(1).to({y:-332.3},0).wait(1).to({y:-331.4},0).wait(1).to({regX:-0.5,regY:0.2,x:-119,y:-330.35},0).wait(9).to({startPosition:0},0).wait(1).to({regX:0.5,regY:-0.6,x:-118,y:-331.15,alpha:0.4444},0).wait(1).to({alpha:0.1111},0).wait(1).to({regX:-0.5,regY:0.2,x:-119,y:-330.35,alpha:0},0).to({_off:true},1).wait(207));
	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(313).to({_off:false},0).wait(1).to({scaleX:1.1203,scaleY:1.1203,rotation:-18.7494,x:-144.175,y:-346.0375,alpha:0.4141},0).wait(1).to({scaleX:1.1645,scaleY:1.1645,rotation:-29.9991,x:-154.65,y:-344.5,alpha:0.2188},0).to({_off:true},1).wait(1).to({_off:false,scaleX:0.9876,scaleY:0.9876,rotation:14.9998,x:-112.75,y:-350.65,alpha:1},0).wait(1).to({scaleX:1.1203,scaleY:1.1203,rotation:-18.7494,x:-144.175,y:-350.425,alpha:0.4141},0).wait(1).to({scaleX:1.1645,scaleY:1.1645,rotation:-29.9991,x:-154.65,y:-350.35,alpha:0.2188},0).to({_off:true},1).wait(5).to({_off:false,scaleX:0.9876,scaleY:0.9876,rotation:14.9998,x:-112.75,y:-350.65,alpha:1},0).wait(1).to({scaleX:1.1203,scaleY:1.1203,rotation:-18.7494,x:-144.175,y:-346.0375,alpha:0.4141},0).wait(1).to({scaleX:1.1645,scaleY:1.1645,rotation:-29.9991,x:-154.65,y:-344.5,alpha:0.2188},0).to({_off:true},1).wait(1).to({_off:false,scaleX:0.9876,scaleY:0.9876,rotation:14.9998,x:-112.75,y:-350.65,alpha:1},0).wait(1).to({scaleX:1.1203,scaleY:1.1203,rotation:-18.7494,x:-144.175,y:-350.425,alpha:0.4141},0).wait(1).to({scaleX:1.1645,scaleY:1.1645,rotation:-29.9991,x:-154.65,y:-350.35,alpha:0.2188},0).to({_off:true},1).wait(164));
	this.timeline.addTween(cjs.Tween.get(this.instance_11).wait(351).to({_off:false},0).wait(1).to({x:-100.85,y:-198.9,alpha:1},0).wait(1).to({regX:0.9,x:-100.95,y:-197.95,alpha:0.8965},0).wait(1).to({x:-102.3,y:-196.75,alpha:0.7636},0).wait(1).to({x:-103.9,y:-195.3,alpha:0.6048},0).wait(1).to({x:-105.7,y:-193.7,alpha:0.4229},0).wait(1).to({x:-107.7,y:-191.85,alpha:0.2205},0).wait(1).to({regX:0,x:-110.85,y:-189.9,alpha:0},0).to({_off:true},1).wait(137));
	this.timeline.addTween(cjs.Tween.get(this.instance_12).wait(370).to({_off:false},0).wait(1).to({regX:2.3,regY:1,scaleX:0.8633,scaleY:0.8633,x:-123.4,y:-323.65},0).wait(1).to({regX:0,regY:0,scaleX:1,scaleY:1,x:-126.65,y:-329.5},0).wait(1).to({regX:2.3,regY:1,scaleX:0.9896,scaleY:0.9896,x:-124.1,y:-327.35},0).wait(1).to({scaleX:0.9586,scaleY:0.9586,x:-123.55,y:-324.1},0).wait(1).to({regX:0,regY:0,scaleX:0.9068,scaleY:0.9068,x:-124.65,y:-319.5},0).to({scaleX:1,scaleY:1,x:-125.65,y:-323.5},2).wait(3).to({scaleX:1.1165,scaleY:1.1165},0).wait(1).to({regX:2.3,regY:1,scaleX:0.8111,scaleY:0.8111,x:-123.05,y:-322.5,alpha:0.3262},0).wait(1).to({regX:0,regY:0,scaleX:0.7092,scaleY:0.7092,x:-124.65,y:-323.25,alpha:0.1016},0).to({_off:true},1).wait(113));
	...
	this.timeline.addTween(cjs.Tween.get(this.c).wait(9).to({regX:-52,regY:-144,x:-52,y:-152.4},0).wait(1).to({regX:0,regY:0,x:0,y:-10},0).wait(1).to({regX:-52,regY:-144,x:-52,y:-153.2},0).wait(1).to({y:-150.45},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({y:1},0).wait(1).to({y:0},0).wait(1).to({y:2},0).wait(1).to({regX:-52,regY:-144,x:-52,y:-149.5},0).wait(1).to({regX:0,regY:0,x:0,y:-8},0).wait(1).to({regX:-52,regY:-144,x:-52,y:-149.75},0).wait(1).to({y:-142.8},0).wait(1).to({regX:0,regY:0,x:0,y:4},0).wait(1).to({regX:-52,regY:-144,x:-52,y:-140.75},0).wait(1).to({y:-143.15},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({y:2},0).wait(1).to({y:-7},0).wait(1).to({regX:-52,regY:-144,x:-52,y:-148.95},0).wait(1).to({y:-143.05},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({y:-7},0).wait(1).to({regX:-52,regY:-144,x:-52,y:-148.95},0).wait(1).to({y:-143.05},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({regX:-52,regY:-144,x:-52,y:-143.1},0).wait(1).to({y:-143.75},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({y:6},0).wait(1).to({regX:-52,regY:-144,x:-52,y:-153},0).wait(1).to({regX:0,regY:0,x:0,y:-14},0).wait(1).to({regX:-52,regY:-144,x:-52,y:-156.95},0).wait(1).to({y:-153.35},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({regX:-52,regY:-144,x:-52,y:-142},0).wait(1).to({regX:0,regY:0,x:0,y:-1},0).wait(1).to({regX:-52,regY:-144,x:-52,y:-144.25},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({y:6},0).wait(1).to({regX:-52,regY:-144,x:-52,y:-153},0).wait(1).to({regX:0,regY:0,x:0,y:-14},0).wait(1).to({regX:-52,regY:-144,x:-52,y:-156.95},0).wait(1).to({y:-153.35},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({regX:-52,regY:-144,x:-52,y:-142},0).wait(1).to({regX:0,regY:0,x:0,y:-1},0).wait(1).to({regX:-52,regY:-144,x:-52,y:-144.25},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(2).to({regX:-52,regY:-144,x:-52,y:-143.4},0).wait(1).to({y:-141},0).wait(1).to({y:-138.65},0).wait(1).to({regX:0,regY:0,x:0,y:6},0).wait(1).to({regX:-52,regY:-144,x:-52,y:-138.65},0).wait(1).to({y:-141},0).wait(1).to({y:-143.4},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(2).to({regX:-52,regY:-144,x:-52,y:-143.85},0).wait(1).to({y:-143.3},0).wait(1).to({y:-142.2},0).wait(1).to({y:-140.85},0).wait(1).to({y:-139.75},0).wait(1).to({y:-139.2},0).wait(1).to({regX:0,regY:0,x:0,y:5},0).wait(1).to({regX:-52,regY:-144,x:-52,y:-139.2},0).wait(1).to({y:-139.75},0).wait(1).to({y:-140.85},0).wait(1).to({y:-142.2},0).wait(1).to({y:-143.3},0).wait(1).to({y:-143.85},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({y:6},2).wait(1).to({regX:-52,regY:-144,x:-52,y:-139.25},0).wait(1).to({y:-142.8},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).to({y:6},2).wait(1).to({regX:-52,regY:-144,x:-52,y:-141.8},0).wait(1).to({y:-143.65},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(2).to({regX:-52,regY:-144,rotation:-0.0253,x:-52.05,y:-143.95},0).wait(1).to({rotation:-0.1129,x:-52.2,y:-143.55},0).wait(1).to({rotation:-0.2845,x:-52.35,y:-142.85},0).wait(1).to({rotation:-0.5565,x:-52.7,y:-141.75},0).wait(1).to({scaleX:0.9999,scaleY:0.9999,rotation:-0.898,x:-53.1,y:-140.3},0).wait(1).to({rotation:-1.2075,x:-53.5,y:-139},0).wait(1).to({rotation:-1.4141,x:-53.75,y:-138.1},0).wait(1).to({rotation:-1.5201,x:-53.85,y:-137.65},0).wait(1).to({regX:0,regY:0,rotation:-1.5505,x:2,y:5},0).wait(1).to({regX:-52,regY:-144,rotation:-1.5305,x:-53.85,y:-137.65},0).wait(1).to({rotation:-1.4624,x:-53.8,y:-137.9},0).wait(1).to({rotation:-1.3309,x:-53.65,y:-138.5},0).wait(1).to({rotation:-1.121,x:-53.4,y:-139.4},0).wait(1).to({rotation:-0.8372,x:-53.05,y:-140.55},0).wait(1).to({scaleX:1,scaleY:1,rotation:-0.534,x:-52.7,y:-141.85},0).wait(1).to({rotation:-0.2881,x:-52.4,y:-142.9},0).wait(1).to({rotation:-0.1291,x:-52.2,y:-143.6},0).wait(1).to({rotation:-0.0467,x:-52.1,y:-143.9},0).wait(1).to({regX:0,regY:0,rotation:-0.0227,x:0,y:0},0).wait(1).to({rotation:0},0).wait(1).to({regX:-52,regY:-144,rotation:-0.0253,x:-52.05,y:-143.95},0).wait(1).to({rotation:-0.1129,x:-52.2,y:-143.55},0).wait(1).to({rotation:-0.2845,x:-52.35,y:-142.85},0).wait(1).to({rotation:-0.5565,x:-52.7,y:-141.75},0).wait(1).to({scaleX:0.9999,scaleY:0.9999,rotation:-0.898,x:-53.1,y:-140.3},0).wait(1).to({rotation:-1.2075,x:-53.5,y:-139},0).wait(1).to({rotation:-1.4141,x:-53.75,y:-138.1},0).wait(1).to({rotation:-1.5201,x:-53.85,y:-137.65},0).wait(1).to({regX:0,regY:0,rotation:-1.5505,x:2,y:5},0).wait(1).to({regX:-52,regY:-144,rotation:-1.5302,x:-53.85,y:-137.65},0).wait(1).to({rotation:-1.461,x:-53.8,y:-137.9},0).wait(1).to({rotation:-1.3276,x:-53.65,y:-138.5},0).wait(1).to({rotation:-1.1146,x:-53.4,y:-139.4},0).wait(1).to({rotation:-0.8266,x:-53.05,y:-140.55},0).wait(1).to({scaleX:1,scaleY:1,rotation:-0.5189,x:-52.65,y:-141.9},0).wait(1).to({rotation:-0.2693,x:-52.4,y:-142.9},0).wait(1).to({rotation:-0.1079,x:-52.15,y:-143.6},0).wait(1).to({rotation:-0.0243,x:-52.05,y:-143.95},0).wait(1).to({regX:0,regY:0,rotation:0,x:0,y:0},0).wait(16).to({regX:-52,regY:-144,x:-52,y:-149.55},0).wait(1).to({y:-151.45},0).wait(1).to({regX:0,regY:0,x:0,y:-8},0).wait(1).to({regX:-52,regY:-144,x:-52,y:-151.35},0).wait(1).to({y:-149.25},0).wait(1).to({regX:0,regY:0,x:0,y:2},0).wait(1).to({y:1},0).wait(1).to({y:0},0).wait(7).to({regX:-52,regY:-144,x:-52,y:-152.4},0).wait(1).to({regX:0,regY:0,x:0,y:-10},0).wait(1).to({regX:-52,regY:-144,x:-52,y:-153.2},0).wait(1).to({y:-150.45},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({y:1},0).wait(1).to({y:0},0).wait(15).to({regX:-52,regY:-144,rotation:-0.0253,x:-52.05,y:-143.9},0).wait(1).to({rotation:-0.1129,x:-52.2,y:-143.25},0).wait(1).to({rotation:-0.2845,x:-52.35,y:-142.1},0).wait(1).to({rotation:-0.5565,x:-52.7,y:-140.3},0).wait(1).to({scaleX:0.9999,scaleY:0.9999,rotation:-0.898,x:-53.1,y:-137.95},0).wait(1).to({rotation:-1.2075,x:-53.5,y:-135.85},0).wait(1).to({rotation:-1.4141,x:-53.75,y:-134.45},0).wait(1).to({rotation:-1.5201,x:-53.85,y:-133.75},0).wait(1).to({regX:0,regY:0,rotation:-1.5505,x:2,y:9},0).wait(1).to({regX:-52,regY:-144,rotation:-1.5305,x:-53.85,y:-133.7},0).wait(1).to({rotation:-1.4624,x:-53.8,y:-134.15},0).wait(1).to({rotation:-1.3309,x:-53.65,y:-135.05},0).wait(1).to({rotation:-1.121,x:-53.4,y:-136.5},0).wait(1).to({rotation:-0.8372,x:-53.05,y:-138.45},0).wait(1).to({scaleX:1,scaleY:1,rotation:-0.534,x:-52.7,y:-140.5},0).wait(1).to({rotation:-0.2881,x:-52.4,y:-142.2},0).wait(1).to({rotation:-0.1291,x:-52.2,y:-143.3},0).wait(1).to({rotation:-0.0467,x:-52.1,y:-143.85},0).wait(1).to({regX:0,regY:0,rotation:-0.0227,x:0,y:0},0).wait(1).to({rotation:0},0).wait(1).to({regX:-52,regY:-144,rotation:-0.147,x:-52.2,y:-143.4},0).wait(1).to({rotation:-0.7239,x:-52.9,y:-141.05},0).wait(1).to({scaleX:0.9999,scaleY:0.9999,rotation:-1.3727,x:-53.7,y:-138.3},0).wait(1).to({regX:0,regY:0,rotation:-1.5505,x:2,y:5},0).wait(18).to({regX:-52,regY:-144,rotation:-1.4913,x:-53.85,y:-137.8},0).wait(1).to({rotation:-1.2701,x:-53.6,y:-138.75},0).wait(1).to({rotation:-0.8372,x:-53.05,y:-140.55},0).wait(1).to({scaleX:1,scaleY:1,rotation:-0.3606,x:-52.5,y:-142.55},0).wait(1).to({rotation:-0.094,x:-52.2,y:-143.7},0).wait(1).to({regX:0,regY:0,rotation:-0.0227,x:0,y:0},0).wait(1).to({rotation:0},0).wait(1).to({regX:-52,regY:-144,rotation:-0.0894,x:-52.1,y:-143.65},0).wait(1).to({rotation:-0.4358,x:-52.55,y:-142.2},0).wait(1).to({scaleX:0.9999,scaleY:0.9999,rotation:-1.0316,x:-53.3,y:-139.7},0).wait(1).to({rotation:-1.4426,x:-53.75,y:-138},0).wait(1).to({regX:0,regY:0,rotation:-1.5505,x:2,y:5},0).wait(8).to({regX:-52,regY:-144,rotation:-1.4913,x:-53.85,y:-137.8},0).wait(1).to({rotation:-1.2701,x:-53.6,y:-138.75},0).wait(1).to({rotation:-0.8372,x:-53.05,y:-140.55},0).wait(1).to({scaleX:1,scaleY:1,rotation:-0.3606,x:-52.5,y:-142.55},0).wait(1).to({rotation:-0.094,x:-52.2,y:-143.7},0).wait(1).to({regX:0,regY:0,rotation:-0.0227,x:0,y:0},0).wait(5).to({rotation:0},0).wait(1).to({regX:-52,regY:-144,x:-52,y:-152.4},0).wait(1).to({regX:0,regY:0,x:0,y:-10},0).wait(1).to({regX:-52,regY:-144,x:-52,y:-153.2},0).wait(1).to({y:-150.45},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({y:1},0).wait(1).to({y:0},0).wait(9).to({x:1,y:4},1,cjs.Ease.get(1)).wait(1).to({regX:-52,regY:-144,x:-54.75,y:-136.25},0).wait(1).to({regX:0,regY:0,x:-4,y:9},0).to({x:0,y:13},4).wait(11).to({regX:-52,regY:-144,x:-52,y:-131.75},0).wait(1).to({y:-134.7},0).wait(1).to({y:-139.65},0).wait(1).to({y:-143.1},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(5).to({y:-1},0).wait(1).to({regX:-52,regY:-144,x:-52,y:-143},0).wait(1).to({y:-137.05},0).wait(1).to({regX:0,regY:0,x:0,y:9},0).to({y:8},2).wait(1).to({y:9},0).wait(6).to({regX:-52,regY:-144,x:-52,y:-136.2},0).wait(1).to({y:-140.5},0).wait(1).to({y:-144.8},0).wait(1).to({regX:0,regY:0,x:0,y:-2},0).wait(1).to({regX:-52,regY:-144,x:-52,y:-144.5},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(2).to({regX:-52,regY:-144,x:-52,y:-150.7},0).wait(1).to({regX:0,regY:0,x:0,y:-8},0).wait(1).to({regX:-52,regY:-144,x:-52,y:-150.85},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({regX:-52,regY:-144,x:-52,y:-152.4},0).wait(1).to({regX:0,regY:0,x:0,y:-10},0).wait(1).to({regX:-52,regY:-144,x:-52,y:-153.2},0).wait(1).to({y:-150.45},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({y:1},0).wait(1).to({y:0},0).wait(1).to({x:1,y:4},1,cjs.Ease.get(1)).wait(1).to({regX:-52,regY:-144,x:-54.75,y:-136.25},0).wait(1).to({regX:0,regY:0,x:-4,y:9},0).to({x:0,y:13},4).wait(8).to({regX:-52,regY:-144,x:-52,y:-133.25},0).wait(1).to({y:-141},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({y:2},0).wait(1).to({regX:-52,regY:-144,x:-52,y:-145},0).wait(1).to({regX:0,regY:0,x:0,y:-2},0).wait(1).to({regX:-52,regY:-144,x:-52,y:-144.15},0).wait(1).to({regX:0,regY:0,x:0,y:2},0).wait(1).to({regX:-52,regY:-144,x:-52,y:-143.5},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(2).to({regX:-52,regY:-144,x:-52,y:-143.4},0).wait(1).to({y:-141},0).wait(1).to({y:-138.65},0).wait(1).to({regX:0,regY:0,x:0,y:6},0).wait(1).to({regX:-52,regY:-144,x:-52,y:-138.6},0).wait(1).to({y:-138.9},0).wait(1).to({regX:0,regY:0,x:0,y:5},0).wait(5).to({regX:-52,regY:-144,x:-52,y:-139.4},0).wait(1).to({y:-140.9},0).wait(1).to({y:-143.15},0).wait(1).to({y:-144.6},0).wait(1).to({regX:0,regY:0,x:0,y:-1},0).wait(1).to({regX:-52,regY:-144,x:-52,y:-144.25},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({y:5},0).wait(1).to({regX:-52,regY:-144,x:-52,y:-151.6},0).wait(1).to({regX:0,regY:0,x:0,y:-10},0).wait(1).to({regX:-52,regY:-144,x:-52,y:-153.2},0).wait(1).to({y:-150.45},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({y:1},0).wait(1).to({y:0},0).wait(9).to({regX:-52,regY:-144,x:-49,y:-140.6},0).wait(1).to({regX:0,regY:0,x:4,y:4.55},0).to({x:-2,y:8.8},2).wait(1).to({regX:-52,regY:-144,x:-52.85,y:-134.55},0).wait(1).to({x:-52.2,y:-134.15},0).wait(1).to({regX:0,regY:0,x:0,y:10},0).wait(5).to({regX:-52,regY:-144,x:-52,y:-134.7},0).wait(1).to({y:-137.15},0).wait(1).to({y:-140.85},0).wait(1).to({y:-143.35},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(11).to({regX:-52,regY:-144,x:-52,y:-143.95},0).wait(1).to({y:-143.65},0).wait(1).to({y:-143.1},0).wait(1).to({y:-142.25},0).wait(1).to({y:-141.1},0).wait(1).to({y:-139.85},0).wait(1).to({y:-138.8},0).wait(1).to({regX:0,regY:0,x:0,y:6},0).wait(1).to({regX:-52,regY:-144,x:-52,y:-138.15},0).wait(1).to({y:-138.65},0).wait(1).to({y:-139.65},0).wait(1).to({y:-141},0).wait(1).to({y:-142.4},0).wait(1).to({y:-143.4},0).wait(1).to({y:-143.9},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(2).to({x:1.3},0).wait(1).to({x:-1.3},0).wait(1).to({x:1.3},0).wait(1).to({x:-1.3},0).wait(1).to({x:1.3},0).wait(1).to({x:-1.3},0).wait(1).to({x:0.65},0).wait(1).to({x:-0.65},0).wait(1).to({x:0.65},0).wait(1).to({x:-0.65},0).wait(1).to({x:0.65},0).wait(1).to({x:-0.65},0).wait(1).to({x:0},0).wait(2).to({scaleX:0.9999,scaleY:0.9999,rotation:-1.5505,x:2,y:5},0).wait(1).to({regX:-52,regY:-144,rotation:-1.5074,x:-53.9,y:-137.75},0).wait(1).to({rotation:-1.3512,x:-53.7,y:-138.35},0).wait(1).to({rotation:-1.0387,x:-53.3,y:-139.7},0).wait(1).to({scaleX:1,scaleY:1,rotation:-0.6037,x:-52.75,y:-141.55},0).wait(1).to({rotation:-0.2408,x:-52.3,y:-143.05},0).wait(1).to({rotation:-0.0518,x:-52.1,y:-143.8},0).wait(1).to({regX:0,regY:0,rotation:0,x:0,y:0},0).wait(2).to({regX:-52,regY:-144,x:-52,y:-146.5},0).wait(1).to({regX:0,regY:0,x:0,y:-3.4},0).wait(1).to({regX:-52,regY:-144,x:-52,y:-146.45},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({y:1},0).wait(1).to({y:0},0).wait(2).to({regX:-52,regY:-144,x:-52,y:-143.85},0).wait(1).to({y:-143.3},0).wait(1).to({y:-142.25},0).wait(1).to({y:-140.65},0).wait(1).to({y:-139.1},0).wait(1).to({regX:0,regY:0,x:0,y:6},0).wait(1).to({regX:-52,regY:-144,x:-52,y:-138.3},0).wait(1).to({y:-139.25},0).wait(1).to({y:-141},0).wait(1).to({y:-142.8},0).wait(1).to({y:-143.75},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(2).to({regX:-52,regY:-144,rotation:-0.2845,x:-52.55,y:-143.3},0).wait(1).to({rotation:-1.4005,x:-54.6,y:-140.4},0).wait(1).to({scaleX:0.9999,scaleY:0.9999,rotation:-2.6557,x:-56.85,y:-137.05},0).wait(1).to({regX:0,regY:0,rotation:-2.9996,x:1.95,y:4.95},0).wait(1).to({regX:-52,regY:-144,rotation:-2.9169,x:-57.45,y:-136.35},0).wait(1).to({rotation:-2.6171,x:-56.85,y:-137.2},0).wait(1).to({rotation:-2.0171,x:-55.75,y:-138.8},0).wait(1).to({rotation:-1.1819,x:-54.25,y:-141.05},0).wait(1).to({scaleX:1,scaleY:1,rotation:-0.4851,x:-52.95,y:-142.85},0).wait(1).to({rotation:-0.1222,x:-52.3,y:-143.8},0).wait(1).to({regX:0,regY:0,rotation:-0.0227,x:0,y:0},0).wait(1).to({rotation:0},0).to({x:1,y:4},1,cjs.Ease.get(1)).wait(1).to({regX:-52,regY:-144,x:-54.75,y:-136.25},0).wait(1).to({regX:0,regY:0,x:-4,y:9},0).to({x:0,y:13},4).wait(2).to({regX:-52,regY:-144,x:-52,y:-131.75},0).wait(1).to({y:-134.7},0).wait(1).to({y:-139.65},0).wait(1).to({y:-143.1},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-462.9,-680.4,819.5,843.5999999999999);
...
// stage content:
(lib._401_4 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{end0:14,scene1:15,end1:195,scene2:196,end2:329,scene3:330,end3:479,scene4:480,end4:640,scene5:641,end5:805,scene6:806,end6:977,scene7:978,end7:1151});
	...
	this.frame_15 = function() {
		...
		this.ch1.gotoAndPlay("pop");
	}
	this.frame_24 = function() {
		this.ch1.gotoAndPlay("down3");
	}
	this.frame_40 = function() {
		exportRoot._g.m1 = "うっうっ……えぐっ……";
		exportRoot._u.setText();
	...
	this.frame_55 = function() {
		...
		exportRoot._g.m2 = "びーっ!";
		exportRoot._u.setText();
		
		exportRoot._u.setFace("ch1", 3);
		
		//exportRoot.ch1.gotoAndPlay();
	}
	this.frame_84 = function() {
		exportRoot._g.m2 = "びーっ! よかった……";
		exportRoot._u.setText();
	...
	this.frame_115 = function() {
		//exportRoot.ch1.gotoAndPlay("nod_off2");
	}
	...
	this.frame_151 = function() {
		...
		//exportRoot.ch1.gotoAndPlay("happy");
		
		exportRoot.ch1.gotoAndPlay("nod2");
	}
	...
	this.frame_273 = function() {
		...
		exportRoot.ch1.gotoAndPlay("swing_on");
	}
	this.frame_285 = function() {
		exportRoot.ch1.gotoAndPlay("swing_off");
	}
	...
	this.frame_366 = function() {
		...
		//exportRoot.ch1.gotoAndPlay("swing_off2");
	}
	this.frame_377 = function() {
		exportRoot._g.m2 = "推しの輝きは永遠!";
		exportRoot._u.setText();
	...
	this.frame_506 = function() {
		exportRoot._g.m1 = this.m.t[exportRoot._g.idx][1];
		exportRoot._g.m2 = "つらいよ｡";
		exportRoot._u.setText();
		
		exportRoot._u.setFace("ch1", 1);
		
		//exportRoot.ch1.gotoAndPlay("nod_on");
	}
	this.frame_517 = function() {
		//exportRoot.ch1.gotoAndPlay("nod_off");
	}
	this.frame_540 = function() {
		exportRoot._g.m2 = this.m.t[exportRoot._g.idx][2];
		exportRoot._g.m3 = "やれないから､";
		exportRoot._u.setText();
	...
	this.frame_685 = function() {
		exportRoot._g.m1 = this.m.t[exportRoot._g.idx][1];
		exportRoot._g.m2 = "に幸あれ!";
		exportRoot._u.setText();
		
		exportRoot._u.setFace("ch2", 1);
		
		exportRoot.ch2.gotoAndPlay("jump_flower");
	}
	this.frame_716 = function() {
		exportRoot._g.m2 = "に幸あれ! ぼくは";
		exportRoot._u.setText();
	...
	this.frame_791 = function() {
		...
		exportRoot.ch2.gotoAndPlay("jump_flower2");
	}
	...
	this.frame_1120 = function() {
		...
		exportRoot._g.m4 = "これからもｽﾞｯ推しだって!!";
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(14).call(this.frame_14).wait(1).call(this.frame_15).wait(9).call(this.frame_24).wait(16).call(this.frame_40).wait(9).call(this.frame_49).wait(6).call(this.frame_55).wait(29).call(this.frame_84).wait(16).call(this.frame_100).wait(15).call(this.frame_115).wait(18).call(this.frame_133).wait(18).call(this.frame_151).wait(17).call(this.frame_168).wait(27).call(this.frame_195).wait(1).call(this.frame_196).wait(28).call(this.frame_224).wait(14).call(this.frame_238).wait(35).call(this.frame_273).wait(12).call(this.frame_285).wait(24).call(this.frame_309).wait(20).call(this.frame_329).wait(1).call(this.frame_330).wait(36).call(this.frame_366).wait(11).call(this.frame_377).wait(35).call(this.frame_412).wait(19).call(this.frame_431).wait(26).call(this.frame_457).wait(7).call(this.frame_464).wait(15).call(this.frame_479).wait(1).call(this.frame_480).wait(26).call(this.frame_506).wait(11).call(this.frame_517).wait(23).call(this.frame_540).wait(35).call(this.frame_575).wait(17).call(this.frame_592).wait(23).call(this.frame_615).wait(12).call(this.frame_627).wait(13).call(this.frame_640).wait(1).call(this.frame_641).wait(15).call(this.frame_656).wait(7).call(this.frame_663).wait(22).call(this.frame_685).wait(31).call(this.frame_716).wait(13).call(this.frame_729).wait(41).call(this.frame_770).wait(21).call(this.frame_791).wait(14).call(this.frame_805).wait(1).call(this.frame_806).wait(19).call(this.frame_825).wait(16).call(this.frame_841).wait(18).call(this.frame_859).wait(47).call(this.frame_906).wait(16).call(this.frame_922).wait(28).call(this.frame_950).wait(15).call(this.frame_965).wait(12).call(this.frame_977).wait(1).call(this.frame_978).wait(18).call(this.frame_996).wait(22).call(this.frame_1018).wait(13).call(this.frame_1031).wait(28).call(this.frame_1059).wait(28).call(this.frame_1087).wait(33).call(this.frame_1120).wait(31).call(this.frame_1151).wait(5));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1156));
	...
	this.timeline.addTween(cjs.Tween.get(this.sender).wait(1151).to({_off:false},0).wait(5));
	...
	this.timeline.addTween(cjs.Tween.get(this.loader).wait(1156));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(15).to({alpha:0.1992},3,cjs.Ease.get(1)).to({_off:true},1).wait(1137));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(12).to({_off:false},0).to({_off:true},3).wait(1141));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(2).to({alpha:0.1016},3).to({_off:true},1).wait(1150));
	...
	this.timeline.addTween(cjs.Tween.get(this.window_1).wait(15).to({y:301.1},0).wait(1).to({regX:132.8,regY:98.8,x:134.8,y:398.6},0).wait(1).to({y:394.65},0).wait(1).to({y:388},0).wait(1).to({y:378.75},0).wait(1).to({y:367.25},0).wait(1).to({y:354.25},0).wait(1).to({y:340.85},0).wait(1).to({y:328.45},0).wait(1).to({y:318.45},0).wait(1).to({y:312},0).wait(1).to({regX:0,regY:0,x:2,y:211},0).wait(1).to({regX:132.8,regY:98.8,x:134.8,y:310.3},0).wait(1).to({y:311.9},0).wait(1).to({regX:0,regY:0,x:2,y:214},0).wait(1080).to({regX:132.8,regY:98.8,x:134.8,y:313.9},0).wait(1).to({y:317.75},0).wait(1).to({y:325},0).wait(1).to({y:336.4},0).wait(1).to({y:351.7},0).wait(1).to({y:368.85},0).wait(1).to({y:384.15},0).wait(1).to({y:395.55},0).wait(1).to({y:402.8},0).wait(1).to({y:406.65},0).wait(1).to({regX:0,regY:0,x:2,y:309},0).to({_off:true},1).wait(36));
	...
	this.timeline.addTween(cjs.Tween.get(this.window_2).wait(1120).to({_off:false},0).wait(1).to({regX:3.5,regY:59.1,x:123.5,y:380.6},0).wait(1).to({y:378.9},0).wait(1).to({y:375.6},0).wait(1).to({y:370.25},0).wait(1).to({y:362.8},0).wait(1).to({y:354.45},0).wait(1).to({y:347.5},0).wait(1).to({y:342.95},0).wait(1).to({y:340.65},0).wait(1).to({regX:0,regY:0,x:120,y:280.9},0).to({y:282.9},3).wait(23));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_8},{t:this.instance_7},{t:this.instance_6},{t:this.instance_5},{t:this.instance_4}]},1120).wait(36));
	...
	this.timeline.addTween(cjs.Tween.get(this.glitters).wait(1120).to({_off:false},0).wait(36));
	...
	this.timeline.addTween(cjs.Tween.get(this.fns).wait(1120).to({_off:false},0).wait(36));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(1108).to({_off:false},0).to({alpha:0.8984},11).to({_off:true},1).wait(36));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(15).to({_off:false},0).to({alpha:0},3).to({_off:true},1).wait(1137));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_12},{t:this.instance_11}]}).to({state:[]},15).wait(1141));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_13).wait(15).to({_off:false},0).wait(483).to({regX:0,scaleX:1.1997,scaleY:1.1997,rotation:-4.2598,x:145.75,y:-12.2},129).wait(529));
	...
	this.timeline.addTween(cjs.Tween.get(this.ch1).wait(15).to({scaleX:0.8719,scaleY:0.8719,x:158.85,y:348.65},0).wait(40).to({regX:0.1,regY:0.1,scaleX:0.8718,scaleY:0.8718,rotation:2.2871,x:158.9,y:346.75},5,cjs.Ease.cubicInOut).wait(1).to({x:159.9},0).wait(1).to({x:157.9},0).wait(1).to({x:159.9},0).wait(1).to({x:157.9},0).wait(1).to({x:159.9},0).wait(1).to({x:157.9},0).wait(1).to({x:159.9},0).wait(1).to({x:158.9},0).wait(2).to({regX:0,regY:0,rotation:2.262,x:158.8,y:346.65},0).to({scaleX:0.8719,scaleY:0.8719,rotation:0,x:158.85,y:348.65},5,cjs.Ease.cubicInOut).wait(121).to({regX:0.1,regY:0.1,scaleX:1.0255,scaleY:1.0255,x:166.35,y:393.85},28,cjs.Ease.cubicInOut).wait(154).to({regX:-55.2,regY:-252.9,scaleX:1.025,scaleY:1.025,x:109.6,y:134.35},0).wait(1).to({scaleX:1.0232,scaleY:1.0232,x:109.65,y:134.2},0).wait(1).to({scaleX:1.0203,scaleY:1.0203,x:109.7,y:134.05},0).wait(1).to({scaleX:1.016,scaleY:1.016,y:133.8},0).wait(1).to({scaleX:1.0102,scaleY:1.0102,x:109.85,y:133.45},0).wait(1).to({scaleX:1.0029,scaleY:1.0029,x:109.9,y:133.05},0).wait(1).to({scaleX:0.994,scaleY:0.994,x:110.05,y:132.55},0).wait(1).to({scaleX:0.9832,scaleY:0.9832,x:110.15,y:131.95},0).wait(1).to({scaleX:0.9707,scaleY:0.9707,x:110.3,y:131.2},0).wait(1).to({scaleX:0.9562,scaleY:0.9562,x:110.5,y:130.35},0).wait(1).to({scaleX:0.9397,scaleY:0.9397,x:110.75,y:129.4},0).wait(1).to({scaleX:0.9213,scaleY:0.9213,x:110.95,y:128.35},0).wait(1).to({scaleX:0.9011,scaleY:0.9011,x:111.2,y:127.15},0).wait(1).to({scaleX:0.8793,scaleY:0.8793,x:111.5,y:125.9},0).wait(1).to({scaleX:0.8562,scaleY:0.8562,x:111.8,y:124.55},0).wait(1).to({scaleX:0.8324,scaleY:0.8324,x:112.1,y:123.2},0).wait(1).to({scaleX:0.8084,scaleY:0.8084,x:112.35,y:121.8},0).wait(1).to({scaleX:0.7849,scaleY:0.7849,x:112.65,y:120.45},0).wait(1).to({scaleX:0.7625,scaleY:0.7625,x:113,y:119.15},0).wait(1).to({scaleX:0.7418,scaleY:0.7418,x:113.25,y:117.95},0).wait(1).to({scaleX:0.7231,scaleY:0.7231,x:113.5,y:116.9},0).wait(1).to({scaleX:0.7067,scaleY:0.7067,x:113.7,y:115.9},0).wait(1).to({scaleX:0.6928,scaleY:0.6928,x:113.85,y:115.1},0).wait(1).to({scaleX:0.6813,scaleY:0.6813,x:114.05,y:114.45},0).wait(1).to({scaleX:0.6722,scaleY:0.6722,x:114.15,y:113.9},0).wait(1).to({scaleX:0.6654,scaleY:0.6654,x:114.2,y:113.5},0).wait(1).to({scaleX:0.6608,scaleY:0.6608,x:114.3,y:113.25},0).wait(1).to({scaleX:0.6581,scaleY:0.6581,x:114.35,y:113.1},0).wait(1).to({regX:0,regY:0,scaleX:0.6572,scaleY:0.6572,x:150.7,y:279.3},0).wait(235).to({regX:0.3,regY:0.1,scaleX:0.6573,x:150.9,y:279.35},0).to({alpha:0},15,cjs.Ease.quartOut).to({_off:true},1).wait(499));

	// bg
	this.bg1 = new lib.bg_zoom_half();
	this.bg1.name = "bg1";
	this.bg1.parent = this;
	this.bg1.setTransform(-55.5,-0.95,1.0445,1.0445);

	this.timeline.addTween(cjs.Tween.get(this.bg1).wait(15).to({scaleX:0.8719,scaleY:0.8719,x:-148.05,y:-24.45},0).wait(181).to({regX:-0.1,regY:-0.1,scaleX:1.0255,scaleY:1.0255,x:-194.65,y:-45.1},28,cjs.Ease.cubicInOut).wait(154).to({regX:300,regY:284,scaleX:1.025,scaleY:1.025,x:113.15,y:246.2},0).wait(1).to({scaleX:1.0232,scaleY:1.0232,y:245.9},0).wait(1).to({scaleX:1.0203,scaleY:1.0203,x:113.2,y:245.4},0).wait(1).to({scaleX:1.016,scaleY:1.016,x:113.25,y:244.7},0).wait(1).to({scaleX:1.0102,scaleY:1.0102,y:243.7},0).wait(1).to({scaleX:1.0029,scaleY:1.0029,x:113.35,y:242.5},0).wait(1).to({scaleX:0.994,scaleY:0.994,x:113.45,y:241},0).wait(1).to({scaleX:0.9832,scaleY:0.9832,x:113.55,y:239.25},0).wait(1).to({scaleX:0.9707,scaleY:0.9707,x:113.7,y:237.1},0).wait(1).to({scaleX:0.9562,scaleY:0.9562,x:113.85,y:234.7},0).wait(1).to({scaleX:0.9397,scaleY:0.9397,x:114,y:231.95},0).wait(1).to({scaleX:0.9213,scaleY:0.9213,x:114.2,y:228.9},0).wait(1).to({scaleX:0.9011,scaleY:0.9011,x:114.45,y:225.5},0).wait(1).to({scaleX:0.8793,scaleY:0.8793,x:114.65,y:221.85},0).wait(1).to({scaleX:0.8562,scaleY:0.8562,x:114.85,y:218},0).wait(1).to({scaleX:0.8324,scaleY:0.8324,x:115.1,y:214.05},0).wait(1).to({scaleX:0.8084,scaleY:0.8084,x:115.4,y:210.1},0).wait(1).to({scaleX:0.7849,scaleY:0.7849,x:115.65,y:206.15},0).wait(1).to({scaleX:0.7625,scaleY:0.7625,x:115.85,y:202.4},0).wait(1).to({scaleX:0.7418,scaleY:0.7418,x:116.1,y:198.95},0).wait(1).to({scaleX:0.7231,scaleY:0.7231,x:116.3,y:195.85},0).wait(1).to({scaleX:0.7067,scaleY:0.7067,x:116.4,y:193.1},0).wait(1).to({scaleX:0.6928,scaleY:0.6928,x:116.6,y:190.8},0).wait(1).to({scaleX:0.6813,scaleY:0.6813,x:116.7,y:188.9},0).wait(1).to({scaleX:0.6722,scaleY:0.6722,x:116.75,y:187.35},0).wait(1).to({scaleX:0.6654,scaleY:0.6654,x:116.9,y:186.25},0).wait(1).to({scaleX:0.6608,scaleY:0.6608,x:116.95,y:185.45},0).wait(1).to({scaleX:0.6581,scaleY:0.6581,x:116.9,y:185},0).wait(1).to({regX:0,regY:0,scaleX:0.6572,scaleY:0.6572,x:-80.3,y:-1.85},0).wait(235).to({regX:-0.3,regY:-0.1,x:-80.5,y:-1.9},0).to({alpha:0},15,cjs.Ease.quartOut).to({_off:true},1).wait(499));

	// ch2
	this.ch2 = new lib.character1_container();
	this.ch2.name = "ch2";
	this.ch2.parent = this;
	this.ch2.setTransform(157.65,306.45,0.8068,0.8068,0,0,0,0.3,0.1);
	this.ch2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.ch2).wait(641).to({_off:false},0).to({y:321.45},15,cjs.Ease.quadOut).wait(114).to({scaleX:0.8596,scaleY:0.8596,x:160.2,y:337},22,cjs.Ease.cubicInOut).wait(186).to({regX:0,regY:0,x:159.95,y:336.9},0).wait(1).to({regX:-55.2,regY:-252.9,scaleX:0.8598,scaleY:0.8598,x:112.5,y:119.5},0).wait(1).to({scaleX:0.8607,scaleY:0.8607,y:119.55},0).wait(1).to({scaleX:0.8621,scaleY:0.8621,x:112.45,y:119.6},0).wait(1).to({scaleX:0.8642,scaleY:0.8642,y:119.65},0).wait(1).to({scaleX:0.867,scaleY:0.867,y:119.75},0).wait(1).to({scaleX:0.8707,scaleY:0.8707,y:119.9},0).wait(1).to({scaleX:0.8752,scaleY:0.8752,x:112.4,y:120.05},0).wait(1).to({scaleX:0.8806,scaleY:0.8806,y:120.25},0).wait(1).to({scaleX:0.8869,scaleY:0.8869,x:112.35,y:120.5},0).wait(1).to({scaleX:0.8939,scaleY:0.8939,y:120.7},0).wait(1).to({scaleX:0.9014,scaleY:0.9014,x:112.3,y:121},0).wait(1).to({scaleX:0.909,scaleY:0.909,y:121.3},0).wait(1).to({scaleX:0.9162,scaleY:0.9162,x:112.25,y:121.55},0).wait(1).to({scaleX:0.9227,scaleY:0.9227,x:112.2,y:121.75},0).wait(1).to({scaleX:0.9282,scaleY:0.9282,y:121.95},0).wait(1).to({scaleX:0.9326,scaleY:0.9326,x:112.15,y:122.15},0).wait(1).to({scaleX:0.9359,scaleY:0.9359,x:112.2,y:122.25},0).wait(1).to({scaleX:0.9382,scaleY:0.9382,x:112.15,y:122.35},0).wait(1).to({scaleX:0.9394,scaleY:0.9394},0).wait(1).to({regX:0,regY:0,scaleX:0.9398,scaleY:0.9398,x:164.05,y:360.1},0).to({_off:true},122).wait(36));

	// bg2
	this.bg2 = new lib.bg_zoom_half();
	this.bg2.name = "bg2";
	this.bg2.parent = this;
	this.bg2.setTransform(-126.4,-38.9,0.8068,0.8068,0,0,0,-0.3,-0.1);
	this.bg2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.bg2).wait(641).to({_off:false},0).to({y:-23.9},15,cjs.Ease.quadOut).wait(114).to({scaleX:0.8596,scaleY:0.8596,x:-142.4,y:-30.9},22,cjs.Ease.cubicInOut).wait(186).to({regX:0,regY:0,x:-142.15,y:-30.8},0).wait(1).to({regX:300,regY:284,scaleX:0.8598,scaleY:0.8598,x:115.75,y:213.4},0).wait(1).to({scaleX:0.8607,scaleY:0.8607,y:213.5},0).wait(1).to({scaleX:0.8621,scaleY:0.8621,y:213.75},0).wait(1).to({scaleX:0.8642,scaleY:0.8642,x:115.8,y:214},0).wait(1).to({scaleX:0.867,scaleY:0.867,y:214.5},0).wait(1).to({scaleX:0.8707,scaleY:0.8707,y:215},0).wait(1).to({scaleX:0.8752,scaleY:0.8752,x:115.85,y:215.7},0).wait(1).to({scaleX:0.8806,scaleY:0.8806,x:115.9,y:216.55},0).wait(1).to({scaleX:0.8869,scaleY:0.8869,x:115.95,y:217.5},0).wait(1).to({scaleX:0.8939,scaleY:0.8939,x:116,y:218.55},0).wait(1).to({scaleX:0.9014,scaleY:0.9014,y:219.7},0).wait(1).to({scaleX:0.909,scaleY:0.909,x:116.1,y:220.8},0).wait(1).to({scaleX:0.9162,scaleY:0.9162,y:221.9},0).wait(1).to({scaleX:0.9227,scaleY:0.9227,x:116.15,y:222.9},0).wait(1).to({scaleX:0.9282,scaleY:0.9282,x:116.2,y:223.7},0).wait(1).to({scaleX:0.9326,scaleY:0.9326,x:116.25,y:224.4},0).wait(1).to({scaleX:0.9359,scaleY:0.9359,y:224.9},0).wait(1).to({scaleX:0.9382,scaleY:0.9382,y:225.25},0).wait(1).to({scaleX:0.9394,scaleY:0.9394,x:116.3,y:225.45},0).wait(1).to({regX:0,regY:0,scaleX:0.9398,scaleY:0.9398,x:-165.7,y:-41.45},0).to({_off:true},122).wait(36));
	...
	this.timeline.addTween(cjs.Tween.get(this.toggle_btn).to({_off:true},1120).wait(36));
	...
	this.timeline.addTween(cjs.Tween.get(this.stage_btn).to({_off:true},1120).wait(31).to({_off:false},0).wait(5));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-282.1,-720,902.1,1383);
// library properties:
lib.properties = {
	id: '_401_4',
	width: 240,
