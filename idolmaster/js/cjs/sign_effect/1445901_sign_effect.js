...
(lib.reflect_mask_1445901 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// レイヤー_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("rgba(0,204,255,0.502)").s().p("");
	this.shape.setTransform(0.0106,0.0025);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = getMCSymbolPrototype(lib.reflect_mask_1445901, new cjs.Rectangle(-162.4,-56.9,324.9,113.8), null);
...
(lib.reflect = function(mode,startPosition,loop) {
	...
	this.lighter_tgt.setTransform(0,-286.65,1.1527,1.1527,0,0,-20.0009);
	this.lighter_tgt.compositeOperation = "lighter";

	this.timeline.addTween(cjs.Tween.get(this.lighter_tgt).wait(1));

}).prototype = getMCSymbolPrototype(lib.reflect, new cjs.Rectangle(0,-404.9,325,809.9), null);


(lib.reflect_container_cjs_1445901 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(-0.5,461.95,1,1,0,0,0,-0.5,0.1);
	this.instance.compositeOperation = "lighter";
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(20).to({_off:false},0).to({regY:-0.1,y:-0.1},9,cjs.Ease.get(-1)).to({regY:0.1,y:-461.75},9,cjs.Ease.get(1)).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(0,-866.8,325,1733.6);
...
(lib.reflect_wrapper_1445901 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// cjs
	this.reflect = new lib.reflect_container_cjs_1445901();
...
}).prototype = getMCSymbolPrototype(lib.reflect_wrapper_1445901, new cjs.Rectangle(0,-404.9,325,809.9), null);
...
(lib.sign_effect_1445901 = function(mode,startPosition,loop) {
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});

	// glitter
	this.instance = new lib.glitter_wrapper();
	this.instance.parent = this;
	this.instance.setTransform(405.4,525.65,0.9401,0.9401);

	this.instance_1 = new lib.glitter_wrapper();
	this.instance_1.parent = this;
	this.instance_1.setTransform(598.85,574.85,0.9401,0.9401);

	this.instance_2 = new lib.glitter_wrapper();
	this.instance_2.parent = this;
	this.instance_2.setTransform(436.5,624,0.9401,0.9401);

	this.instance_3 = new lib.glitter_wrapper();
	this.instance_3.parent = this;
	this.instance_3.setTransform(538.75,620.45,0.6813,0.6813);

	this.instance_4 = new lib.glitter_wrapper();
	this.instance_4.parent = this;
	this.instance_4.setTransform(473.9,558.6,0.6508,0.6508);

	this.instance_5 = new lib.glitter_wrapper();
	this.instance_5.parent = this;
	this.instance_5.setTransform(322.75,551.35,0.9401,0.9401);

	this.instance_6 = new lib.glitter_wrapper();
	this.instance_6.parent = this;
	this.instance_6.setTransform(322.75,624,0.9401,0.9401);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_6},{t:this.instance_5},{t:this.instance_4},{t:this.instance_3},{t:this.instance_2},{t:this.instance_1},{t:this.instance}]}).wait(1));

	// mask_idn
	this.reflect_mask = new lib.reflect_mask_1445901();
	this.reflect_mask.name = "reflect_mask";
	this.reflect_mask.parent = this;
	this.reflect_mask.setTransform(445.45,576.8);
	...
	mask._off = true;
	mask.graphics.p("");
	mask.setTransform(303.9675,316.8574);

	// reflect
	this.reflect_wrapper = new lib.reflect_wrapper_1445901();
	this.reflect_wrapper.name = "reflect_wrapper";
	this.reflect_wrapper.parent = this;
	this.reflect_wrapper.setTransform(282.95,576.8);
...
}).prototype = getMCSymbolPrototype(lib.sign_effect_1445901, new cjs.Rectangle(32,162.1,619.6,747.6999999999999), null);
...
(lib.replace = function(mode,startPosition,loop) {
	...
	// sign
	this.sign_effect = new lib.sign_effect_1445901();
...
}).prototype = getMCSymbolPrototype(lib.replace, new cjs.Rectangle(0,0,651.6,981.8), null);


// stage content:
(lib._1445901_sign_effect = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// replace
	this.instance = new lib.replace();
	this.instance.parent = this;
	this.instance.setTransform(325.8,490.9,1,1,0,0,0,325.8,490.9);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(590.1,571.9,61.5,409.9);
// library properties:
lib.properties = {
	id: '_1445901_sign_effect',
	width: 640,
	height: 800,
	fps: 18,
	color: "#333333",
...
an.compositions['_1445901_sign_effect'] = {
